---
title: 커스텀 매니저 에이전트
description: LocalAI에서 커스텀 에이전트를 매니저로 설정하여 작업 관리 및 조정을 보다 세밀하게 제어하는 방법을 알아보세요.
icon: user-shield
mode: "wide"
---

# LocalAI에서 특정 에이전트를 매니저로 설정하기

LocalAI는 사용자가 crew의 매니저로 특정 에이전트를 설정할 수 있도록 하여, 작업의 관리 및 조정에 대한 더 많은 제어권을 제공합니다.  
