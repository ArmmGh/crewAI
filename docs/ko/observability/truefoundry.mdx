...
TrueFoundry provides an enterprise-ready [AI Gateway](https://www.truefoundry.com/ai-gateway) which can integrate with agentic frameworks like LocalAI and provides governance and observability for your AI Applications. TrueFoundry AI Gateway serves as a unified interface for LLM access, providing:
...
## How TrueFoundry Integrates with LocalAI
...
<Step title="Configure LocalAI with TrueFoundry">
...
Monitor your LocalAI agents through TrueFoundry's metrics tab:
...
This provides additional trace correlation across your entire LocalAI workflow.
![TrueFoundry LocalAI Tracing](/images/tracing_localagents.png)
