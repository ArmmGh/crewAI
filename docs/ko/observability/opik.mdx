---
title: Opik 통합
description: Comet Opik을 사용하여 LocalAI 애플리케이션을 포괄적인 트레이싱, 자동 평가, 프로덕션 준비 대시보드로 디버그, 평가 및 모니터링하는 방법을 알아보세요.
icon: meteor
mode: "wide"
---
...
<Frame caption="Opik 에이전트 대시보드">
  <img src="/images/opik-localagents-dashboard.png" alt="LocalAI와 함께하는 Opik 에이전트 모니터링 예시" />
</Frame>

Opik은 LocalAI 애플리케이션 개발의 모든 단계에서 포괄적인 지원을 제공합니다:
...
호스팅 버전을 사용하려면 [무료 Comet 계정 만들기](https://www.comet.com/signup?utm_medium=github&utm_source=localagents_docs) 후 API 키를 발급받으세요.

Opik 플랫폼을 로컬에서 실행하려면, [설치 가이드](https://www.comet.com/docs/opik/self-host/overview/)에서 자세한 정보를 확인하세요.

이 가이드에서는 LocalAI의 빠른 시작 예제를 사용합니다.
...
<Steps>
    ...
    <Step title="LocalAI 사용하기">
      첫 번째 단계는 프로젝트를 만드는 것입니다. LocalAI 문서의 예제를 사용하겠습니다:
      ...
      print(result)
      ```
      LocalAI 애플리케이션을 실행한 후에는 Opik 앱에서 다음을 확인할 수 있습니다:
      - LLM 추적, span, 메타데이터
