...
[OpenLIT](https://github.com/openlit/openlit?src=localagents-docs)은 오픈 소스 도구로, 단 **한** 줄의 코드만으로 AI 에이전트, LLM, VectorDB, GPU의 성능을 간편하게 모니터링할 수 있습니다.
...
- **모델 플레이그라운드**: 배포 전에 LocalAI 에이전트에 사용할 다양한 모델을 테스트하고 비교할 수 있습니다.
