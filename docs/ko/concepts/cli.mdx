...
crew 또는 flow를 [LocalAI AMP](https://app.crewai.com)에 배포하세요.
...
CLI를 사용하여 [LocalAI AMP](http://app.crewai.com)에 crew를 배포하는 단계별 시연은 아래 비디오 튜토리얼을 참조하십시오.
...
| 설정                | 값                     | 설명                                                                 |
| :------------------ | :--------------------- | :------------------------------------------------------------------- |
| enterprise_base_url | https://app.crewai.com | LocalAI AMP 인스턴스의 기본 URL                                       |
