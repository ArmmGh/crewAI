...
LocalAI AOP의 RBAC는 **조직 수준 역할**과 **자동화(Automation) 수준 가시성**을 결합하여 안전하고 확장 가능한 접근 제어를 제공합니다.

<Frame>
  <img src="/images/enterprise/users_and_roles.png" alt="LocalAI AMP RBAC 개요" />
...
<Frame>
  <img src="/images/enterprise/visibility.png" alt="LocalAI AMP 가시성 설정" />
