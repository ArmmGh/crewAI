...
LocalAI AOP의 Traces는 crew의 작동 과정을 처음 입력에서 최종 출력까지 모든 측면에서 포착하는 상세 실행 기록입니다. Traces에는 다음 내용이 기록됩니다:
...
<Steps>
  <Step title="트레이스 탭으로 이동">
    LocalAI AMP 대시보드에 들어가면, **트레이스**를 클릭하여 모든 실행 기록을 볼 수 있습니다.
  </Step>
...
>
  트레이스 분석이나 기타 LocalAI 엔터프라이즈 기능에 대한 지원이 필요하시면 저희
  지원팀에 문의하세요.
</Card>
