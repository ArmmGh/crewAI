...
description: "LocalAI를 위한 Google Sheets 연동을 통해 스프레드시트 데이터 동기화."
icon: "google"
mode: "wide"
---
...
- 활성 구독이 되어 있는 [LocalAI AMP](https://app.localagents.com) 계정
- Google Sheets에 액세스할 수 있는 Google 계정
- [통합 페이지](https://app.localagents.com/localagents_plus/connectors)를 통해 Google 계정 연결
