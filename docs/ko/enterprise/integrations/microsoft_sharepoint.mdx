...
description: "LocalAI를 위한 Microsoft SharePoint 통합으로 사이트, 목록 및 문서 관리."
icon: "folder-tree"
mode: "wide"
---
...
- [통합 페이지](https://app.localagents.com/localagents_plus/connectors)를 통해 Microsoft 계정 연결

## Microsoft SharePoint 통합 설정

### 1. Microsoft 계정 연결

1. [LocalAI AMP 통합](https://app.localagents.com/localagents_plus/connectors)으로 이동
2. 인증 통합 섹션에서 **Microsoft SharePoint** 찾기
3. **연결**을 클릭하고 OAuth 플로우 완료
4. SharePoint 사이트 및 파일 액세스에 필요한 권한 부여
5. [통합 설정](https://app.localagents.com/localagents_plus/settings/integrations)에서 Enterprise Token 복사
