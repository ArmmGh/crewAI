---
title: "팀 관리"
description: "LocalAI AMP 조직에서 팀원을 초대하고 관리하는 방법을 알아보세요"
icon: "users"
mode: "wide"
---

LocalAI AMP 계정의 관리자라면 새로운 팀원을 조직에 쉽게 초대할 수 있습니다. 이 안내서는 단계별로 프로세스를 안내합니다.

## 팀 멤버 초대하기

<Steps>
  <Step title="설정 페이지 접속">
    - LocalAI AMP 계정에 로그인합니다 - 대시보드 오른쪽 상단에 있는 기어
...
<Steps>
  <Step title="설정 페이지 접근">
    - LocalAI AMP 계정에 로그인하세요 - 대시보드 오른쪽 상단에서 기어
...
이 단계들을 따르면 팀을 손쉽게 확장하고 LocalAI AMP 조직 내에서 더욱 효과적으로 협업할 수 있습니다.
