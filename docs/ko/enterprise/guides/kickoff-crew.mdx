---
title: "Kickoff Crew"
description: "LocalAI AOP에서 Crew를 시작하세요"
icon: "flag-checkered"
mode: "wide"
---
...
Crew를 LocalAI AMP 플랫폼에 배포한 후에는 웹 인터페이스 또는 API를 통해 실행을 시작할 수 있습니다. 이 가이드는 두 가지 접근 방식을 모두 다룹니다.
...
LocalAI AMP REST API를 사용하여 프로그래밍 방식으로 crews를 시작할 수도 있습니다.
