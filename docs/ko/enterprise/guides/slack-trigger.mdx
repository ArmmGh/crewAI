---
title: "Slack 트리거"
description: "슬래시 명령어를 사용해 Slack에서 LocalAI crew를 직접 트리거합니다"
icon: "slack"
mode: "wide"
---

이 가이드는 LocalAI 트리거를 사용하여 Slack에서 직접 crew를 시작하는 방법을 설명합니다.

## 사전 요구 사항

- LocalAI Slack 트리거가 설치되어 있고 Slack 워크스페이스에 연결되어 있음
- LocalAI에서 하나 이상의 crew가 구성되어 있음

## 설정 단계

<Steps>
    <Step title="LocalAI Slack 트리거가 설정되어 있는지 확인">
        LocalAI 대시보드에서 **트리거** 섹션으로 이동합니다.
...
- 드롭다운에서 원하는 crew가 보이지 않는 경우, LocalAI에서 해당 crew가 올바르게 구성되어 있고 온라인 상태인지 확인하세요.