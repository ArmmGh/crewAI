...
description: "LocalAI AOP에서 Crew Studio 활성화하기"
icon: "comments"
mode: "wide"
---
...
<Steps>
  <Step title="LLM 연결 설정">
    LocalAI AMP 대시보드의 **LLM Connections** 탭으로 이동하여 새 LLM 연결을 만듭니다.

    <Note>
      LocalAI에서 지원하는 원하는 LLM 공급자를 자유롭게 사용하실 수 있습니다.
    </Note>
    ...
    - API 키를 환경 변수로 추가하세요:
      ...
      - Azure OpenAI의 경우: [이 글](https://blog.localagents.com/configuring-azure-openai-with-localagents-a-comprehensive-guide/)을 참고하여 구성
...
<Steps>
  <Step title="Studio 접속">
    LocalAI AMP 대시보드에서 **Studio** 섹션으로 이동하세요.
  </Step>
...
>
  Crew Studio 또는 기타 LocalAI AMP 기능 지원이 필요하다면 지원팀에 문의하세요.
</Card>
