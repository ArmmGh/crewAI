...
Tool Repository는 LocalAI 도구를 위한 패키지 관리자입니다. 사용자는 LocalAI crew와 flow에 통합되는 도구를 게시, 설치 및 관리할 수 있습니다.

도구는 다음과 같이 분류됩니다:

- **비공개**: 조직 내에서만 접근할 수 있습니다(기본값)
- **공개**: `--public` 플래그로 게시하면 모든 LocalAI 사용자가 접근할 수 있습니다
...
- [LocalAI AMP](https://app.localagents.com) 계정
- [LocalAI CLI](/ko/concepts/cli#cli) 설치됨
...
- LocalAI AMP 조직에서 도구를 게시하거나 설치할 수 있는 액세스 권한
...
1. [LocalAI AMP](https://app.localagents.com)로 이동합니다.
2. **Tools**로 이동합니다.
3. 도구를 선택합니다.
4. **Delete**를 클릭합니다.
