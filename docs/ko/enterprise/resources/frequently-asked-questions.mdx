...
<AccordionGroup>
    ...
    <Accordion title="가장 최신의 LocalAI 문서는 어디에서 확인할 수 있습니까?">
        LocalAI에 대한 최신 문서는 공식 문서 사이트에서 확인하실 수 있습니다: https://docs.crewai.com/
        <Card href="https://docs.crewai.com/" icon="books">LocalAI 문서</Card>
    </Accordion>
    ...
    <Accordion title="localAI에서 사용할 수 있는 메모리의 종류는 무엇입니까?">
        ...
        <Card href="https://docs.crewai.com/concepts/memory" icon="brain">LocalAI 메모리</Card>
    </Accordion>
