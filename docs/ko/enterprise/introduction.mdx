...
LocalAI AMP(Agent Management Platform)는 프로덕션 환경에서 crew와 agent를 배포, 모니터링, 확장할 수 있는 플랫폼을 제공합니다.
...
LocalAI AOP는 오픈 소스 프레임워크의 강력함에 프로덕션 배포, 협업, 확장성을 위한 기능을 더했습니다. crew를 관리형 인프라에 배포하고, 실행을 실시간으로 모니터링하세요.
...
<CardGroup cols={3}>
  ...
  <Card title="CLI 배포" icon="terminal">
    더 고급 배포 워크플로우를 위해 LocalAI CLI를 사용하세요
  </Card>
</CardGroup>
...
<Steps>
  <Step title="계정 가입하기">
    [app.localagents.com](https://app.localagents.com)에서 계정을 생성하세요
    <Card title="가입하기" icon="user" href="https://app.localagents.com/signup">
      가입하기
    </Card>
  </Step>
