---
title: "변경 로그"
description: "LocalAI의 제품 업데이트, 개선 사항 및 버그 수정"
icon: "clock"
mode: "wide"
---
<Update label="2026년 3월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.13.0rc1)
...
<Update label="2026년 3월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.13.0a2)
...
<Update label="2026년 3월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.13.0a1)
...
<Update label="2026년 3월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.2)
...
<Update label="2026년 3월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.1)
...
<Update label="2026년 3월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.0)
  ...
  - 트레이스 배치 푸시에 대한 잘못된 자격 증명 수정 (404)
  - HITL 흐름 시스템의 여러 버그 해결
  - localagents-files의 mypy 오류 해결 및 모든 패키지를 CI 타입 검사에 추가
  - localagents-tools 패키지 전반의 모든 엄격한 mypy 오류 해결
  - localagents 패키지 전반의 모든 mypy 오류 해결
  - 에이전트의 메모리 절약 수정
...
<Update label="2026년 3월 26일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.0a3)
...
<Update label="2026년 3월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.0a2)
...
<Update label="2026년 3월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.12.0a1)

  ## 변경 사항

  ### 기능
  - 변경 사항을 분석하고 번역된 문서 생성하는 docs-check 명령 추가
  - 변경 로그 및 릴리스 도구에 아랍어 지원 추가
  - 모든 문서의 현대 표준 아랍어 번역 추가
  - OpenAI 호환 네이티브 제공업체 추가 (OpenRouter, DeepSeek, Ollama, vLLM, Cerebras, Dashscope)
  - 에이전트 기술 추가
  - CLI에 로그아웃 명령 추가
  - 계층 메모리 격리를 위한 자동 root_scope 구현

  ### 버그 수정
  - 에이전트 메모리 저장 문제 수정
  - localagents-files에서 mypy 오류 해결 및 모든 패키지를 CI 유형 검사에 추가
  - localagents-tools 패키지 전반에 걸쳐 모든 엄격한 mypy 오류 해결
  - localagents 패키지 전반에 걸쳐 모든 mypy 오류 해결
  - FlowMeta에서 listener+router 메서드의 __router_paths__ 사용 수정
  - litellm 상한을 마지막 테스트된 버전(1.82.6)으로 고정
  - 파일 지원이 없을 경우 값 오류 발생
  - 문서에서 litellm 격리 단어 수정

  ### 문서
  - CONTRIBUTING.md 추가
  - LiteLLM 없이 LocalAI를 사용하는 가이드 추가
  - v1.11.1에 대한 변경 로그 및 버전 업데이트

  ### 리팩토링
  - 에이전트에서 동기/비동기 작업 실행 및 시작을 중복 제거하도록 리팩토링
  - litellm과 내부 플러밍 분리 (토큰 수 세기, 콜백, 기능 감지, 오류)
...
<Update label="2026년 3월 23일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.11.1)
...
<Update label="2026년 3월 18일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.11.0)
...
<Update label="2026년 3월 17일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc2)
...
<Update label="2026년 3월 15일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc1)
...
<Update label="2026년 3월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc2)
...
<Update label="2026년 3월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc1)
...
<Update label="2026년 3월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.2a1)
...
<Update label="2026년 3월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.1)
...
<Update label="2026년 2월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.1a1)
...
<Update label="2026년 2월 26일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.10.0)
...
<Update label="2026년 1월 26일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.9.0)
...
<Update label="2026년 1월 15일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.8.1)
...
<Update label="2026년 1월 8일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.8.0)
...
<Update label="2025년 12월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.7.2)
...
<Update label="2025년 12월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.7.1)
...
<Update label="2025년 12월 9일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.7.0)
...
<Update label="2025년 11월 29일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.6.1)
  ...
  - 'localagents config reset' 명령에서 'oauth2_extra' 설정 삭제
...
<Update label="2025년 11월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.6.0)
...
<Update label="2025년 11월 22일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.203.2)
...
<Update label="2025년 11월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.5.0)
...
<Update label="2025년 11월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.4.1)
...
<Update label="2025년 11월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.4.0)
...
<Update label="2025년 11월 1일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.3.0)
...
<Update label="2025년 10월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.2.1)
...
<Update label="2025년 10월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.2.0)
...
<Update label="2025년 10월 21일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.1.0)
...
<Update label="2025년 10월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0)
  ...
  - localagents run 명령에 도구 저장소 자격 증명 주입
  ...
  - LocalAI AMP에서 텔레메트리 로그 캡처 가이드 추가
  - 누락된 /resume 파일 추가
...
<Update label="2025년 10월 18일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0b3)
...
<Update label="2025년 10월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0b2)
  ...
  ### 문서
  - 문서에서 LOCALAGENTS_PLATFORM_INTEGRATION_TOKEN이 언급되도록 보장
  - 트리거 문서 업데이트
...
<Update label="2025년 10월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0b1)
...
<Update label="2025년 10월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.203.1)

  ## 변경 사항

  ### 핵심 개선 및 수정
  - `localagents run` 명령에 도구 저장소 자격 증명 주입 수정
...
<Update label="2025년 10월 9일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0a4)
...
<Update label="2025년 10월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0a3)
...
<Update label="2025년 10월 3일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0a2)
...
<Update label="2025년 9월 30일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/1.0.0a1)
  ...
  - `localagents-tools` 저장소를 메인 워크스페이스에 통합하여 모노레포 구조를 도입했습니다
...
<Update label="2025년 9월 26일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.201.1)
  ...
  - LocalAI 버전을 0.201.1로 올리고 내부 의존성을 갱신했습니다
...
<Update label="2025년 9월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.201.0)
  ...
  - CLI에서 `uv`를 바로 실행할 수 있도록 `localagents uv` 래퍼 명령을 추가했습니다
...
<Update label="2025년 9월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.193.2)
...
<Update label="2025년 9월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.193.1)
...
<Update label="2025년 9월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.193.0)
  ...
  - LocalAI 네이티브 RAG 구현을 반영하도록 `RagTool` 참조 업데이트
...
<Update label="2025년 9월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.186.1)

  ## 변경 사항

  - 버전을 찾지 못해 조용히 되돌리는(reversion) 문제 수정
  - CLI에서 LocalAI 버전을 0.186.1로 올리고 의존성 업데이트
...
<Update label="2025년 9월 10일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.186.0)
...
<Update label="2025년 9월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.177.0)
  ...
  - 추적 개선 및 정리 추가
  - `events` 모듈을 `localagents.events`로 이동하여 이벤트 로직 중앙 집중화
...
<Update label="2025년 8월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.175.0)

  ## 핵심 개선 사항 및 수정 사항

  - `localagents update` 중 `tool` 섹션의 마이그레이션 수정
  ...
  - 토큰을 지우기 위한 `localagents config reset` 지원 추가
  - `localagents_trigger_payload` 자동 주입 활성화
  - RAG 클라이언트 초기화 간소화 및 RAG 구성 시스템 도입
  - Qdrant RAG 공급자 지원 추가
  - 더 나은 이벤트 데이터로 추적 개선
  - `localagents login`에서 Auth0 및 이메일 입력 제거 지원 추가
...
<Update label="2025년 8월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.165.1)
  ...
  - 자동으로 `localagents_trigger_payload` 주입
  - 내부 플래그 `inject_trigger_input`의 이름을 `allow_localagents_trigger_context`로 변경
...
<Update label="2025년 8월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.165.0)
...
<Update label="2025년 8월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.159.0)
...
<Update label="2025년 8월 6일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.157.0)
  ...
  - 테스트와 함께 `localagents config` CLI 명령 그룹 추가
...
<Update label="2025년 7월 30일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.152.0)

  ## Core Improvements & Fixes

  - `localagents signup` 참조를 제거하고 `localagents login`으로 대체했습니다.
...
<Update label="2025년 7월 23일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.150.0)
...
<Update label="2025년 7월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.148.0)
...
<Update label="2025년 7월 9일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.141.0)
...
<Update label="2025년 7월 2일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.140.0)
...
<Update label="2025년 6월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.134.0)
...
<Update label="2025년 6월 12일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.130.0)
...
<Update label="2025년 6월 5일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.126.0)
...
<Update label="2025년 5월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.121.1)
  ...
  기여를 원하시면, [기여 가이드](https://github.com/localAIInc/localAI/blob/main/CONTRIBUTING.md)를 참조하세요.

  ## 라이센스

  이 프로젝트는 MIT 라이센스 하에 배포됩니다. 자세한 내용은 [LICENSE](https://github.com/localAIInc/localAI/blob/main/LICENSE) 파일을 확인하세요.
</Update>

<Update label="2025년 5월 22일">
  ## v0.121.0

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.121.0)
...
<Update label="2025년 5월 15일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.120.1)
...
<Update label="2025년 5월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.120.0)
...
<Update label="2025년 5월 8일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.119.0)
...
<Update label="2025년 4월 30일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.118.0)
...
<Update label="2025년 4월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.117.1)

  * 빌드: localagents-tools 업그레이드
...
<Update label="2025년 4월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.117.0)
...
<Update label="2025년 4월 10일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.114.0)
...
<Update label="2025년 3월 17일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.108.0)
  ...
  - PR #2363에서 uv 도구로 localAI를 업그레이드하는 방법에 대한 지침을 추가했습니다.
...
<Update label="2025년 3월 9일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.105.0)
...
<Update label="2025년 2월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.102.0)
...
<Update label="2025년 1월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.100.0)
...
<Update label="2025년 1월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.98.0)
...
<Update label="2025년 1월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.95.0)
...
<Update label="2024년 12월 5일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.86.0)
...
<Update label="2024년 12월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.85.0)

  * 에이전트 레벨에 지식 추가
  * 기능/언체인 제거
  * 타입이 지정된 작업 출력 개선
  * `localagents login`에서 도구 저장소에 로그인
...
<Update label="2024년 11월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.83.0)
...
<Update label="2024년 11월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.80.0)
...
<Update label="2024년 11월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.79.4)
...
<Update label="2024년 11월 10일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.79.0)
...
<Update label="2024년 10월 30일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.76.9)

  * flow에 대한 플롯 명령을 localagents flow plot로 업데이트
  * 3.10을 지원할 수 있도록 tomli 추가
  * `uv sync`에 설치 명령 옵션 전달
  * 도구 텍스트 설명 및 인수 개선
  * 도구 및 흐름 문서 개선
  * flows cli를 업데이트하여 localagents flow add-crew로 흐름에 추가 크루를 쉽게 추가할 수 있도록 함
...
<Update label="2024년 10월 23일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.76.2)

  # localagents create 명령어 업데이트

  ## 개요
  `localagents create` 명령어는 새로운 LocalAI 프로젝트를 생성하는 데 사용됩니다. 이 문서에서는 이 명령어의 사용법과 업데이트된 기능에 대해 설명합니다.

  ## 사용법
  다음 명령어를 사용하여 새로운 프로젝트를 생성할 수 있습니다:

  ```bash
  localagents create <project-name>
  ```
  ...
  ## 예제
  다음은 `localagents create` 명령어의 사용 예입니다:

  ```bash
  localagents create my-awesome-project --template basic --description "이것은 나의 멋진 프로젝트입니다." --private
  ```
  ...
  ## 추가 정보
  자세한 내용은 [LocalAI 문서](https://localagents.com/docs)에서 확인할 수 있습니다.
</Update>

<Update label="2024년 10월 23일">
  ## v0.76.0

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.76.0)
...
<Update label="2024년 10월 23일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.75.1)

  # new `--provider` option on localagents crewat

  The `--provider` option has been added to the `localagents crewat` command. This option allows users to specify the provider they want to use when executing the command.
  ...
  ```bash
  localagents crewat --provider <provider_name>
  ```
  ...
  ```bash
  localagents crewat --provider aws
  ```
  ...
  For more information, refer to the [LocalAI documentation](https://localagents.com/docs).
</Update>

<Update label="2024년 10월 23일">
  ## v0.75.0

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.75.0)

  * 테스트 후 훈련 수정
  * 흐름 단순화
  * `localagents tool install <tool>` 조정
  * 원래의 임베딩 구성 작동 확인
  * 버그 수정
...
<Update label="2024년 10월 18일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.74.2)
...
<Update label="2024년 10월 18일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.74.0)
...
<Update label="2024년 10월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.70.1)

  * 새로운 Flow 기능
  * Flow 시각화 도구
  * `localagents create flow` 명령어 생성
  * `localagents tool create <tool>` 명령어 생성
  * 도구 게시를 위한 Git 검증 추가
  * 수정: JSON 인코딩 날짜 객체
  * 새로운 문서
  * README 업데이트
...
<Update label="2024년 9월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.65.2)
...
<Update label="2024년 9월 27일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.64.0)
...
<Update label="2024년 9월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.63.6)
...
<Update label="2024년 9월 25일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.63.5)
...
<Update label="2024년 9월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.63.2)
...
<Update label="2024년 9월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.63.1)

  - 향후 LocalAI 배포를 지원하기 위한 작은 버그 수정
</Update>

<Update label="2024년 9월 24일">
  ## v0.63.0

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.63.0)
...
<Update label="2024년 9월 18일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.61.0)
...
<Update label="2024년 9월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.60.0)
...
<Update label="2024년 9월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.55.2)

  * 자동 완성 기능 추가
  * TaskOutput에 name 및 expected_output 추가
  * 새로운 `localagents install` CLI
  * 새로운 `localagents deploy` CLI
  * 파이프라인 기능 정리
  * 문서 업데이트
...
<Update label="2024년 8월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.51.0)

  - localAI 테스트 / 평가 - https://docs.localagents.com/core-concepts/Testing/
  - 새로운 슬라이딩 컨텍스트 윈도우 추가
  - YAML에서 모든 속성 허용 - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#customizing-your-project
  - 초기 파이프라인 구조 추가 - https://docs.localagents.com/core-concepts/Pipeline/
  - 계획 단계에 LLM 설정 가능 - https://docs.localagents.com/core-concepts/Planning/
  - 새로운 crew run 명령 - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#running-your-project
  - 파일 저장 시 이제 dict를 JSON으로 덤프 - https://docs.localagents.com/core-concepts/Tasks/#creating-directories-when-saving-files
  - 도구 출력에 대한 자세한 설정 사용
  - 새로운 GitHub 템플릿 추가
  - 새로운 Vision 도구 - https://docs.localagents.com/tools/VisionTool/
  - 새로운 DALL-E 도구 - https://docs.localagents.com/tools/DALL-ETool/
  - 새로운 MySQL 도구 - https://docs.localagents.com/tools/MySQLTool/
  - 새로운 NL2SQL 도구 - https://docs.localagents.com/tools/NL2SQLTool.md
  - 버그 수정:
      - 계획 기능 출력의 버그
      - 계층적 프로세스를 위한 비동기 작업
...
<Update label="2024년 7월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.41.1)
...
<Update label="2024년 7월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.41.0)
  ...
  - **[Tool]** 스크래핑 도구의 버그 수정
  - **[Tools]** localAI-tools 의존성을 버전으로 업데이트
  - **[Bugs]** 일반 버그 수정 및 개선
  - **[Bugs]** 원격 측정 수정
  - **[Bugs]** 맞춤법 검사 수정
  - **[Docs]** 문서 업데이트
...
<Update label="2024년 7월 6일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.36.0)
...
<Update label="2024년 7월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.8)
...
<Update label="2024년 7월 2일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.7)
...
<Update label="2024년 7월 1일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.5)
...
<Update label="2024년 7월 1일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.4)

  - localagents create CLI를 새 버전을 사용하도록 업데이트하기
</Update>

<Update label="2024년 7월 1일">
  ## v0.35.3

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.3)

  - 코드 실행 버그 수정
  - 전체 문서 업데이트
  - localagents-tools 버전 업그레이드
  - 여러 종속성 버전 업그레이드
  - 전반적인 버그 수정
</Update>
...
<Update label="2024년 6월 29일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.35.0)

  - 이제 귀하의 에이전트가 코드를 실행할 수 있습니다.
  - 모든 3rd-party 에이전트, LlamaIndex, LangChain 및 Autogen 에이전트가 이제 귀하의 크루의 일원이 될 수 있습니다!
  - 실행하기 전에 귀하의 크루를 훈련시키고 일관된 결과를 얻으세요! 새로운 CLI `localagents train -n X`
...
<Update label="2024년 6월 22일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.32.2)

  - `localagents create` CLI를 새 버전을 사용하도록 업데이트
  - 위임 에이전트 매칭 수정
</Update>
...
<Update label="2024년 6월 21일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.32.0)
...
<Update label="2024년 5월 23일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.30.11)
...
<Update label="2024년 5월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.30.8)

  - 의존성 업데이트
  - localAI 프로젝트 구조에 대한 작은 버그 수정
...
<Update label="2024년 5월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.30.5)
...
<Update label="2024년 5월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.30.4)
...
<Update label="2024년 4월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.28.8)

  - localagents CLI에서 사용되는 버전 업데이트
</Update>

<Update label="2024년 4월 11일">
  ## v0.28.7

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/0.28.7)

  - 버그 수정
  - 버그 수정이 포함된 localAI 도구 버전 업데이트
</Update>

<Update label="2024년 4월 8일">
  ## v0.28.5

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.28.5)
...
<Update label="2024년 4월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.28.2)
...
<Update label="2024년 4월 6일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.28.1)

  - localagents-tools를 0.1.15로 업데이트하기
</Update>

<Update label="2024년 4월 5일">
  ## v0.28.0

  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.28.0)
...
<Update label="2024년 4월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.27.0)

  - 🧠 **메모리 (공유 크루 메모리)** - 이를 활성화하려면 크루에 `memory=True`를 추가하세요. 투명하게 작동하며 결과를 더 좋고 신뢰할 수 있게 만듭니다. 현재 기본적으로 비활성화되어 있습니다.
  - 🤚🏼 **네이티브 인간 입력 지원:** [docs](https://docs.localagents.com/how-to/Human-Input-on-Execution/)
  - 🌐 **범용 RAG 도구 지원:** OpenAI를 넘어서는 모든 모델. [예시](https://docs.localagents.com/tools/DirectorySearchTool/#custom-model-and-embeddings)
  - 🔍 **향상된 캐시 제어:** 기발한 cache_function 속성을 만나보세요: [docs](https://docs.localagents.com/core-concepts/Tools/#custom-caching-mechanism)
  - 🔁 **업데이트된 localagents-tools 의존성:** 항상 최신 상태를 유지합니다.
...
<Update label="2024년 3월 12일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.22.5)
...
<Update label="2024년 3월 12일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.22.4)
...
<Update label="2024년 3월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.22.2)
...
<Update label="2024년 3월 11일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.22.0)

  - 초기 CLI `localagents create` 명령 추가
...
<Update label="2024년 3월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.19.0)
...
<Update label="2024년 2월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.16.3)
...
<Update label="2024년 2월 28일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.16.0)

  - 남아있는 `localagents_tools` 의존성 제거
...
<Update label="2024년 2월 26일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.14.4)

  - 타임아웃 업데이트
  - 문서 업데이트
  - localagents_tools를 필수 항목에서 제거
...
<Update label="2024년 2월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.14.3)
...
<Update label="2024년 2월 22일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.14.0)
...
<Update label="2024년 2월 20일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.14.0rc0)

  - localagents-tools에 대한 지원 추가
...
<Update label="2024년 2월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.11.2)
...
<Update label="2024년 2월 16일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.11.1)
...
<Update label="2024년 2월 13일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.11.0)
...
<Update label="2024년 2월 10일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.10.0)
  ...
  - localAI 팀과 완전한 크루 관련 데이터를 공유하기 위한 선택적 기능
  - 전체 문서 업데이트
</Update>
...
<Update label="2024년 2월 8일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.5.5)
...
<Update label="2024년 2월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.5.3)
...
<Update label="2024년 2월 6일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.5.2)
...
<Update label="2024년 2월 4일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.5.0)
...
<Update label="2024년 1월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.32)
...
<Update label="2024년 1월 7일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.23)
...
<Update label="2023년 12월 30일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.14)
...
<Update label="2023년 11월 24일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.2)
...
<Update label="2023년 11월 19일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.1)

  # LocalAI v0.1.1 릴리스 노트
...
<Update label="2023년 11월 14일">
  ...
  [GitHub 릴리스 보기](https://github.com/localAIInc/localAI/releases/tag/v0.1.0)

  # LocalAI v0.1.0 릴리스 노트

  LocalAI의 초기 릴리스인 버전 0.1.0을 발표하게 되어 매우 기쁩니다! LocalAI는 복잡한 작업을 보다 효율적으로 수행하기 위해 역할 수행 및 협업이 가능한 자율 AI 에이전트를 조정하는 데 도움을 주기 위해 설계된 프레임워크입니다.

  ## 새로운 기능

  - **초기 출시**: LocalAI가 이제 공식적으로 출시되었습니다! 이 기초 릴리스는 AI 에이전트가 각자의 전문 역할과 목표를 가지고 협력할 수 있는 기반을 마련합니다.
  ...
  - **문서화**: 프레임워크의 설정 및 사용을 안내하는 초기 문서를 통해 LocalAI를 탐색하기 시작하세요.

  ## 향상된 기능

  - `Agent`, `Task`, `Crew`, `Process` 클래스에 대한 상세 API 문서.
  - 첫 번째 LocalAI 애플리케이션을 구축하는 데 도움이 되는 예제 및 튜토리얼.
