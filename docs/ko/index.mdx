...
<CardGroup cols={3}>
  <Card title="소개" href="/ko/introduction" icon="sparkles">
    LocalAI의 핵심 개념, 아키텍처, 에이전트·크루·플로우로 만들 수 있는 것들을 빠르게 파악하세요.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="통합 도구" href="/ko/tools/integration/overview" icon="plug">
    기존 LocalAI 자동화 또는 Amazon Bedrock Agent를 크루에서 직접 호출하는 방법을 안내합니다.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="GitHub 스타 남기기" href="https://github.com/localAIInc/localAI" icon="star">
    LocalAI가 도움이 되었다면 GitHub에서 별을 남기고 빌드를 공유해주세요.
  </Card>
  <Card title="커뮤니티 참여" href="https://community.localagents.com" icon="comments">
