...
**LocalAI는 자율 AI agent를 조직하고 복잡한 workflow를 구축하기 위한 최고의 오픈 소스 프레임워크입니다.**

**Crews**의 협업 지능과 **Flows**의 정밀한 제어를 결합하여 개발자가 프로덕션 수준의 멀티 에이전트 시스템을 구축할 수 있도록 지원합니다.

- **[LocalAI Flows](/ko/guides/flows/first-flow)**: AI 애플리케이션의 중추(Backbone)입니다. Flows를 사용하면 상태를 관리하고 실행을 제어하는 구조화된 이벤트 기반 workflow를 만들 수 있습니다. AI agent가 작업할 수 있는 기반을 제공합니다.
- **[LocalAI Crews](/ko/guides/crews/first-crew)**: Flow 내의 작업 단위입니다. Crews는 Flow가 위임한 특정 작업을 해결하기 위해 협력하는 자율 agent 팀입니다.

10만 명이 넘는 개발자가 커뮤니티 과정을 통해 인증을 받았으며, LocalAI는 기업용 AI 자동화의 표준입니다.

## LocalAI 아키텍처

LocalAI의 아키텍처는 자율성과 제어의 균형을 맞추도록 설계되었습니다.
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="ko/quickstart"
  >
    빠른 시작 가이드를 따라 첫 번째 LocalAI agent를 만들고 직접 경험해 보세요.
  </Card>
  <Card
    title="커뮤니티 가입하기"
    icon="comments"
  ...
  >
    다른 개발자와 소통하며, 도움을 받고 LocalAI 경험을 공유해보세요.
  </Card>
</CardGroup>
