...
1. LocalAI AMP 계정에 로그인하세요([app.crewai.com](https://app.crewai.com)에서 무료 계정 만들기)
2. Crew Studio 열기
...
![Crew Studio Quickstart](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="LocalAI AMP 체험하기" icon="rocket" href="https://app.crewai.com">
...
production 환경에 crew를 배포하는 가장 쉬운 방법은 [LocalAI AMP](http://app.crewai.com)를 통해서입니다.

CLI를 사용하여 [LocalAI AMP](http://app.crewai.com)에 crew를 배포하는 단계별 시연은 이 영상 튜토리얼을 참고하세요.
