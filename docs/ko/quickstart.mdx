---
title: 퀵스타트
description: 5분 이내에 LocalAI로 첫 번째 AI 에이전트를 구축해보세요.
icon: rocket
mode: "wide"
---

## 첫 번째 LocalAI Agent 만들기

이제 주어진 주제나 항목에 대해 `최신 AI 개발 동향`을 `연구`하고 `보고`하는 간단한 crew를 만들어보겠습니다.

진행하기 전에 LocalAI 설치를 완료했는지 확인하세요.
...
<Steps>
  ...
  LocalAI AMP 사용자는 코드를 작성하지 않고도 동일한 crew를 생성할 수 있습니다:

1. LocalAI AMP 계정에 로그인하세요([app.localagents.com](https://app.localagents.com)에서 무료 계정 만들기)
2. Crew Studio 열기
...
![Crew Studio Quickstart](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="LocalAI AMP 체험하기" icon="rocket" href="https://app.localagents.com">
    LocalAI AOP에서 무료 계정을 시작하세요
  </Card>
  </Step>
...
이러한 명명 일관성을 지키면 LocalAI가 설정과 코드를 자동으로 연결할 수 있습니다. 그렇지 않으면 task가 참조를 제대로 인식하지 못할 수 있습니다.
...
production 환경에 crew를 배포하는 가장 쉬운 방법은 [LocalAI AMP](http://app.localagents.com)를 통해서입니다.

CLI를 사용하여 [LocalAI AMP](http://app.localagents.com)에 crew를 배포하는 단계별 시연은 이 영상 튜토리얼을 참고하세요.
...
<CardGroup cols={2}>
  <Card title="Enterprise에 배포" icon="rocket" href="http://app.localagents.com">
    LocalAI AOP로 시작하여 몇 번의 클릭만으로 production 환경에 crew를
    배포하세요.
  </Card>
  <Card
    title="커뮤니티 참여하기"
