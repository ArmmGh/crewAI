---
title: "도구 개요"
description: "LocalAI의 AI 에이전트를 강화하는 40개 이상의 방대한 도구 라이브러리를 확인해보세요"
icon: "toolbox"
mode: "wide"
---

LocalAI는 에이전트의 기능을 향상시키기 위한 다양한 사전 구축 도구 라이브러리를 제공합니다. 파일 처리부터 웹 스크래핑, 데이터베이스 쿼리, AI 서비스에 이르기까지 모두 지원합니다.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    color="#0891B2"
  >
    Amazon Bedrock 및 LocalAI Automation 툴킷 등 외부 시스템과 LocalAI를 통합합니다.
  </Card>
</CardGroup>
