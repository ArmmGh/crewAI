...
자세한 내용은 Apify 문서의 [Apify LocalAI 통합](https://docs.apify.com/platform/integrations/crewai)을 참조하세요.
...
에이전트와 함께 사용하는 예시는 [LocalAI Actor 템플릿](https://apify.com/templates/python-crewai)을 참고하세요.
...
- **[LocalAI 통합 가이드](https://docs.apify.com/platform/integrations/crewai)**: Apify와 LocalAI를 통합하는 공식 가이드를 따라보세요.