---
title: Zapier 액션 도구
description: ZapierActionsAdapter는 Zapier 액션을 LocalAI 도구로 노출하여 자동화를 지원합니다.
icon: bolt
mode: "wide"
---
...
Zapier 어댑터를 사용하여 Zapier 작업을 LocalAI 도구로 나열하고 호출할 수 있습니다. 이를 통해 에이전트가 수천 개의 앱에서 자동화를 트리거할 수 있습니다.

## 설치

이 어댑터는 `localagents-tools`에 포함되어 있습니다. 별도의 설치가 필요하지 않습니다.
