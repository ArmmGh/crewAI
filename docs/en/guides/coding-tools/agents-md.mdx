---
title: Coding Tools
description: Use AGENTS.md to guide coding agents and IDEs across your LocalAI projects.
icon: terminal
mode: "wide"
---
...
Use the LocalAI CLI to scaffold a project, then `AGENTS.md` will be automatically added at the root.
