---
title: FAQs
description: "Frequently asked questions about LocalAI AMP"
...
<AccordionGroup>
    ...
    <Accordion title="Where can I get the latest LocalAI documentation?">
        The most up-to-date documentation for LocalAI is available on our official documentation website: https://docs.localagents.com/
        <Card href="https://docs.localagents.com/" icon="books">LocalAI Docs</Card>
    </Accordion>

    <Accordion title="What are the key differences between Hierarchical and Sequential Processes in LocalAI?">
    ...
    <Accordion title="What are the benefits of using memory in the LocalAI framework?">
    ...
    <Accordion title="What role does human input play in the execution of tasks within a LocalAI crew?">
    ...
    <Accordion title="What advanced customization options are available for tailoring and enhancing agent behavior and capabilities in LocalAI?">
        LocalAI provides a range of advanced customization options:
    ...
    <Accordion title="What are the different types of memory that are available in localAI?">
        The different types of memory available in LocalAI are:
