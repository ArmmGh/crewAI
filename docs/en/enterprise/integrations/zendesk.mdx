...
description: "Customer support and helpdesk management with Zendesk integration for LocalAI."
icon: "headset"
mode: "wide"
---
...
- Connected your Zendesk account through the [Integrations page](https://app.localagents.com/integrations)
