...
- A [LocalAI AMP](https://app.crewai.com) account with an active subscription
...
1. Navigate to [LocalAI AMP Integrations](https://app.crewai.com/crewai_plus/connectors)
