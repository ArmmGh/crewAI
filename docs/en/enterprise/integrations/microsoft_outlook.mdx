...
description: "Email, calendar, and contact management with Microsoft Outlook integration for LocalAI."
icon: "envelope"
mode: "wide"
---
...
- A [LocalAI AMP](https://app.localagents.com) account with an active subscription
- A Microsoft account with Outlook access
- Connected your Microsoft account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)

## Setting Up Microsoft Outlook Integration

### 1. Connect Your Microsoft Account

1. Navigate to [LocalAI AMP Integrations](https://app.localagents.com/localagents_plus/connectors)
...
5. Copy your Enterprise Token from [Integration Settings](https://app.localagents.com/localagents_plus/settings/integrations)
