...
description: "Software project and bug tracking with Linear integration for LocalAI."
icon: "list-check"
mode: "wide"
---
...
- Connected your Linear account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
