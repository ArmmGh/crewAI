...
description: "File storage and document management with Box integration for LocalAI."
icon: "box"
mode: "wide"
---
...
- Connected your Box account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
