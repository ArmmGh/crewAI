...
description: "E-commerce and online store management with Shopify integration for LocalAI."
icon: "shopify"
mode: "wide"
---
...
- Connected your Shopify store through the [Integrations page](https://app.localagents.com/integrations)
