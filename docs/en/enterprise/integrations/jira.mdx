...
description: "Issue tracking and project management with Jira integration for LocalAI."
icon: "bug"
mode: "wide"
---
...
- Connected your Jira account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
