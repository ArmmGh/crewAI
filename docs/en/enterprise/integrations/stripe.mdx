...
description: "Payment processing and subscription management with Stripe integration for LocalAI."
icon: "stripe"
mode: "wide"
---
...
- Connected your Stripe account through the [Integrations page](https://app.localagents.com/integrations)
