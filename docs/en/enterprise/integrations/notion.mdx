...
description: "User management and commenting with Notion integration for LocalAI."
icon: "book"
mode: "wide"
---
...
- Connected your Notion account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
