...
description: "Email and contact management with Gmail integration for LocalAI."
icon: "envelope"
mode: "wide"
---
...
- Connected your Gmail account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
