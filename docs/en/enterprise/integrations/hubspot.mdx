...
description: "Manage companies and contacts in HubSpot with LocalAI."
icon: "briefcase"
mode: "wide"
---
...
- Connected your HubSpot account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors).
