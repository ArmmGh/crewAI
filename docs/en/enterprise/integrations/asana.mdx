...
description: "Team task and project coordination with Asana integration for LocalAI."
icon: "circle"
mode: "wide"
---
...
- Connected your Asana account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
