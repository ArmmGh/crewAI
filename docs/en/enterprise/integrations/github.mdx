...
description: "Repository and issue management with GitHub integration for LocalAI."
icon: "github"
mode: "wide"
---
...
- Connected your GitHub account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
