...
description: "Presentation creation and management with Google Slides integration for LocalAI."
icon: "chart-bar"
mode: "wide"
---
...
- Connected your Google account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
