...
description: "Task and productivity management with ClickUp integration for LocalAI."
icon: "list-check"
mode: "wide"
---
...
- Connected your ClickUp account through the [Integrations page](https://app.localagents.com/localagents_plus/connectors)
