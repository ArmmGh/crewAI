...
description: "CRM and sales automation with Salesforce integration for LocalAI."
icon: "salesforce"
mode: "wide"
---
...
- Connected your Salesforce account through the [Integrations page](https://app.localagents.com/integrations)
