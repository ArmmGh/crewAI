...
description: "Team communication and collaboration with Slack integration for LocalAI."
icon: "slack"
mode: "wide"
---
...
- Connected your Slack workspace through the [Integrations page](https://app.localagents.com/integrations)
