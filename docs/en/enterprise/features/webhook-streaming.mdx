...
The `data` object structure varies by event type. Refer to the [event list](https://github.com/localAIInc/localAI/tree/main/lib/crewai/src/crewai/events/types) on GitHub.
