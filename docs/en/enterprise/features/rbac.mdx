...
RBAC in LocalAI AMP enables secure, scalable access management through two layers:
...
<Frame>
  <img src="/images/enterprise/users_and_roles.png" alt="RBAC overview in LocalAI AMP" />
</Frame>

## Users and Roles

Each member in your LocalAI workspace is assigned a role, which determines their access across various features.
...
<Steps>
  <Step title="Open Roles settings">
    Go to <b>Settings → Roles</b> in LocalAI AMP.
  </Step>
...
In addition to organization‑wide roles, LocalAI supports fine‑grained entity-level permissions that restrict access to individual resources.
...
<Frame>
  <img src="/images/enterprise/visibility.png" alt="Automation Visibility settings in LocalAI AMP" />
</Frame>
...
While LocalAI ships with Owner and Member roles, most teams benefit from creating custom roles. Here are common patterns:
