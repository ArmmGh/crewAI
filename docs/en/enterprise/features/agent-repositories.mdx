...
1. You must have an account at LocalAI, try the [free plan](https://app.localagents.com).
...
To switch between organizations or see your current organization, use the LocalAI CLI:
