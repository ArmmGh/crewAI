...
description: "Enabling Crew Studio on LocalAI AMP"
icon: "comments"
mode: "wide"
---
...
- Deploy directly to the LocalAI AMP platform
...
<Steps>
  <Step title="Set Up LLM Connection">
    Go to the **LLM Connections** tab in your LocalAI AMP dashboard and create a new LLM connection.

    <Note>
      Feel free to use any LLM provider you want that is supported by LocalAI.
    </Note>
    ...
    - Add your API key as an environment variable:
      ...
      - For Azure OpenAI: Refer to [this article](https://blog.localagents.com/configuring-azure-openai-with-localagents-a-comprehensive-guide/) for configuration details
...
<Steps>
  <Step title="Access Studio">
    Navigate to the **Studio** section in your LocalAI AMP dashboard.
  </Step>
  ...
  <Step title="Deploy or Download">
    ...
    - Deploy the crew directly to the LocalAI AMP platform
...
<Card title="Need Help?" icon="headset" href="mailto:support@localagents.com">
  Contact our support team for assistance with Crew Studio or any other LocalAI
  AMP features.
</Card>
