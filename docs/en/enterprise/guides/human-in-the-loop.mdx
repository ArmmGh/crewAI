...
description: "Learn how to implement Human-In-The-Loop workflows in LocalAI for enhanced decision-making"
icon: "user-check"
mode: "wide"
---

Human-In-The-Loop (HITL) is a powerful approach that combines artificial intelligence with human expertise to enhance decision-making and improve task outcomes. This guide shows you how to implement HITL within LocalAI Enterprise.

## HITL Approaches in LocalAI

LocalAI offers two approaches for implementing human-in-the-loop workflows:
...
When using the `@human_feedback` decorator in your Flows, LocalAI Enterprise provides an **email-first HITL system** that enables anyone with an email address to respond to review requests:
