---
title: "Slack Trigger"
description: "Trigger LocalAI crews directly from Slack using slash commands"
icon: "slack"
mode: "wide"
---

This guide explains how to start a crew directly from Slack using LocalAI triggers.

## Prerequisites

- LocalAI Slack trigger installed and connected to your Slack workspace
- At least one crew configured in LocalAI

## Setup Steps

<Steps>
    <Step title="Ensure the LocalAI Slack trigger is set up">
        In the LocalAI dashboard, navigate to the **Triggers** section.

        <Frame>
            <img src="/images/enterprise/slack-integration.png" alt="LocalAI Slack Integration" />
        </Frame>
...
- If you don't see your desired crew in the dropdown, ensure it's properly configured and online in LocalAI. 