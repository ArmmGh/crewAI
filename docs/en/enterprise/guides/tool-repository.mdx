...
- A [LocalAI AMP](https://app.crewai.com) account
...
After installing a tool from the LocalAI AMP Tool Repository, you need to use the `crewai uv` command to add other packages to your project.
...
1. Go to [LocalAI AMP](https://app.crewai.com)
2. Navigate to **Tools**
3. Select the tool
4. Click **Delete**
