---
title: "Kickoff Crew"
description: "Kickoff a Crew on LocalAI AMP"
icon: "flag-checkered"
mode: "wide"
---
...
Once you've deployed your crew to the LocalAI AMP platform, you can kickoff executions through the web interface or the API. This guide covers both approaches.
...
You can also kickoff crews programmatically using the LocalAI AMP REST API.
