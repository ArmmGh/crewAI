...
description: "Learn how to invite and manage team members in your LocalAI AMP organization"
icon: "users"
mode: "wide"
---

As an administrator of a LocalAI AMP account, you can easily invite new team members to join your organization. This guide will walk you through the process step-by-step.

## Inviting Team Members

<Steps>
  <Step title="Access the Settings Page">
    - Log in to your LocalAI AMP account - Look for the gear icon (⚙️) in the top
...
By following these steps, you can easily expand your team and collaborate more effectively within your LocalAI AMP organization.
