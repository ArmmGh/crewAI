...
description: "Ensure your Crew or Flow is ready for deployment to LocalAI AMP"
icon: "clipboard-check"
mode: "wide"
---

<Note>
  Before deploying to LocalAI AMP, it's crucial to verify your project is correctly structured.
...
In LocalAI AMP, **automations** is the umbrella term for deployable Agentic AI projects. An automation can be either:
...
| **CLI create command** | `localagents create crew name` | `localagents create flow name` |
...
When you run `localagents create crew my_crew`, you get this structure:
...
When you run `localagents create flow my_flow`, you get this structure:
...
Your `pyproject.toml` must include the correct `[tool.localagents]` section:
...
LocalAI uses `uv` for dependency management. The `uv.lock` file ensures reproducible builds and is **required** for deployment.
...
<Card title="Deploy to AMP" icon="rocket" href="/en/enterprise/guides/deploy-to-amp">
  Follow the deployment guide to deploy your Crew or Flow to LocalAI AMP using
