---
title: "Update Crew"
description: "Updating a Crew on LocalAI AMP"
icon: "pencil"
mode: "wide"
---

<Note>
  After deploying your crew to LocalAI AMP, you may need to make updates to the
...
LocalAI won't automatically pick up GitHub updates by default, so you'll need to manually trigger updates, unless you checked the `Auto-update` option when deploying your crew.
...
1. Navigate to your crew in the LocalAI AMP platform
