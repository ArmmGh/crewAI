...
Deploy the crew or flow to [LocalAI AMP](https://app.crewai.com).
...
Watch this video tutorial for a step-by-step demonstration of deploying your crew to [LocalAI AMP](http://app.crewai.com) using the CLI.
...
| :------------------ | :----------------------- | :---------------------------------------------------------- |
| enterprise_base_url | https://app.crewai.com | Base URL of the LocalAI AMP instance |
