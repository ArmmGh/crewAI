---
title: Collaboration
description: How to enable agents to work together, delegate tasks, and communicate effectively within LocalAI teams.
icon: screen-users
mode: "wide"
---
...
Collaboration in LocalAI enables agents to work together as a team by delegating tasks and asking questions to leverage each other's expertise. When `allow_delegation=True`, agents automatically gain access to powerful collaboration tools.
...
When `allow_delegation=True`, LocalAI automatically provides agents with two powerful tools:
