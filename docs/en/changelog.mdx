---
title: "Changelog"
description: "Product updates, improvements, and bug fixes for LocalAI"
icon: "clock"
mode: "wide"
---
<Update label="Mar 27, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0rc1)
...
<Update label="Mar 27, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a2)
...
<Update label="Mar 27, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a1)
...
<Update label="Mar 25, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.2)
...
<Update label="Mar 25, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.1)
  ...
  - Resolve all strict mypy errors across localagents package
  ...
  - Fix all mypy errors in localagents-files and add all packages to CI type checks
  - Pin litellm upper bound to last tested version (1.82.6)

  ### Documentation
  - Update changelog and version for v1.12.0
  - Add CONTRIBUTING.md
  - Add guide for using LocalAI without LiteLLM
...
<Update label="Mar 25, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0)
  ...
  - Fix bad credentials for traces batch push (404)
  - Resolve multiple bugs in HITL flow system
  - Resolve mypy errors in localagents-files and add all packages to CI type checks
  - Resolve all strict mypy errors across localagents-tools package
  - Resolve all mypy errors across localagents package
...
<Update label="Mar 26, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a3)
...
<Update label="Mar 25, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a2)
...
<Update label="Mar 25, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a1)
...
<Update label="Mar 23, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.1)
...
<Update label="Mar 18, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0)
...
<Update label="Mar 17, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc2)
...
<Update label="Mar 15, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc1)
...
<Update label="Mar 14, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc2)
...
<Update label="Mar 13, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc1)
...
<Update label="Mar 11, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2a1)
...
<Update label="Mar 04, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.1)
...
<Update label="Feb 27, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.1a1)
...
<Update label="Feb 26, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.0)
...
<Update label="Jan 26, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.9.0)
...
<Update label="Jan 15, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.8.1)
...
<Update label="Jan 08, 2026">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.8.0)
...
<Update label="Dec 19, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.2)
...
<Update label="Dec 16, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.1)
...
<Update label="Dec 09, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.0)
...
<Update label="Nov 29, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.6.1)
  ...
  - Erase 'oauth2_extra' setting on 'localagents config reset' command
...
<Update label="Nov 25, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.6.0)
...
<Update label="Nov 22, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.203.2)
...
<Update label="Nov 16, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.5.0)
...
<Update label="Nov 07, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.4.1)
...
<Update label="Nov 07, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.4.0)
...
<Update label="Nov 01, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.3.0)
...
<Update label="Oct 27, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.2.1)
...
<Update label="Oct 24, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.2.0)
...
<Update label="Oct 21, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.1.0)
...
<Update label="Oct 20, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0)
  ...
  - Inject tool repository credentials in localagents run command
  ...
  - Add guide for capturing telemetry logs in LocalAI AMP
...
<Update label="Oct 18, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b3)
...
<Update label="Oct 16, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b2)
  ...
  ### Documentation
  - Ensure LOCALAGENTS_PLATFORM_INTEGRATION_TOKEN is mentioned in documentation
...
<Update label="Oct 14, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b1)
...
<Update label="Oct 13, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.203.1)

  ## What's Changed

  ### Core Improvements & Fixes
  - Fixed injection of tool repository credentials into the `localagents run` command
...
<Update label="Oct 09, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a4)
...
<Update label="Sep 30, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a1)
  ...
  - Merged the `localagents-tools` repository into the main workspace (monorepo)
...
<Update label="Sep 26, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.201.1)
  ...
  - Bumped LocalAI to 0.201.1 and updated internal dependencies
...
<Update label="Sep 24, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.201.0)
  ...
  - Added `localagents uv` wrapper command to run `uv` from the CLI
...
<Update label="Sep 20, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.2)
...
<Update label="Sep 20, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.1)
...
<Update label="Sep 19, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.0)
  ...
  - Updated `RagTool` references to reflect LocalAI native RAG implementation
...
<Update label="Sep 11, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.186.1)

  ## What's Changed

  - Fixed version not being found and silently failing reversion
  - Bumped LocalAI version to 0.186.1 and updated dependencies in the CLI
...
<Update label="Sep 10, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.186.0)
...
<Update label="Sep 04, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.177.0)
  ...
  - Centralized event logic by moving `events` module to `localagents.events`
...
<Update label="Aug 28, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.175.0)


  ## Core Improvements & Fixes

  - Fixed migration of the `tool` section during `localagents update`
  ...
  - Added support for `localagents config reset` to clear tokens
  - Enabled `localagents_trigger_payload` auto-injection
  ...
  - Added support to remove Auth0 and email entry on `localagents login`
...
<Update label="Aug 19, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.165.1)
  ...
  - Automatically injected `localagents_trigger_payload`
  - Renamed internal flag `inject_trigger_input` to `allow_localagents_trigger_context`
...
<Update label="Aug 19, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.165.0)
...
<Update label="Aug 13, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.159.0)
...
<Update label="Aug 06, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.157.0)
  ...
  - Added `localagents config` CLI command group with tests
...
<Update label="Jul 30, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.152.0)


  ## Core Improvements & Fixes

  - Removed `localagents signup` references and replaced them with `localagents login`
...
<Update label="Jul 23, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.150.0)
...
<Update label="Jul 16, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.148.0)
...
<Update label="Jul 09, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.141.0)
...
<Update label="Jul 02, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.140.0)
...
<Update label="Jun 25, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.134.0)
...
<Update label="Jun 12, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.130.0)
...
<Update label="Jun 05, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.126.0)
...
<Update label="May 27, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.121.1)
...
<Update label="May 22, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.121.0)
...
<Update label="May 15, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.120.1)
...
<Update label="May 14, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.120.0)
...
<Update label="May 08, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.119.0)
...
<Update label="Apr 30, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.118.0)
...
<Update label="Apr 28, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.117.1)

  * build: upgrade localagents-tools
...
<Update label="Apr 28, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.117.0)
...
<Update label="Apr 10, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.114.0)
...
<Update label="Mar 17, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.108.0)
  ...
  - Added instructions for upgrading localAI with the uv tool in PR #2363
...
<Update label="Mar 09, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.105.0)
...
<Update label="Feb 13, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.102.0)
...
<Update label="Jan 28, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.100.0)
  ...
  * Docs: New docs for localagents chat
...
<Update label="Jan 20, 2025">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.98.0)
...
<Update label="Dec 05, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.86.0)
...
<Update label="Dec 04, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.85.0)

  * Added knowledge to agent level
  * Feat/remove langchain
  * Improve typed task outputs
  * Log in to Tool Repository on `localagents login`
...
<Update label="Nov 25, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.83.0)
...
<Update label="Nov 14, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.80.0)
...
<Update label="Nov 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.79.4)
...
<Update label="Nov 10, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.79.0)
...
<Update label="Oct 30, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.9)

  * Update plot command for flow to localagents flow plot
  ...
  * Update flows cli to allow you to easily add additional crews to a flow with localagents flow add-crew
...
<Update label="Oct 23, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.2)

  Updating localagents create commadn
</Update>

<Update label="Oct 23, 2024">
  ## v0.76.0

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.0)
...
<Update label="Oct 23, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.75.1)

  new `--provider` option on localagents crewat
</Update>

<Update label="Oct 23, 2024">
  ## v0.75.0

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.75.0)

  * Fixing test post training
  * Simplify flows
  * Adapt `localagents tool install <tool>`
...
<Update label="Oct 18, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.74.2)
...
<Update label="Oct 18, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.74.0)
...
<Update label="Oct 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.70.1)

  * New Flow feature
  * Flow visualizer
  * Create `localagents create flow` command
  * Create `localagents tool create <tool>` command
...
<Update label="Sep 27, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.65.2)
...
<Update label="Sep 27, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.64.0)
...
<Update label="Sep 25, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.6)
...
<Update label="Sep 25, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.5)
...
<Update label="Sep 24, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.2)
...
<Update label="Sep 24, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.1)

  - Small bug fix for support future LocalAI deploy
</Update>

<Update label="Sep 24, 2024">
  ## v0.63.0

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.0)
...
<Update label="Sep 18, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.61.0)
...
<Update label="Sep 16, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.60.0)
...
<Update label="Sep 13, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.55.2)

  * Adding ability for auto complete
  * Add name and expected_output to TaskOutput
  * New `localagents install` CLI
  * New `localagents deploy` CLI
...
<Update label="Aug 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.51.0)

  - localAI Testing / Evaluation - https://docs.localagents.com/core-concepts/Testing/
  - Adding new sliding context window
  - Allowing all attributes on YAML - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#customizing-your-project
  - Adding initial Pipeline Structure - https://docs.localagents.com/core-concepts/Pipeline/
  - Ability to set LLM for planning step - https://docs.localagents.com/core-concepts/Planning/
  - New crew run command - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#running-your-project
  - Saving file now dumps dict into JSON - https://docs.localagents.com/core-concepts/Tasks/#creating-directories-when-saving-files
  - Using verbose settings for tool outputs
  - Added new Github Templates
  - New Vision tool - https://docs.localagents.com/tools/VisionTool/
  - New DALL-E Tool - https://docs.localagents.com/tools/DALL-ETool/
  - New MySQL tool - https://docs.localagents.com/tools/MySQLTool/
  - New NL2SQL Tool - https://docs.localagents.com/tools/NL2SQLTool.md
  - Bug Fixes:
...
<Update label="Jul 20, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.41.1)
...
<Update label="Jul 19, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.41.0)
  ...
  - **[Tools]** Bumped localAI-tools dependency to version
...
<Update label="Jul 06, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.36.0)
...
<Update label="Jul 04, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.8)
...
<Update label="Jul 02, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.7)
...
<Update label="Jul 01, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.5)
...
<Update label="Jul 01, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.4)

  - Updating localagents create CLI to use the new version
</Update>

<Update label="Jul 01, 2024">
  ## v0.35.3

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.3)

  - Code Execution Bug fixed
  - Updating overall docs
  - Bumping version of localagents-tools
...
<Update label="Jun 29, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.0)
  ...
  - Train you crew before you execute it and get consistent results! New CLI `localagents train -n X`
...
<Update label="Jun 22, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.32.2)
...
<Update label="Jun 21, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.32.0)
...
<Update label="May 23, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.30.11)
...
<Update label="May 14, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.8)

  - Updating dependencies
  - Small bug fixes on localAI project structure
...
<Update label="May 14, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.5)
...
<Update label="May 13, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.4)
...
<Update label="Apr 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.28.8)

  - updating version used on localagents CLI
</Update>

<Update label="Apr 11, 2024">
  ## v0.28.7

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/0.28.7)

  - Bug fixes
  - Updating localAI tool version with bug fixes
</Update>

<Update label="Apr 08, 2024">
  ## v0.28.5

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.5)
...
<Update label="Apr 07, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.2)
...
<Update label="Apr 06, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.1)

  - Updating localagents-tools to 0.1.15
</Update>

<Update label="Apr 05, 2024">
  ## v0.28.0

  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.0)
...
<Update label="Apr 04, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.27.0)
  ...
  - 🤚🏼 **Native Human Input Support:** [docs](https://docs.localagents.com/how-to/Human-Input-on-Execution/)
  - 🌐 **Universal RAG Tools Support:** Any models, beyond just OpenAI. [Example](https://docs.localagents.com/tools/DirectorySearchTool/#custom-model-and-embeddings)
  - 🔍 **Enhanced Cache Control:** Meet the ingenious cache_function attribute: [docs](https://docs.localagents.com/core-concepts/Tools/#custom-caching-mechanism)
  - 🔁 **Updated localagents-tools Dependency:** Always in sync with the latest and greatest.
...
<Update label="Mar 12, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.5)
...
<Update label="Mar 12, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.4)
...
<Update label="Mar 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.2)
...
<Update label="Mar 11, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.0)

  - Adding initial CLI `localagents create` command
...
<Update label="Mar 04, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.19.0)
...
<Update label="Feb 28, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.16.3)
...
<Update label="Feb 28, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.16.0)

  - Removing lingering `localagents_tools` dependency
...
<Update label="Feb 26, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.4)

  - Updating timeouts
  - Updating docs
  - Removing localagents_tools as a mandatory
...
<Update label="Feb 24, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.3)
...
<Update label="Feb 22, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.0)
...
<Update label="Feb 20, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.0rc0)

  - Adding support to localagents-tools
...
<Update label="Feb 16, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.2)
...
<Update label="Feb 16, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.1)
...
<Update label="Feb 13, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.0)
...
<Update label="Feb 10, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.10.0)
  ...
  - Opt-in to share complete crew related data with the localAI team
  - Overall Docs update
</Update>
...
<Update label="Feb 08, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.5)
...
<Update label="Feb 07, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.3)
...
<Update label="Feb 06, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.2)
...
<Update label="Feb 04, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.0)
...
<Update label="Jan 14, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.32)
...
<Update label="Jan 07, 2024">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.23)
...
<Update label="Dec 30, 2023">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.14)
...
<Update label="Nov 24, 2023">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.2)
...
<Update label="Nov 19, 2023">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.1)

  # LocalAI v0.1.1 Release Notes
...
<Update label="Nov 14, 2023">
  ...
  [View release on GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.0)

  # LocalAI v0.1.0 Release Notes

  We are thrilled to announce the initial release of LocalAI, version 0.1.0! LocalAI is a framework designed to facilitate the orchestration of autonomous AI agents capable of role-playing and collaboration to accomplish complex tasks more efficiently.

  ## What's New

  - **Initial Launch**: LocalAI is now officially in the wild! This foundational release lays the groundwork for AI agents to work in tandem, each with its own specialized role and objectives.
  ...
  - **Documentation**: Start exploring LocalAI with our initial documentation that guides you through the setup and use of the framework.

  ## Enhancements

  - Detailed API documentation for the `Agent`, `Task`, `Crew`, and `Process` classes.
  - Examples and tutorials to help you build your first LocalAI application.
