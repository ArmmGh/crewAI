...
description: Understanding and using execution hooks in LocalAI for fine-grained control over agent operations
mode: "wide"
---

Execution Hooks provide fine-grained control over the runtime behavior of your LocalAI agents. Unlike kickoff hooks that run before and after crew execution, execution hooks intercept specific operations during agent execution, allowing you to modify behavior, implement safety checks, and add comprehensive monitoring.

## Types of Execution Hooks

LocalAI provides two main categories of execution hooks:
...
```python
from localagents.hooks import before_llm_call, after_llm_call, before_tool_call, after_tool_call
...
from localagents.project import crew
from localagents.hooks import before_llm_call_crew, after_tool_call_crew
...
```python
from localagents.hooks import clear_all_global_hooks
...
```python
from localagents.hooks import LLMCallHookContext, ToolCallHookContext
