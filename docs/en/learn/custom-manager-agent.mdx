...
description: Learn how to set a custom agent as the manager in LocalAI, providing more control over task management and coordination.
icon: user-shield
mode: "wide"
---

# Setting a Specific Agent as Manager in LocalAI

LocalAI allows users to set a specific agent as the manager of the crew, providing more control over the management and coordination of tasks. 
