...
description: "Learn how to use DALL-E for AI-powered image generation in your LocalAI projects"
icon: "image"
mode: "wide"
---

LocalAI supports integration with OpenAI's DALL-E, allowing your AI agents to generate images as part of their tasks. This guide will walk you through how to set up and use the DALL-E tool in your LocalAI projects.

## Prerequisites

- localAI installed (latest version)
...
2. **Version compatibility** - Check that you're using the latest version of localAI and localagents-tools.
