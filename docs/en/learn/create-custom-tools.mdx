...
description: Comprehensive guide on crafting, using, and managing custom tools within the LocalAI framework, including new functionalities and error handling.
icon: hammer
mode: "wide"
---

## Creating and Utilizing Tools in LocalAI

This guide provides detailed instructions on creating custom tools for the LocalAI framework and how to efficiently manage and utilize these tools,
...
LocalAI supports async tools for non-blocking I/O operations. This is useful when your tool needs to make HTTP requests, database queries, or other I/O-bound operations.
...
you can leverage the full capabilities of the LocalAI framework, enhancing both the development experience and the efficiency of your AI agents.
