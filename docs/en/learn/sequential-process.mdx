...
description: A comprehensive guide to utilizing the sequential processes for task execution in LocalAI projects.
icon: forward
mode: "wide"
---
...
LocalAI offers a flexible framework for executing tasks in a structured manner, supporting both sequential and hierarchical processes. 
...
LocalAI supports both memory and caching features:
...
LocalAI tracks token usage across all tasks and agents. You can access these metrics after execution.
