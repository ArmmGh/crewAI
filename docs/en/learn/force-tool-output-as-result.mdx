...
description: Learn how to force tool output as the result in an Agent's task in LocalAI.
icon: wrench-simple
mode: "wide"
---
...
In LocalAI, you can force the output of a tool as the result of an agent's task. 
