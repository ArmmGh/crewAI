...
description: "Learn how to use annotations to properly structure agents, tasks, and components in LocalAI"
icon: "at"
mode: "wide"
---
...
Annotations in the LocalAI framework are used to decorate classes and methods, providing metadata and functionality to various components of your crew. These annotations help in organizing and structuring your code, making it more readable and maintainable.

## Available Annotations

The LocalAI framework provides the following annotations:
...
By following these guidelines and properly using annotations, you can create well-structured and maintainable crews using the LocalAI framework.
