...
description: A comprehensive guide to understanding and applying the hierarchical process within your LocalAI projects, updated to reflect the latest coding practices and functionalities.
icon: sitemap
mode: "wide"
---
...
The hierarchical process in LocalAI introduces a structured approach to task management, simulating traditional organizational hierarchies for efficient task delegation and execution. 
...
By default, tasks in LocalAI are managed through a sequential process. However, adopting a hierarchical approach allows for a clear hierarchy in task management, 
...
automatically created by LocalAI or explicitly set by the user.
...
Adopting the hierarchical process in LocalAI, with the correct configurations and understanding of the system's capabilities, facilitates an organized and efficient approach to project management. 
