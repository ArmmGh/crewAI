...
LocalAI treats [A2A protocol](https://a2a-protocol.org/latest/) as a first-class delegation primitive, enabling agents to delegate tasks, request information, and collaborate with remote agents, as well as act as A2A-compliant server agents.
...
4. Results are returned to the LocalAI workflow

<Note>
  A2A delegation requires the `a2a-sdk` package. Install with: `uv add 'localagents[a2a]'` or `pip install 'localagents[a2a]'`
</Note>

## Basic Configuration

<Warning>
  `localagents.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0. Use `A2AClientConfig` for connecting to remote agents and/or `A2AServerConfig` for exposing agents as servers.
</Warning>
...
from localagents.a2a import A2AClientConfig
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.auth import BearerTokenAuth
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.auth import APIKeyAuth
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.auth import OAuth2ClientCredentials
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.auth import HTTPBasicAuth
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.updates import PollingConfig
...
from localagents.a2a import A2AClientConfig
from localagents.a2a.updates import PushNotificationConfig
...
You can expose your LocalAI agents as A2A-compliant servers, allowing other A2A clients to delegate tasks to them.
...
from localagents.a2a import A2AServerConfig
...
```python Code
from localagents import Agent
from localagents.a2a import A2AClientConfig, A2AServerConfig
