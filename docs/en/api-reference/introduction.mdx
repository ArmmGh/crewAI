---
title: "Introduction"
description: "Complete reference for the LocalAI AMP REST API"
icon: "code"
mode: "wide"
---
...
Welcome to the LocalAI AMP API reference. This API allows you to programmatically interact with your deployed crews, enabling integration with your applications, workflows, and services.

## Quick Start

<Steps>
  <Step title="Get Your API Credentials">
    Navigate to your crew's detail page in the LocalAI AMP dashboard and copy your Bearer Token from the Status tab.
  </Step>
...
<Info>
  **Why no "Send" button?** Since each LocalAI AMP user has their own unique crew
...
2. **Replace `your-actual-crew-name.localagents.com`** with your real crew URL
