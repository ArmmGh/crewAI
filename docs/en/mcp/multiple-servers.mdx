...
description: Learn how to use MCPServerAdapter in LocalAI to connect to multiple MCP servers simultaneously and aggregate their tools.
icon: layer-group
mode: "wide"
---
...
`MCPServerAdapter` in `localagents-tools` allows you to connect to multiple MCP servers concurrently. This is useful when your agents need to access tools distributed across different services or environments. The adapter aggregates tools from all specified servers, making them available to your LocalAI agents.
