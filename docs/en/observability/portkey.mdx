...
description: How to use Portkey with LocalAI
icon: key
mode: "wide"
---
...
Portkey enhances LocalAI with production-readiness features, turning your experimental agent crews into robust systems by providing:
...
<Step title="Configure LocalAI with Portkey">
The integration is simple - you just need to update the LLM configuration in your LocalAI setup:
...
Portkey provides comprehensive observability for your LocalAI agents, helping you understand exactly what's happening during each execution.
...
Add custom metadata to your LocalAI LLM configuration to enable powerful filtering and segmentation:
...
It's simple to enable fallback in your LocalAI setup by using a Portkey Config:
...
### 3. Prompting in LocalAI

Portkey's Prompt Engineering Studio helps you create, manage, and optimize the prompts used in your LocalAI agents. Instead of hardcoding prompts or instructions, use Portkey's prompt rendering API to dynamically fetch and apply your versioned prompts.
...
This visual environment makes it easier to craft effective prompts for each step in your LocalAI agents' workflow.
  </Tab>
...
Guardrails ensure your LocalAI agents operate safely and respond appropriately in all situations.

**Why Use Guardrails?**

LocalAI agents can experience various failure modes:
...
Track individual users through your LocalAI agents using Portkey's metadata system.
...
Implement caching to make your LocalAI agents more efficient and cost-effective:
...
LocalAI supports multiple LLM providers, and Portkey extends this capability by providing access to over 200 LLMs through a unified interface. You can easily switch between different models without changing your core agent logic:
...
## Set Up Enterprise Governance for LocalAI

**Why Enterprise Governance?**
If you are using LocalAI inside your organization, you need to consider several governance aspects:
...
<Step title="Connect to LocalAI">
After setting up your Portkey API key with the attached config, connect it to your LocalAI agents:
...
```
  ...
  <Accordion title="Step 4: Deploy & Monitor">
    ...
    After distributing API keys to your team members, your enterprise-ready LocalAI setup is ready to go. Each team member can now use their designated API keys with appropriate access levels and budget controls.
...
**Your LocalAI integration now has:**
...
<AccordionGroup>
  <Accordion title="How does Portkey enhance LocalAI?">
    Portkey adds production-readiness to LocalAI through comprehensive observability (traces, logs, metrics), reliability features (fallbacks, retries, caching), and access to 200+ LLMs through a unified interface. This makes it easier to debug, optimize, and scale your agent applications.
  </Accordion>

  <Accordion title="Can I use Portkey with existing LocalAI applications?">
    Yes! Portkey integrates seamlessly with existing LocalAI applications. You just need to update your LLM configuration code with the Portkey-enabled version. The rest of your agent and crew code remains unchanged.
  </Accordion>

  <Accordion title="Does Portkey work with all LocalAI features?">
    Portkey supports all LocalAI features, including agents, tools, human-in-the-loop workflows, and all task process types (sequential, hierarchical, etc.). It adds observability and reliability without limiting any of the framework's functionality.
  </Accordion>
...
<CardGroup cols="3">
  <Card title="LocalAI Docs" icon="book" href="https://docs.localagents.com/">
    <p>Official LocalAI documentation</p>
  </Card>
