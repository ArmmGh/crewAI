...
[OpenLIT](https://github.com/openlit/openlit?src=localagents-docs) is an open-source tool that makes it simple to monitor the performance of AI agents, LLMs, VectorDBs, and GPUs with just **one** line of code. 
...
- **Model Playground** Test and compare different models for your LocalAI agents before deployment.
    ...
    <Step title="Initialize OpenLIT in Your Application">
      ...
      <Tabs>
        <Tab title="Setup using function arguments">
          ...
          Example Usage for monitoring a LocalAI Agent:
        ...
        <Tab title="Setup using Environment Variables">
          ...
          Example Usage for monitoring a LocalAI Async Agent:
