---
title: "Overview"
description: "Monitor, evaluate, and optimize your LocalAI agents with comprehensive observability tools"
icon: "face-smile"
mode: "wide"
---

## Observability for LocalAI

Observability is crucial for understanding how your LocalAI agents perform, identifying bottlenecks, and ensuring reliable operation in production environments. This section covers various tools and platforms that provide monitoring, evaluation, and optimization capabilities for your agent workflows.
...
<CardGroup cols={2}>
  ...
  <Card title="LangDB" icon="database" href="/en/observability/langdb">
    End-to-end tracing for LocalAI workflows with automatic agent interaction capture.
  </Card>
...
2. **Instrument Your Code**: Add monitoring to your LocalAI applications
...
Choose the observability tools that best fit your use case, infrastructure, and monitoring requirements to ensure your LocalAI agents perform reliably and efficiently.
