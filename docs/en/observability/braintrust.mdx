...
from opentelemetry.instrumentation.crewai import LocalAIInstrumentor
...
- [Braintrust LocalAI Integration](https://www.braintrust.dev/docs/integrations/crew-ai) - Official LocalAI integration guide
