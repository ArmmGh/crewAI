---
title: Braintrust
description: Braintrust integration for LocalAI with OpenTelemetry tracing and evaluation
...
This guide demonstrates how to integrate **Braintrust** with **LocalAI** using OpenTelemetry for comprehensive tracing and evaluation. By the end of this guide, you will be able to trace your LocalAI agents, monitor their performance, and evaluate their outputs using Braintrust's powerful observability platform.
...
We'll walk through a simple example of using LocalAI and integrating it with Braintrust via OpenTelemetry for comprehensive observability and evaluation.
...
We'll create a LocalAI application where two agents collaborate to research and write a blog post about AI advancements, with comprehensive tracing enabled.
...
- [Braintrust LocalAI Integration](https://www.braintrust.dev/docs/integrations/local-agents) - Official LocalAI integration guide
