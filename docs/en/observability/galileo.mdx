---
title: Galileo
description: Galileo integration for LocalAI tracing and evaluation
icon: telescope
mode: "wide"
---
...
This guide demonstrates how to integrate **Galileo** with **LocalAI**
for comprehensive tracing and Evaluation Engineering.
By the end of this guide, you will be able to trace your LocalAI agents,
...
This tutorial follows the [LocalAI quickstart](/en/quickstart) and shows how to add
Galileo's [LocalAIEventListener](https://v2docs.galileo.ai/sdk-api/python/reference/handlers/localagents/handler),
an event handler.
For more information, see Galileo’s
[Add Galileo to a LocalAI Application](https://v2docs.galileo.ai/how-to-guides/third-party-integrations/add-galileo-to-localagents/add-galileo-to-localagents)
how-to guide.

> **Note** This tutorial assumes you have completed the [LocalAI quickstart](/en/quickstart).
If you want a completed comprehensive example, see the Galileo
[LocalAI sdk-example repo](https://github.com/rungalileo/sdk-examples/tree/main/python/agent/local-agents).
...
### Step 2: Add to the .env file from the [LocalAI quickstart](/en/quickstart)
...
To enable logging with Galileo, you need to create an instance of the `LocalAIEventListener`.
Import the Galileo LocalAI handler package by
...
Run your crew with the LocalAI CLI:
...
Galileo integrates with LocalAI by registering an event listener
...
Creating a `LocalAIEventListener()` instance is all that’s
required to enable Galileo for a LocalAI run. When instantiated, the listener:

- Automatically registers itself with LocalAI
