...
Maxim AI provides comprehensive agent monitoring, evaluation, and observability for your LocalAI applications. With Maxim's one-line integration, you can easily trace and analyse agent interactions, performance metrics, and more.

## Features

### Prompt Management

Maxim's Prompt Management capabilities enable you to create, organize, and optimize prompts for your LocalAI agents. Rather than hardcoding instructions, leverage Maxim’s SDK to dynamically retrieve and apply version-controlled prompts.
...
<Tabs>
  <Tab title="Prompt Playground">
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_playground.png'> </img>
  </Tab>
  <Tab title="Prompt Versions">
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_versions.png'> </img>
  </Tab>
...
Maxim AI provides comprehensive observability & evaluation for your LocalAI agents, helping you understand exactly what's happening during each execution.
...
<Tabs>
  <Tab title="Agent Tracing">
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_agent_tracking.png'> </img>
  </Tab>
  <Tab title="Analytics + Evals">
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_trace_eval.png'> </img>
  ...
  <Tab title="Alerting">
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_alerts_1.png'> </img>
  </Tab>
  <Tab title="Dashboards">
    Visualize Traces over time, usage metrics, latency & error rates with ease.

    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/maxim_dashboard_1.png'> </img>
  </Tab>
</Tabs>
...
from maxim.logger.localagents import instrument_localagents
```
...
```python {8}
# Instrument LocalAI with just one line
instrument_localagents(Maxim().logger())
```

### 4. Create and run your LocalAI application as usual
...
That's it\! All your LocalAI agent interactions will now be logged and available in your Maxim dashboard.
...
After running your LocalAI application:
...
3. View detailed agent traces, including:
   ...
   - Cost analytics
    ...
    <img src='https://raw.githubusercontent.com/akmadan/localAI/docs_maxim_observability/docs/images/localagents_traces.gif'> </img>
...
- Ensure you've **`called instrument_localagents()`** **_before_** running your crew. This initializes logging hooks correctly.
- Set `debug=True` in your `instrument_localagents()` call to surface any internal errors:

  ```python
  instrument_localagents(logger, debug=True)
  ```
- Configure your agents with `verbose=True` to capture detailed logs:
  ...
  ```
- Double-check that `instrument_localagents()` is called **before** creating or executing agents. This might be obvious, but it's a common oversight.

## Resources

<CardGroup cols="3">
  <Card title="LocalAI Docs" icon="book" href="https://docs.localagents.com/">
    Official LocalAI documentation
  </Card>
