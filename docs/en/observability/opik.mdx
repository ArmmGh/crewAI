...
description: Learn how to use Comet Opik to debug, evaluate, and monitor your LocalAI applications with comprehensive tracing, automated evaluations, and production-ready dashboards. 
icon: meteor
mode: "wide"
---
...
<Frame caption="Opik Agent Dashboard">
  <img src="/images/opik-localagents-dashboard.png" alt="Opik agent monitoring example with LocalAI" />
</Frame>

Opik provides comprehensive support for every stage of your LocalAI application development:
...
To use the hosted version, simply [create a free Comet account](https://www.comet.com/signup?utm_medium=github&utm_source=localagents_docs) and grab you API Key.
...
For this guide we will use LocalAI’s quickstart example.
...
<Steps>
    ...
    <Step title="Using LocalAI">
      The first step is to create our project. We will use an example from LocalAI’s documentation:
      ...
      print(result)
      ```
      After running your LocalAI application, visit the Opik app to view:
