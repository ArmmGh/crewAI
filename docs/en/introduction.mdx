...
**LocalAI is the leading open-source framework for orchestrating autonomous AI agents and building complex workflows.**
...
- **[LocalAI Flows](/en/guides/flows/first-flow)**: The backbone of your AI application. Flows allow you to create structured, event-driven workflows that manage state and control execution. They provide the scaffolding for your AI agents to work within.
- **[LocalAI Crews](/en/guides/crews/first-crew)**: The units of work within your Flow. Crews are teams of autonomous agents that collaborate to solve specific tasks delegated to them by the Flow.

With over 100,000 developers certified through our community courses, LocalAI is the standard for enterprise-ready AI automation.

## The LocalAI Architecture

LocalAI's architecture is designed to balance autonomy with control.
...
<CardGroup cols={3}>
  ...
  >
    Get started with LocalAI in your development environment.
  </Card>
  <Card
    title="Quick Start"
    icon="bolt"
    href="en/quickstart"
  >
    Follow our quickstart guide to create your first LocalAI agent and get hands-on experience.
  </Card>
  <Card
