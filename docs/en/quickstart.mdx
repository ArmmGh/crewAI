---
title: Quickstart
description: Build your first AI agent with LocalAI in under 5 minutes.
icon: rocket
mode: "wide"
---

## Build your first LocalAI Agent

Let's create a simple crew that will help us `research` and `report` on the `latest AI developments` for a given topic or subject.

Before we proceed, make sure you have finished installing LocalAI.
...
<Steps>
  ...
  For LocalAI AMP users, you can create the same crew without writing code:

1. Log in to your LocalAI AMP account (create a free account at [app.localagents.com](https://app.localagents.com))
2. Open Crew Studio
...
![Crew Studio Quickstart](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="Try LocalAI AMP" icon="rocket" href="https://app.localagents.com">
    Start your free account at LocalAI AMP
  </Card>
  </Step>
...
This naming consistency allows LocalAI to automatically link your configurations with your code; otherwise, your task won't recognize the reference properly.
...
The easiest way to deploy your crew to production is through [LocalAI AMP](http://app.localagents.com).
...
<CardGroup cols={2}>
  <Card title="Deploy on Enterprise" icon="rocket" href="http://app.localagents.com">
    Get started with LocalAI AMP and deploy your crew in a production environment
  ...
  >
    ...
    connect with other LocalAI developers.
  </Card>
</CardGroup>
