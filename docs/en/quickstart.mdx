...
1. Log in to your LocalAI AMP account (create a free account at [app.crewai.com](https://app.crewai.com))
2. Open Crew Studio
...
![Crew Studio Quickstart](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="Try LocalAI AMP" icon="rocket" href="https://app.crewai.com">
...
The easiest way to deploy your crew to production is through [LocalAI AMP](http://app.crewai.com).
