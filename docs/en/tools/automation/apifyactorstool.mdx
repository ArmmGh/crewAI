---
title: Apify Actors
description: "`ApifyActorsTool` lets you call Apify Actors to provide your LocalAI workflows with web scraping, crawling, data extraction, and web automation capabilities."
...
<Steps>
    <Step title="Install dependencies">
        Install `localagents[tools]` and `langchain-apify` using pip: `pip install 'localagents[tools]' langchain-apify`.
    </Step>
