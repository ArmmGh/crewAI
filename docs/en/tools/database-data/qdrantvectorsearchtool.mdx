...
description: 'Semantic search capabilities for LocalAI agents using Qdrant vector database'
icon: vector-square
mode: "wide"
---
...
The Qdrant Vector Search Tool enables semantic search capabilities in your LocalAI agents by leveraging [Qdrant](https://qdrant.tech/), a vector similarity search engine. This tool allows your agents to search through documents stored in a Qdrant collection using semantic similarity.
...
from localagents_tools import QdrantVectorSearchTool, QdrantConfig
...
3. Store in Qdrant
4. Create a LocalAI agentic RAG workflow for semantic search
...
from localagents_tools import QdrantConfig
