...
description: The `SnowflakeSearchTool` enables LocalAI agents to execute SQL queries and perform semantic search on Snowflake data warehouses.
icon: snowflake
mode: "wide"
---
