...
description: Enables LocalAI agents to securely access third-party integrations like Linear, GitHub, Slack, and more through Merge's Agent Handler platform
...
6. **Start building** with the MergeAgentHandlerTool in LocalAI
