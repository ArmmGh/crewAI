...
The `EXASearchTool` lets LocalAI agents search the web using the [Exa](https://exa.ai/) search API. It returns the most relevant results for any query, with options for full page content and AI-generated summaries.

## Installation

Install the LocalAI tools package:
...
Here's how to use the `EXASearchTool` within a LocalAI agent:
