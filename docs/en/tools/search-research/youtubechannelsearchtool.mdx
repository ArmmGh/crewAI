...
The following example demonstrates how to use the `YoutubeChannelSearchTool` with a LocalAI agent:
...
Here's a more detailed example of how to integrate the `YoutubeChannelSearchTool` with a LocalAI agent:
