...
Extract text from images (local path or URL). Uses a vision‑capable LLM via LocalAI’s LLM interface.

## Installation

No extra install beyond `localagents-tools`. Ensure your selected LLM supports vision.
