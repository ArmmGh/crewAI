...
To utilize the DirectoryReadTool in your project, install the `localagents_tools` package. If this package is not yet part of your environment, you can install it using pip with the command below:

```shell
pip install 'localagents[tools]'
```

This command installs the latest version of the `localagents_tools` package, granting access to the DirectoryReadTool among other utilities.
