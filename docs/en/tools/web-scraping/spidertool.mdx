...
[Spider](https://spider.cloud/?ref=localagents) is the [fastest](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md#benchmark-results) 
...
and the `localagents[tools]` SDK too:
