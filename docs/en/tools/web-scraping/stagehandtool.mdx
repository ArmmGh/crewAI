...
description: Web automation tool that integrates Stagehand with LocalAI for browser interaction and automation
icon: hand
mode: "wide"
---
...
The `StagehandTool` integrates the [Stagehand](https://docs.stagehand.dev/get_started/introduction) framework with LocalAI, enabling agents to interact with websites and automate browser tasks using natural language instructions.
...
The StagehandTool wraps the Stagehand Python SDK to provide LocalAI agents with browser control capabilities through three core primitives:
...
For questions about the LocalAI integration:
