---
title: الوكلاء
description: دليل تفصيلي حول إنشاء وإدارة الوكلاء ضمن إطار عمل LocalAI.
icon: robot
mode: "wide"
---
...
في إطار عمل LocalAI، الـ `Agent` هو وحدة مستقلة يمكنها:
...
يتضمن LocalAI AMP منشئ وكلاء مرئي يبسّط إنشاء وتهيئة الوكلاء بدون كتابة كود. صمم وكلاءك بصريًا واختبرهم في الوقت الفعلي.
...
هناك طريقتان لإنشاء الوكلاء في LocalAI: باستخدام **تهيئة YAML (موصى بها)** أو تعريفهم **مباشرة في الكود**.

### تهيئة YAML (موصى بها)

توفر تهيئة YAML طريقة أنظف وأكثر قابلية للصيانة لتعريف الوكلاء. نوصي بشدة باستخدام هذا النهج في مشاريع LocalAI.

بعد إنشاء مشروع LocalAI كما هو موضح في قسم [التثبيت](/ar/installation)، انتقل إلى ملف `src/latest_ai_development/config/agents.yaml` وعدّل القالب ليتوافق مع متطلباتك.
...
يمكن تجهيز الوكلاء بأدوات متنوعة لتعزيز قدراتهم. يدعم LocalAI أدوات من:

- [مجموعة أدوات LocalAI](https://github.com/joaomdmoura/localagents-tools)
