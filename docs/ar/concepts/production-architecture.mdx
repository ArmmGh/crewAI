---
title: بنية الإنتاج
description: أفضل الممارسات لبناء تطبيقات ذكاء اصطناعي جاهزة للإنتاج مع LocalAI
icon: server
mode: "wide"
---
...
عند بناء تطبيقات ذكاء اصطناعي إنتاجية مع LocalAI، **نوصي بالبدء بتدفق (Flow)**.
...
3. **المراقبة**: توفر التدفقات هيكلًا واضحًا يسهّل تتبع التنفيذ وتصحيح الأخطاء ومراقبة الأداء. نوصي باستخدام [تتبع LocalAI](/ar/observability/tracing) للحصول على رؤى تفصيلية. ما عليك سوى تشغيل `localagents login` لتفعيل ميزات المراقبة المجانية.

## البنية

يبدو تطبيق LocalAI الإنتاجي النموذجي هكذا:
...
استفد من عناصر التحكم الأولية في LocalAI لإضافة المتانة والتحكم إلى أطقمك.
...
### LocalAI Enterprise
أسهل طريقة لنشر تدفقك هي استخدام LocalAI Enterprise. تتعامل مع البنية التحتية والمصادقة والمراقبة نيابة عنك.
