---
title: التخطيط
description: تعرّف على كيفية إضافة التخطيط إلى طاقم LocalAI وتحسين أدائه.
icon: ruler-combined
mode: "wide"
---
...
تتيح لك ميزة التخطيط في LocalAI إضافة قدرة التخطيط إلى طاقمك. عند تفعيلها، قبل كل تكرار للطاقم،
...
<Warning>
عند تفعيل التخطيط، سيستخدم LocalAI `gpt-4o-mini` كنموذج LLM افتراضي للتخطيط، مما يتطلب مفتاح API صالحًا من OpenAI. نظرًا لأن وكلاءك قد يستخدمون نماذج LLM مختلفة، فقد يسبب ذلك ارتباكًا إذا لم يكن لديك مفتاح OpenAI API مهيأ أو إذا كنت تواجه سلوكًا غير متوقع متعلقًا باستدعاءات LLM API.
</Warning>
