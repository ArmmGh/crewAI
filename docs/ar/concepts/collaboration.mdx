---
title: التعاون
description: كيفية تمكين الوكلاء من العمل معًا وتفويض المهام والتواصل بفعالية داخل فرق LocalAI.
icon: screen-users
mode: "wide"
---
...
يُمكّن التعاون في LocalAI الوكلاء من العمل معًا كفريق عن طريق تفويض المهام وطرح الأسئلة للاستفادة من خبرات بعضهم البعض. عندما يكون `allow_delegation=True`، يحصل الوكلاء تلقائيًا على أدوات تعاون قوية.
...
عندما يكون `allow_delegation=True`، يوفر LocalAI تلقائيًا للوكلاء أداتين قويتين:
