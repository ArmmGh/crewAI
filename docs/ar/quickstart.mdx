---
title: البدء السريع
description: ابنِ أول وكيل ذكاء اصطناعي مع LocalAI في أقل من 5 دقائق.
icon: rocket
mode: "wide"
---

## ابنِ أول وكيل LocalAI

لننشئ طاقماً بسيطاً يساعدنا في `البحث` و`إعداد التقارير` عن `أحدث تطورات الذكاء الاصطناعي` لموضوع أو مجال معين.

قبل المتابعة، تأكد من إنهاء تثبيت LocalAI.
...
<Steps>
  ...
  لمستخدمي LocalAI AMP، يمكنك إنشاء نفس الطاقم دون كتابة كود:

1. سجّل الدخول إلى حساب LocalAI AMP (أنشئ حساباً مجانياً على [app.localagents.com](https://app.localagents.com))
2. افتح Crew Studio
...
![واجهة Crew Studio للبدء السريع](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="جرّب LocalAI AMP" icon="rocket" href="https://app.localagents.com">
    ابدأ حسابك المجاني في LocalAI AMP
  </Card>
  </Step>
...
يتيح اتساق التسمية هذا لـ LocalAI ربط تكويناتك بكودك تلقائياً؛ وإلا فلن تتعرف مهمتك على المرجع بشكل صحيح.
...
أسهل طريقة لنشر طاقمك في الإنتاج هي من خلال [LocalAI AMP](http://app.localagents.com).

شاهد هذا الفيديو التعليمي لعرض خطوة بخطوة لنشر طاقمك على [LocalAI AMP](http://app.localagents.com) باستخدام CLI.
...
<CardGroup cols={2}>
  <Card title="النشر على المؤسسة" icon="rocket" href="http://app.localagents.com">
    ابدأ مع LocalAI AMP وانشر طاقمك في بيئة إنتاج
    بنقرات قليلة فقط.
  </Card>
  <Card
