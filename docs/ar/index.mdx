...
<CardGroup cols={3}>
  <Card title="مقدمة" href="/ar/introduction" icon="sparkles">
    نظرة عامة على مفاهيم LocalAI وبنيته المعمارية وما يمكنك بناؤه باستخدام Agents وCrews وFlows.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="أدوات التكامل" href="/ar/tools/integration/overview" icon="plug">
    استدعاء أتمتة LocalAI الحالية أو Amazon Bedrock Agents مباشرة من Crews باستخدام مجموعة أدوات التكامل المحدّثة.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="امنحنا نجمة على GitHub" href="https://github.com/localAIInc/localAI" icon="star">
    إذا ساعدك LocalAI في الإطلاق بشكل أسرع، امنحنا نجمة وشارك مشاريعك مع المجتمع.
  </Card>
  <Card title="انضم إلى المجتمع" href="https://community.localagents.com" icon="comments">
