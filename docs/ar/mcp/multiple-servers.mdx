...
description: تعلم كيفية استخدام MCPServerAdapter في LocalAI للاتصال بخوادم MCP متعددة بشكل متزامن وتجميع أدواتها.
icon: layer-group
mode: "wide"
---
...
يتيح لك `MCPServerAdapter` في `localagents-tools` الاتصال بخوادم MCP متعددة بشكل متزامن. هذا مفيد عندما يحتاج وكلاؤك للوصول إلى أدوات موزعة عبر خدمات أو بيئات مختلفة. يجمع المحول الأدوات من جميع الخوادم المحددة، مما يجعلها متاحة لوكلاء LocalAI.
