---
title: تكامل MCP DSL
description: تعلم كيفية استخدام صياغة DSL البسيطة في LocalAI لدمج خوادم MCP مباشرة مع وكلائك باستخدام حقل mcps.
icon: code
mode: "wide"
---
...
يوفر تكامل MCP DSL (لغة المجال المحددة) في LocalAI **الطريقة الأبسط** لربط وكلائك بخوادم MCP (بروتوكول سياق النموذج). ما عليك سوى إضافة حقل `mcps` إلى وكيلك وسيتعامل LocalAI مع كل التعقيدات تلقائياً.
...
يتعامل LocalAI تلقائياً مع تسمية الأدوات لمنع التعارضات:
...
تعمل أدوات MCP بسلاسة مع ميزات LocalAI الأخرى:
