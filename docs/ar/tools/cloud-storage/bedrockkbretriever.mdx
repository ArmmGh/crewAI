...
تمكّن `BedrockKBRetrieverTool` وكلاء LocalAI من استرجاع المعلومات من قواعد معرفة Amazon Bedrock باستخدام استعلامات اللغة الطبيعية.
...
- تمكين وكلاء LocalAI من الوصول إلى المعرفة الخاصة بمؤسستك دون كشف البيانات الحساسة
...
- ربط وكلاء LocalAI بقواعد معرفة متخصصة بالمجال (قانونية، طبية، تقنية) دون إعادة تدريب النماذج
- الاستفادة من مستودعات المعرفة الموجودة المُدارة بالفعل في بيئة AWS
- الجمع بين تفكير LocalAI والمعلومات المتخصصة من قواعد معرفتك

### اتخاذ القرارات المبنية على البيانات
- تأسيس استجابات وكلاء LocalAI على بيانات شركتك الفعلية بدلاً من المعرفة العامة
...
### الامتثال والحوكمة
- ضمان تقديم وكلاء LocalAI لاستجابات تتوافق مع وثائق شركتك المعتمدة
