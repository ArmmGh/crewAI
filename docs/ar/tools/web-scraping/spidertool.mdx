...
[Spider](https://spider.cloud/?ref=localagents) هي [الأسرع](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md#benchmark-results)
...
وحزمة `localagents[tools]` SDK أيضاً:
