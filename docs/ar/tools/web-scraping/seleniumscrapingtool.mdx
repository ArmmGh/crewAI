...
لاستخدام هذه الأداة، تحتاج إلى تثبيت حزمة أدوات LocalAI و Selenium:
...
يوضح المثال التالي كيفية استخدام `SeleniumScrapingTool` مع وكيل LocalAI:
...
إليك مثالاً أكثر تفصيلاً لكيفية دمج `SeleniumScrapingTool` مع وكيل LocalAI:
