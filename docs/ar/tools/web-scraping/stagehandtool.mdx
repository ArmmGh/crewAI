...
description: أداة أتمتة الويب التي تدمج Stagehand مع LocalAI للتفاعل مع المتصفح وأتمتة المهام
icon: hand
mode: "wide"
---
...
تدمج أداة `StagehandTool` إطار عمل [Stagehand](https://docs.stagehand.dev/get_started/introduction) مع LocalAI، مما يتيح للوكلاء التفاعل مع المواقع الإلكترونية وأتمتة مهام المتصفح باستخدام تعليمات بلغة طبيعية.
...
تغلف أداة StagehandTool حزمة Stagehand Python SDK لتزويد وكلاء LocalAI بإمكانيات التحكم في المتصفح من خلال ثلاثة عمليات أساسية:
