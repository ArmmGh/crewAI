...
استخراج النص من الصور (مسار محلي أو عنوان URL). تستخدم نموذج LLM مزوداً بالرؤية عبر واجهة LLM الخاصة بـ LocalAI.

## التثبيت

لا حاجة لتثبيت إضافي بخلاف `localagents-tools`. تأكد من أن النموذج المحدد يدعم الرؤية.
