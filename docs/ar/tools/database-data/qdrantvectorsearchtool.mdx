...
description: 'إمكانيات البحث الدلالي لوكلاء LocalAI باستخدام قاعدة بيانات Qdrant المتجهية'
icon: vector-square
mode: "wide"
---
...
تتيح أداة البحث المتجهي Qdrant إمكانيات البحث الدلالي في وكلاء LocalAI من خلال الاستفادة من [Qdrant](https://qdrant.tech/)، محرك بحث التشابه المتجهي. تسمح هذه الأداة لوكلائك بالبحث في المستندات المخزنة في مجموعة Qdrant باستخدام التشابه الدلالي.
...
3. التخزين في Qdrant
4. إنشاء سير عمل RAG وكيلي باستخدام LocalAI للبحث الدلالي
