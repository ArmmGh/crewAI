...
يمكن تثبيت حزمة `localagents_tools`، التي ستتضمن أداة PGSearchTool عند إصدارها، باستخدام الأمر التالي:
...
<Note>
    أداة PGSearchTool غير متاحة بعد في الإصدار الحالي من حزمة `localagents_tools`. سيتم تحديث أمر التثبيت هذا بمجرد إصدار الأداة.
</Note>
