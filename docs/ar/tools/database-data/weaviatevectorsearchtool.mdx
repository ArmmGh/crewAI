...
1. **تثبيت الحزمة**: تأكد من تثبيت حزمتي `localagents[tools]` و `weaviate-client` في بيئة Python الخاصة بك.
...
إليك كيفية دمج `WeaviateVectorSearchTool` مع وكيل LocalAI:
