...
description: "اكتشف مكتبة LocalAI الواسعة التي تضم أكثر من 40 أداة لتعزيز قدرات وكلاء الذكاء الاصطناعي"
icon: "toolbox"
mode: "wide"
---

توفر LocalAI مكتبة واسعة من الأدوات الجاهزة لتعزيز قدرات وكلائك. من معالجة الملفات إلى استخراج بيانات الويب، ومن استعلامات قواعد البيانات إلى خدمات الذكاء الاصطناعي - لدينا ما تحتاجه.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    color="#0891B2"
  >
    دمج LocalAI مع الأنظمة الخارجية مثل Amazon Bedrock ومجموعة أدوات أتمتة LocalAI.
  </Card>
</CardGroup>
...
لاستخدام أي أداة في مشروع LocalAI الخاص بك:
