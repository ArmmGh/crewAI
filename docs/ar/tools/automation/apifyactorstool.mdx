...
للتفاصيل، راجع [تكامل Apify LocalAI](https://docs.apify.com/platform/integrations/crewai) في وثائق Apify.
...
لمثال على الاستخدام مع الوكلاء، راجع [قالب LocalAI Actor](https://apify.com/templates/python-crewai).
...
- **[دليل تكامل LocalAI](https://docs.apify.com/platform/integrations/crewai)**: اتبع الدليل الرسمي لتكامل Apify وLocalAI.
