---
title: أداة MultiOn
description: تمكّن `MultiOnTool` وكلاء LocalAI من التنقل والتفاعل مع الويب من خلال تعليمات اللغة الطبيعية.
icon: globe
mode: "wide"
---
...
صُممت `MultiOnTool` لتغليف قدرات تصفح الويب الخاصة بـ [MultiOn](https://docs.multion.ai/welcome)، مما يمكّن وكلاء LocalAI من التحكم في متصفحات الويب باستخدام تعليمات اللغة الطبيعية. تسهّل هذه الأداة تصفح الويب بسلاسة، مما يجعلها أصلاً أساسياً للمشاريع التي تتطلب تفاعلاً ديناميكياً مع بيانات الويب وأتمتة المهام المستندة إلى الويب.
...
1. **تثبيت LocalAI**: تأكد من تثبيت حزمة `localagents[tools]` في بيئة Python.
...
`MultiOnTool` منفذة كفئة فرعية من `BaseTool` في LocalAI. تغلف عميل MultiOn لتوفير قدرات تصفح الويب:
...
توفر `MultiOnTool` طريقة قوية لدمج قدرات تصفح الويب في وكلاء LocalAI. من خلال تمكين الوكلاء من التفاعل مع المواقع عبر تعليمات اللغة الطبيعية، تفتح مجموعة واسعة من الإمكانيات للمهام المستندة إلى الويب، من جمع البيانات والبحث إلى التفاعلات الآلية مع خدمات الويب.
