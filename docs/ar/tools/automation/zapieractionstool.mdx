...
description: يعرض `ZapierActionsAdapter` إجراءات Zapier كأدوات LocalAI للأتمتة.
icon: bolt
mode: "wide"
---
...
استخدم محول Zapier لسرد واستدعاء إجراءات Zapier كأدوات LocalAI. يمكّن هذا الوكلاء من تشغيل عمليات الأتمتة عبر آلاف التطبيقات.

## التثبيت

هذا المحول مضمّن مع `localagents-tools`. لا يلزم تثبيت إضافي.
