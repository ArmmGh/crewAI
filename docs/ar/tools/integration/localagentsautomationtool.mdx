...
توفر `InvokeCrewAIAutomationTool` تكاملاً مع واجهة برمجة تطبيقات منصة LocalAI مع خدمات الأطقم الخارجية. تتيح لك هذه الأداة استدعاء أتمتة منصة LocalAI والتفاعل معها من داخل وكلاء LocalAI، مما يمكّن التكامل السلس بين سير عمل الأطقم المختلفة.
