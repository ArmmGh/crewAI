---
title: أداة تشغيل أتمتة LocalAI
description: تتيح لوكلاء LocalAI استدعاء أتمتة منصة LocalAI والاستفادة من خدمات الأطقم الخارجية ضمن سير العمل الخاص بك.
icon: robot
---

# `InvokeLocalAgentsAutomationTool`

توفر `InvokeLocalAgentsAutomationTool` تكاملاً مع واجهة برمجة تطبيقات منصة LocalAI مع خدمات الأطقم الخارجية. تتيح لك هذه الأداة استدعاء أتمتة منصة LocalAI والتفاعل معها من داخل وكلاء LocalAI، مما يمكّن التكامل السلس بين سير عمل الأطقم المختلفة.
...
- الوصول إلى واجهة برمجة تطبيقات منصة LocalAI
- رمز حامل صالح للمصادقة
- الوصول الشبكي إلى نقاط نهاية أتمتة منصة LocalAI

## الاستخدام

إليك كيفية استخدام الأداة مع وكيل LocalAI:
...
|:---------|:-----|:---------|:--------|:------------|
| **crew_api_url** | `str` | نعم | None | عنوان URL الأساسي لواجهة برمجة تطبيقات أتمتة منصة LocalAI |
...
- توسيع المعالجة من خلال توزيع أعباء العمل عبر أتمتة منصة LocalAI المتعددة

### التكامل عبر المنصات
- ربط وكلاء LocalAI مع أتمتة منصة LocalAI لسير عمل محلي-سحابي هجين
...
- **أخطاء اتصال API**: مشكلات الاتصال الشبكي مع منصة LocalAI
