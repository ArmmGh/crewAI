...
description: تتيح لوكلاء LocalAI الوصول بأمان إلى تكاملات الأطراف الثالثة مثل Linear و GitHub و Slack والمزيد من خلال منصة معالج الوكيل من Merge
...
6. **البدء بالبناء** مع MergeAgentHandlerTool في LocalAI
