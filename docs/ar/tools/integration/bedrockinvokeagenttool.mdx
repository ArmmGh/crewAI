...
description: تتيح لوكلاء LocalAI استدعاء وكلاء Amazon Bedrock والاستفادة من قدراتهم ضمن سير العمل الخاص بك
icon: aws
mode: "wide"
---
...
تتيح `BedrockInvokeAgentTool` لوكلاء LocalAI استدعاء وكلاء Amazon Bedrock والاستفادة من قدراتهم ضمن سير العمل الخاص بك.
...
- إنشاء سير عمل حيث يتعاون وكلاء LocalAI مع وكلاء Bedrock المُدارة التي تعمل كخدمات في AWS
- تمكين سيناريوهات حيث تتم معالجة البيانات الحساسة داخل بيئة AWS الخاصة بك بينما تعمل وكلاء أخرى خارجياً
- ربط وكلاء LocalAI المحلية مع وكلاء Bedrock السحابية لسير عمل ذكاء موزع

### سيادة البيانات والامتثال
- الحفاظ على سير عمل الوكلاء الحساسة للبيانات داخل بيئة AWS الخاصة بك مع السماح لوكلاء LocalAI الخارجية بتنسيق المهام
...
- تمكين وكلاء LocalAI من التفاعل مع خدمات AWS من خلال طلبات اللغة الطبيعية
...
- تفريغ المهام الحسابية المكثفة إلى وكلاء Bedrock المُدارة بينما تعمل المهام الخفيفة في LocalAI
- توسيع معالجة الوكلاء من خلال توزيع أعباء العمل بين وكلاء LocalAI المحلية ووكلاء Bedrock السحابية

### التعاون بين المؤسسات
- تمكين التعاون الآمن بين وكلاء LocalAI الخاصة بمؤسستك ووكلاء Bedrock الخاصة بالمؤسسات الشريكة
