---
title: "نظرة عامة"
description: "ربط وكلاء LocalAI مع الأتمتة الخارجية وخدمات الذكاء الاصطناعي المُدارة"
icon: "face-smile"
mode: "wide"
---

تتيح أدوات التكامل لوكلائك تسليم العمل إلى منصات أتمتة أخرى وخدمات ذكاء اصطناعي مُدارة. استخدمها عندما يحتاج سير العمل إلى استدعاء نشر LocalAI موجود أو تفويض مهام متخصصة لمزودين مثل Amazon Bedrock.
...
<CardGroup cols={2}>
  ...
  <Card title="أداة تشغيل أتمتة LocalAI" icon="robot" href="/ar/tools/integration/localagentsautomationtool">
    استدعاء أتمتة منصة LocalAI المباشرة، تمرير مدخلات مخصصة، واستقصاء النتائج مباشرة من وكيلك.
  </Card>
...
- **تسلسل الأتمتة**: بدء نشر LocalAI موجود من داخل طاقم أو تدفق آخر
- **تسليم المؤسسة**: توجيه المهام إلى وكلاء Bedrock التي تغلف بالفعل منطق الشركة وحواجز الحماية
- **سير العمل الهجين**: الجمع بين تفكير LocalAI والأنظمة اللاحقة التي تكشف واجهات برمجة تطبيقات الوكلاء الخاصة بها
...
- **مراقبة الاستخدام**: تتبع سجلات المراجعة في منصة LocalAI أو AWS CloudWatch للبقاء على اطلاع بحدود الحصص والأعطال
