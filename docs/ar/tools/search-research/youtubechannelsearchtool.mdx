...
لاستخدام YoutubeChannelSearchTool، يجب تثبيت حزمة `localagents_tools`. نفّذ الأمر التالي في الطرفية للتثبيت:
...
يوضح المثال التالي كيفية استخدام `YoutubeChannelSearchTool` مع وكيل LocalAI:
...
إليك مثالاً أكثر تفصيلاً لكيفية دمج `YoutubeChannelSearchTool` مع وكيل LocalAI:
