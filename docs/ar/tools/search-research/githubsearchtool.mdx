...
لاستخدام GithubSearchTool، تأكد أولاً من تثبيت حزمة localagents_tools في بيئة Python الخاصة بك:

```shell
pip install 'localagents[tools]'
```

يثبّت هذا الأمر الحزمة اللازمة لتشغيل GithubSearchTool مع أي أدوات أخرى مضمنة في حزمة localagents_tools.
