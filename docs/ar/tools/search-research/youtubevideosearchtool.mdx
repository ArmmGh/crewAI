...
هذه الأداة جزء من حزمة `localagents_tools` وهي مصممة لإجراء عمليات بحث دلالية داخل محتوى فيديو YouTube، باستخدام تقنيات التوليد المعزز بالاسترجاع (RAG).
...
لاستخدام `YoutubeVideoSearchTool`، يجب أولاً تثبيت حزمة `localagents_tools`.
...
يوضح المثال التالي كيفية استخدام `YoutubeVideoSearchTool` مع وكيل LocalAI:
...
إليك مثالاً أكثر تفصيلاً لكيفية دمج `YoutubeVideoSearchTool` مع وكيل LocalAI:
