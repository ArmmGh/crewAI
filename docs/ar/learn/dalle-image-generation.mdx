...
description: "تعلم كيفية استخدام DALL-E لإنشاء صور مدعومة بالذكاء الاصطناعي في مشاريع LocalAI"
icon: "image"
mode: "wide"
---

يدعم LocalAI التكامل مع DALL-E من OpenAI، مما يتيح لـ Agents الذكاء الاصطناعي إنشاء صور كجزء من مهامهم. سيرشدك هذا الدليل عبر كيفية إعداد واستخدام أداة DALL-E في مشاريع LocalAI.

## المتطلبات المسبقة

- localAI مثبّت (أحدث إصدار)
...
2. **توافق الإصدارات** - تأكد من استخدام أحدث إصدار من localAI وlocalagents-tools.
