...
description: تعلم كيفية إنشاء تنفيذات LLM مخصصة في LocalAI.
icon: code
mode: "wide"
---
...
يدعم LocalAI تنفيذات LLM المخصصة من خلال فئة `BaseLLM` المجردة. يتيح لك ذلك دمج أي مزود LLM لا يحظى بدعم مدمج في LiteLLM، أو تنفيذ آليات مصادقة مخصصة.
...
يغطي هذا الدليل أساسيات تنفيذ LLM مخصصة في LocalAI.
