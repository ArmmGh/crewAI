...
description: دليل شامل لاستخدام العمليات التسلسلية لتنفيذ المهام في مشاريع LocalAI.
icon: forward
mode: "wide"
---
...
يقدم LocalAI إطار عمل مرن لتنفيذ المهام بطريقة منظمة، يدعم كلاً من العمليات التسلسلية والهرمية.
...
يدعم LocalAI كلاً من ميزتي الذاكرة والتخزين المؤقت:
...
يتتبع LocalAI استخدام الرموز عبر جميع المهام والوكلاء. يمكنك الوصول إلى هذه المقاييس بعد التنفيذ.
