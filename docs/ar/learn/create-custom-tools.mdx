...
description: دليل شامل لصياغة واستخدام وإدارة الأدوات المخصصة ضمن إطار عمل LocalAI، بما في ذلك الوظائف الجديدة ومعالجة الأخطاء.
icon: hammer
mode: "wide"
---

## إنشاء واستخدام الأدوات في LocalAI

يقدم هذا الدليل تعليمات مفصلة لإنشاء أدوات مخصصة لإطار عمل LocalAI وكيفية إدارة واستخدام هذه الأدوات بكفاءة، مع دمج أحدث الوظائف مثل تفويض الأدوات ومعالجة الأخطاء واستدعاء الأدوات الديناميكي.
...
يدعم LocalAI الأدوات غير المتزامنة لعمليات I/O غير المحجوبة.
