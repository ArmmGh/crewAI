...
description: تعلم كيفية تعيين Agent مخصص كمدير في LocalAI، مما يوفر مزيدًا من التحكم في إدارة المهام والتنسيق.
icon: user-shield
mode: "wide"
---

# تعيين Agent محدد كمدير في LocalAI

يتيح LocalAI للمستخدمين تعيين Agent محدد كمدير للـ Crew، مما يوفر مزيدًا من التحكم في إدارة المهام وتنسيقها.
