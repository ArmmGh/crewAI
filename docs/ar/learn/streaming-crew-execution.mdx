...
description: بث المخرجات في الوقت الفعلي من تنفيذ طاقم LocalAI الخاص بك
icon: wave-pulse
mode: "wide"
---
...
يوفر LocalAI القدرة على بث المخرجات في الوقت الفعلي أثناء تنفيذ الطاقم، مما يتيح لك عرض النتائج فور توليدها بدلاً من انتظار اكتمال العملية بالكامل. هذه الميزة مفيدة بشكل خاص لبناء التطبيقات التفاعلية وتقديم تغذية راجعة للمستخدم ومراقبة العمليات طويلة التشغيل.

## كيف يعمل البث

عند تفعيل البث، يلتقط LocalAI استجابات LLM واستدعاءات الأدوات فور حدوثها، ويحزمها في أجزاء منظمة تتضمن سياقاً حول المهمة والوكيل المنفذ. يمكنك التكرار على هذه الأجزاء في الوقت الفعلي والوصول إلى النتيجة النهائية بمجرد اكتمال التنفيذ.
...
import asyncio
from localagents import Agent, Crew, Task
from localagents.types.streaming import StreamChunkType
...
من خلال الاستفادة من البث، يمكنك بناء تطبيقات أكثر استجابة وتفاعلية مع LocalAI، مما يوفر للمستخدمين رؤية فورية لتنفيذ الوكلاء والنتائج.
