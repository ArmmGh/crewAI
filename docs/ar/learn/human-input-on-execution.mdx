...
description: دمج LocalAI مع الإدخال البشري أثناء التنفيذ في عمليات اتخاذ القرارات المعقدة والاستفادة الكاملة من إمكانيات خصائص وأدوات الوكيل.
icon: user-plus
mode: "wide"
---
...
## استخدام الإدخال البشري مع LocalAI
