...
description: "تعلم كيفية استخدام التعليقات التوضيحية لتنظيم الوكلاء والمهام والمكونات بشكل صحيح في LocalAI"
icon: "at"
mode: "wide"
---
...
تُستخدم التعليقات التوضيحية في إطار عمل LocalAI لتزيين الفئات والطرق، مما يوفر بيانات وصفية ووظائف للمكونات المختلفة في طاقمك. تساعد هذه التعليقات التوضيحية في تنظيم وهيكلة الكود الخاص بك، مما يجعله أكثر قابلية للقراءة والصيانة.

## التعليقات التوضيحية المتاحة

يوفر إطار عمل LocalAI التعليقات التوضيحية التالية:
...
باتباع هذه الإرشادات واستخدام التعليقات التوضيحية بشكل صحيح، يمكنك إنشاء أطقم منظمة جيداً وسهلة الصيانة باستخدام إطار عمل LocalAI.
