...
description: "إطار عمل استراتيجي لاختيار نموذج اللغة الكبير المناسب لوكلاء الذكاء الاصطناعي في LocalAI وكتابة تعريفات فعالة للمهام والوكلاء"
icon: "brain-circuit"
mode: "wide"
---

## نهج LocalAI في اختيار LLM
