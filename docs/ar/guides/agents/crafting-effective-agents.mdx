...
في قلب LocalAI يكمن الـ Agent - كيان ذكاء اصطناعي متخصص مصمم لأداء أدوار محددة ضمن إطار تعاوني. بينما إنشاء Agents أساسية أمر بسيط، فإن صياغة Agents فعّالة حقًا تنتج نتائج استثنائية يتطلب فهم مبادئ التصميم الأساسية وأفضل الممارسات.
...
أقوى الـ Agents في LocalAI مبنية على أساس قوي من ثلاثة عناصر رئيسية:
...
- استكشف [LocalAI Flows](/ar/guides/flows/first-flow) لتنسيق أكثر تقدمًا
