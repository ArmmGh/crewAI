---
title: أدوات البرمجة
description: استخدم AGENTS.md لتوجيه أدوات البرمجة وبيئات التطوير عبر مشاريع LocalAI.
icon: terminal
mode: "wide"
---
...
استخدم CLI الخاص بـ LocalAI لإنشاء هيكل مشروع، وسيُضاف `AGENTS.md` تلقائيًا في الجذر.
