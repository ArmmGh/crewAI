...
description: تعمّق في تخصيص المطالبات على المستوى المنخفض في LocalAI، مما يتيح حالات استخدام مخصصة ومعقدة لنماذج ولغات مختلفة.
icon: message-pen
mode: "wide"
---
...
على الرغم من أن مطالبات LocalAI الافتراضية تعمل بشكل جيد في كثير من السيناريوهات، إلا أن التخصيص على المستوى المنخفض يفتح الباب أمام سلوك أكثر مرونة وقوة للـ Agent. إليك لماذا قد ترغب في الاستفادة من هذا التحكم العميق:
...
يستكشف هذا الدليل كيفية الوصول إلى مطالبات LocalAI على مستوى أعمق، مما يمنحك تحكمًا دقيقًا في كيفية تفكير الـ Agents وتفاعلها.

## فهم نظام المطالبات في LocalAI

تحت الغطاء، يستخدم LocalAI نظام مطالبات معياري يمكنك تخصيصه على نطاق واسع:
...
اطلع على [قوالب المطالبات الأصلية في مستودع LocalAI](https://github.com/localAIInc/localAI/blob/main/src/localagents/translations/en.json) لمعرفة كيفية تنظيم هذه العناصر. من هناك، يمكنك تجاوزها أو تكييفها حسب الحاجة لفتح سلوكيات متقدمة.

## فهم تعليمات النظام الافتراضية

<Warning>
**مشكلة شفافية الإنتاج**: يحقن LocalAI تلقائيًا تعليمات افتراضية في مطالباتك قد لا تكون على علم بها. يشرح هذا القسم ما يحدث تحت الغطاء وكيفية الحصول على تحكم كامل.
</Warning>

عندما تعرّف Agent بـ `role` و`goal` و`backstory`، يضيف LocalAI تلقائيًا تعليمات نظام إضافية تتحكم في التنسيق والسلوك. فهم هذه الحقن الافتراضية أمر بالغ الأهمية لأنظمة الإنتاج التي تحتاج شفافية كاملة في المطالبات.

### ما يحقنه LocalAI تلقائيًا

بناءً على تهيئة الـ Agent، يضيف LocalAI تعليمات افتراضية مختلفة:
...
يدمج LocalAI بعد ذلك تخصيصاتك مع الإعدادات الافتراضية، فلا تحتاج لإعادة تعريف كل مطالبة. إليك الطريقة:
...
يفتح تخصيص المطالبات على المستوى المنخفض في LocalAI الباب أمام حالات استخدام مخصصة ومعقدة للغاية. من خلال إنشاء ملفات مطالبات منظمة (أو قوالب مضمّنة مباشرة)، يمكنك استيعاب نماذج ولغات ومجالات متخصصة متنوعة. يضمن هذا المستوى من المرونة أنك تستطيع صياغة سلوك الذكاء الاصطناعي الذي تحتاجه بالضبط، مع العلم أن LocalAI لا يزال يوفر إعدادات افتراضية موثوقة عندما لا تتجاوزها.

<Check>
لديك الآن الأساس لتخصيصات المطالبات المتقدمة في LocalAI. سواء كنت تتكيف مع هياكل خاصة بالنموذج أو قيود خاصة بالمجال، يتيح لك هذا النهج المنخفض المستوى تشكيل تفاعلات الـ Agent بطرق متخصصة للغاية.
</Check>
