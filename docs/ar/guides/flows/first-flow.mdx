...
تمثل LocalAI Flows المستوى التالي في تنسيق AI - الجمع بين القوة التعاونية لفرق Agents AI مع دقة ومرونة البرمجة الإجرائية. بينما تتفوق Crews في تعاون الـ Agents، تمنحك Flows تحكمًا دقيقًا في كيفية ووقت تفاعل المكونات المختلفة لنظام AI.

في هذا الدليل، سنمشي عبر إنشاء LocalAI Flow قوي ينشئ دليلًا تعليميًا شاملاً حول أي موضوع.
...
## الخطوة 1: إنشاء مشروع LocalAI Flow جديد
...
<Frame caption="نظرة عامة على إطار عمل LocalAI">
  <img src="/images/flows.png" alt="نظرة عامة على إطار عمل LocalAI" />
</Frame>
...
يوضح Flow منشئ الدليل عدة ميزات قوية لـ LocalAI:
...
<Check>
تهانينا! لقد بنيت بنجاح أول LocalAI Flow يجمع بين الكود العادي واستدعاءات LLM المباشرة ومعالجة Crew لإنشاء دليل شامل. هذه المهارات الأساسية تمكّنك من إنشاء تطبيقات AI متطورة بشكل متزايد.
</Check>
