---
title: "سجل التغييرات"
description: "تحديثات المنتج والتحسينات وإصلاحات الأخطاء لـ LocalAI"
icon: "clock"
mode: "wide"
---
<Update label="27 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0rc1)
...
<Update label="27 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a2)
...
<Update label="27 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a1)
...
<Update label="25 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.2)
...
<Update label="25 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.1)
  ...
  - حل جميع أخطاء mypy الصارمة عبر حزمة localagents
  ...
  - إصلاح جميع أخطاء mypy في localagents-files وإضافة جميع الحزم إلى فحوصات النوع في CI
  - تثبيت الحد الأعلى لـ litellm على آخر إصدار تم اختباره (1.82.6)

  ### الوثائق
  - تحديث سجل التغييرات والإصدار لـ v1.12.0
  - إضافة CONTRIBUTING.md
  - إضافة دليل لاستخدام LocalAI بدون LiteLLM
...
<Update label="25 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0)
  ...
  - حل العديد من الأخطاء في نظام تدفق HITL
  - حل أخطاء mypy في localagents-files وإضافة جميع الحزم إلى فحوصات نوع CI
  - حل جميع أخطاء mypy الصارمة عبر حزمة localagents-tools
  - حل جميع أخطاء mypy عبر حزمة localagents
...
<Update label="26 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a3)
...
<Update label="25 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a2)
...
<Update label="25 مارس 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a1)
...
<Update label="Mar 23, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.1)
...
<Update label="Mar 18, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0)
...
<Update label="Mar 17, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc2)
...
<Update label="Mar 15, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc1)
...
<Update label="Mar 14, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc2)
...
<Update label="Mar 13, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc1)
...
<Update label="Mar 11, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2a1)
...
<Update label="Mar 04, 2026">
  ...
  [عرض الإصدار على GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.1)
