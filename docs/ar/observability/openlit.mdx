...
[OpenLIT](https://github.com/openlit/openlit?src=localagents-docs) هو أداة مفتوحة المصدر تجعل من السهل مراقبة أداء وكلاء الذكاء الاصطناعي ونماذج LLM وقواعد بيانات المتجهات ووحدات GPU بسطر **واحد** فقط من الكود.
...
- **ساحة تجربة النماذج**: اختبر وقارن نماذج مختلفة لوكلاء LocalAI قبل النشر.
    ...
    <Step title="تهيئة OpenLIT في تطبيقك">
      ...
      <Tabs>
        <Tab title="الإعداد باستخدام معاملات الدالة">
          ...
          مثال على الاستخدام لمراقبة وكيل LocalAI:
        ...
        <Tab title="الإعداد باستخدام متغيرات البيئة">
          ...
          مثال على الاستخدام لمراقبة وكيل LocalAI غير متزامن:
