---
title: تكامل LangDB
description: إدارة وتأمين وتحسين سير عمل LocalAI مع بوابة LangDB AI — الوصول إلى أكثر من 350 نموذجاً وتوجيه تلقائي وتحسين التكاليف ومراقبة كاملة.
icon: database
mode: "wide"
---
...
توفر [بوابة LangDB AI](https://langdb.ai) واجهات API متوافقة مع OpenAI للاتصال بنماذج لغة كبيرة متعددة وتعمل كمنصة مراقبة تجعل تتبع سير عمل LocalAI شاملاً وسهلاً مع توفير الوصول إلى أكثر من 350 نموذج لغة. مع استدعاء `init()` واحد، يتم التقاط جميع تفاعلات الوكلاء وتنفيذ المهام واستدعاءات LLM، مما يوفر مراقبة شاملة وبنية تحتية جاهزة للإنتاج لتطبيقاتك.

<Frame caption="مثال تتبع LangDB LocalAI">
  <img src="/images/langdb-1.png" alt="مثال تتبع LangDB LocalAI" />
</Frame>
...
### المراقبة والتتبع
- **تتبع تلقائي**: استدعاء `init()` واحد يلتقط جميع تفاعلات LocalAI
...
<Steps>
  <Step title="تثبيت LangDB">
    ثبّت عميل LangDB مع علامة ميزة LocalAI:
    ```bash
  ...
  <Step title="تهيئة التتبع">
    استورد وهيّئ LangDB قبل إعداد كود LocalAI:
    ```python
  ...
  <Step title="إعداد LocalAI مع LangDB">
...
بعد تشغيل تطبيق LocalAI، يمكنك عرض تتبعات مفصلة في لوحة معلومات LangDB:

<Frame caption="لوحة معلومات تتبع LangDB">
  <img src="/images/langdb-2.png" alt="لوحة معلومات تتبع LangDB تعرض سير عمل LocalAI" />
</Frame>
...
- **عدم ظهور تتبعات**: تأكد من استدعاء `init()` قبل أي استيرادات LocalAI
...
<CardGroup cols={3}>
  ...
  <Card title="أمثلة GitHub" icon="github" href="https://github.com/langdb/langdb-samples/tree/main/examples/localagents">
    أمثلة تكامل LocalAI الكاملة
  </Card>
...
غطى هذا الدليل أساسيات دمج بوابة LangDB AI مع LocalAI. لتعزيز سير عمل الذكاء الاصطناعي بشكل أكبر، استكشف:
