---
title: تكامل Datadog
description: تعلم كيفية دمج Datadog مع LocalAI لإرسال تتبعات مراقبة LLM إلى Datadog.
icon: dog
mode: "wide"
---

# دمج Datadog مع LocalAI

سيوضح هذا الدليل كيفية دمج **[Datadog LLM Observability](https://docs.datadoghq.com/llm_observability/)** مع **LocalAI** باستخدام [أداة Datadog للتجهيز التلقائي](https://docs.datadoghq.com/llm_observability/instrumentation/auto_instrumentation?tab=python). بنهاية هذا الدليل، ستتمكن من إرسال تتبعات مراقبة LLM إلى Datadog وعرض تشغيلات وكلاء LocalAI في [عرض التنفيذ الوكيلي](https://docs.datadoghq.com/llm_observability/monitoring/agent_monitoring) من Datadog LLM Observability.
...
- [التجهيز التلقائي لـ LocalAI من Datadog LLM Observability](https://docs.datadoghq.com/llm_observability/instrumentation/auto_instrumentation?tab=python#local-agents)
