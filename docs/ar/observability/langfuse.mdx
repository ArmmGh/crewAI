...
description: تعلم كيفية دمج Langfuse مع LocalAI عبر OpenTelemetry باستخدام OpenLit
icon: vials
mode: "wide"
---

# دمج Langfuse مع LocalAI

يوضح هذا الدفتر كيفية دمج **Langfuse** مع **LocalAI** باستخدام OpenTelemetry عبر حزمة **OpenLit** SDK. بنهاية هذا الدفتر، ستتمكن من تتبع تطبيقات LocalAI مع Langfuse لتحسين المراقبة والتصحيح.
...
سنمر عبر مثال بسيط لاستخدام LocalAI ودمجه مع Langfuse عبر OpenTelemetry باستخدام OpenLit.
...
### الخطوة 4: إنشاء تطبيق LocalAI بسيط

سننشئ تطبيق LocalAI بسيط حيث يتعاون عدة وكلاء للإجابة على سؤال المستخدم.
...
بعد تشغيل الوكيل، يمكنك عرض التتبعات المولدة من تطبيق LocalAI في [Langfuse](https://cloud.langfuse.com). سترى خطوات مفصلة لتفاعلات LLM، مما يساعدك في التصحيح والتحسين.

![مثال تتبع LocalAI في Langfuse](https://langfuse.com/images/cookbook/integration_localagents/localagents-example-trace.png)
