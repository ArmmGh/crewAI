---
title: Braintrust
description: تكامل Braintrust مع LocalAI باستخدام تتبع وتقييم OpenTelemetry
...
يوضح هذا الدليل كيفية دمج **Braintrust** مع **LocalAI** باستخدام OpenTelemetry للتتبع والتقييم الشامل. بنهاية هذا الدليل، ستتمكن من تتبع وكلاء LocalAI ومراقبة أدائهم وتقييم مخرجاتهم باستخدام منصة المراقبة القوية من Braintrust.
...
سنمر عبر مثال بسيط لاستخدام LocalAI ودمجه مع Braintrust عبر OpenTelemetry للمراقبة والتقييم الشامل.
...
سننشئ تطبيق LocalAI حيث يتعاون وكيلان للبحث وكتابة مقال مدونة حول تطورات الذكاء الاصطناعي، مع تفعيل التتبع الشامل.
...
- [تكامل Braintrust LocalAI](https://www.braintrust.dev/docs/integrations/local-agents) - دليل التكامل الرسمي مع LocalAI
