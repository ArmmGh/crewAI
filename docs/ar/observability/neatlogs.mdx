...
description: افهم وأصلح وشارك عمليات تشغيل وكلاء LocalAI الخاصة بك
...
يستخدم وكلاء LocalAI أدوات متعددة وخطوات تفكير. عندما يحدث خطأ ما، تحتاج إلى السياق - وليس فقط الأخطاء.
...
أفضل تجربة مستخدم لعرض تتبع LocalAI. انشر التعليقات أينما تريد. استخدم الذكاء الاصطناعي لتصحيح الأخطاء.
...
## إعداد سريع مع LocalAI

<Steps>
  <Step title="التسجيل والحصول على مفتاح API">
    قم بزيارة [neatlogs.com](https://neatlogs.com/?utm_source=localAI-docs)، وأنشئ مشروعاً، وانسخ مفتاح API.
  </Step>
