...
> **ما هو تتبع LocalAI؟** يوفر التتبع المدمج في LocalAI مراقبة شاملة لوكلاء الذكاء الاصطناعي، بما في ذلك قرارات الوكلاء وجداول تنفيذ المهام واستخدام الأدوات واستدعاءات LLM - كل ذلك متاح عبر [منصة LocalAI AMP](https://app.crewai.com).

![واجهة تتبع LocalAI](/images/crewai-tracing.png)

## المتطلبات الأساسية

قبل أن تتمكن من استخدام تتبع LocalAI، تحتاج إلى:

1. **حساب LocalAI AMP**: سجّل للحصول على حساب مجاني على [app.crewai.com](https://app.crewai.com)
...
قم بزيارة [app.crewai.com](https://app.crewai.com) وأنشئ حسابك المجاني. سيمنحك هذا الوصول إلى منصة LocalAI AMP حيث يمكنك عرض التتبعات والمقاييس وإدارة طواقمك.
