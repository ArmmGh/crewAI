---
title: تكامل Opik
description: تعرّف على كيفية استخدام Comet Opik لتصحيح الأخطاء وتقييم ومراقبة تطبيقات LocalAI الخاصة بك مع تتبع شامل وتقييمات آلية ولوحات معلومات جاهزة للإنتاج.
icon: meteor
mode: "wide"
---
...
يوفر Opik دعماً شاملاً لكل مرحلة من مراحل تطوير تطبيق LocalAI الخاص بك:
...
لاستخدام النسخة المستضافة، ما عليك سوى [إنشاء حساب Comet مجاني](https://www.comet.com/signup?utm_medium=github&utm_source=localagents_docs) والحصول على مفتاح API الخاص بك.

لتشغيل منصة Opik محلياً، راجع [دليل التثبيت](https://www.comet.com/docs/opik/self-host/overview/) لمزيد من المعلومات.

في هذا الدليل سنستخدم مثال البدء السريع الخاص بـ LocalAI.
...
<Steps>
    ...
    <Step title="استخدام LocalAI">
      الخطوة الأولى هي إنشاء مشروعنا. سنستخدم مثالاً من وثائق LocalAI:
      ...
      print(result)
      ```
      بعد تشغيل تطبيق LocalAI، قم بزيارة تطبيق Opik لعرض:
