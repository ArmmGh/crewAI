...
description: "تعلم كيفية تصدير ودمج مكونات React من LocalAI AMP في تطبيقاتك"
icon: "react"
mode: "wide"
---

يشرح هذا الدليل كيفية تصدير طواقم LocalAI AMP كمكونات React ودمجها في تطبيقاتك.
