---
title: "مشغل Zapier"
description: "تشغيل أطقم LocalAI من سير عمل Zapier لأتمتة سير العمل عبر التطبيقات"
icon: "bolt"
mode: "wide"
---

سيرشدك هذا الدليل خلال عملية إعداد مشغلات Zapier لـ LocalAI AMP، مما يتيح لك أتمتة سير العمل بين LocalAI AMP والتطبيقات الأخرى.
...
<Steps>
    ...
    <Step title="تكوين إجراء LocalAI AMP">
        - أضف خطوة إجراء جديدة إلى Zap الخاص بك.
        - اختر LocalAI+ كتطبيق الإجراء وKickoff كحدث الإجراء
    ...
    <Step title="ربط حساب LocalAI AMP">
        - اربط حساب LocalAI AMP الخاص بك.
    ...
    <Step title="تنسيق مخرجات LocalAI AMP">
        - أضف خطوة إجراء أخرى لتنسيق مخرجات النص من LocalAI AMP.
    ...
    <Step title="إرسال المخرجات عبر البريد الإلكتروني">
        ...
        - أدرج مخرجات LocalAI AMP المنسقة في نص البريد الإلكتروني.
...
- تأكد من أن مدخلات LocalAI AMP مربوطة بشكل صحيح من رسالة Slack.
...
باتباع هذه الخطوات، ستكون قد أعددت بنجاح مشغلات Zapier لـ LocalAI AMP، مما يتيح سير عمل آلي يتم تشغيله بواسطة رسائل Slack وينتج عنه إشعارات بالبريد الإلكتروني مع مخرجات LocalAI AMP.
