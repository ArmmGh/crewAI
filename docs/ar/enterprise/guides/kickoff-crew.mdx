---
title: "تشغيل الطاقم"
description: "تشغيل طاقم على LocalAI AMP"
icon: "flag-checkered"
mode: "wide"
---
...
بمجرد نشر طاقمك على منصة LocalAI AMP، يمكنك بدء عمليات التنفيذ عبر واجهة الويب أو API. يغطي هذا الدليل كلا النهجين.
...
يمكنك أيضاً تشغيل الطواقم برمجياً باستخدام REST API لـ LocalAI AMP.
