...
- حساب [LocalAI AMP](https://app.crewai.com)
...
بعد تثبيت أداة من مستودع أدوات LocalAI AMP، تحتاج لاستخدام أمر `crewai uv` لإضافة حزم أخرى لمشروعك.
...
1. انتقل إلى [LocalAI AMP](https://app.crewai.com)
2. انتقل إلى **Tools**
3. اختر الأداة
4. انقر على **Delete**
