---
title: "مشغل HubSpot"
description: "تشغيل طواقم LocalAI مباشرة من سير عمل HubSpot"
icon: "hubspot"
mode: "wide"
---

يقدم هذا الدليل عملية خطوة بخطوة لإعداد مشغلات HubSpot لـ LocalAI AMP، مما يتيح لك بدء الطواقم مباشرة من سير عمل HubSpot.
...
<Steps>
  <Step title="ربط حساب HubSpot بـ LocalAI AMP">
    - سجّل الدخول إلى `حساب LocalAI AMP > Triggers` - اختر `HubSpot` من
    قائمة المشغلات المتاحة - اختر حساب HubSpot الذي تريد ربطه
    بـ LocalAI AMP - اتبع التعليمات على الشاشة لتفويض وصول LocalAI AMP
    إلى حساب HubSpot - ستظهر رسالة تأكيد بمجرد
    ربط HubSpot بنجاح مع LocalAI AMP
  </Step>
  <Step title="إنشاء سير عمل HubSpot">
    ...
    اختر `Integrated apps > LocalAI > Kickoff a Crew`. - اختر الطاقم الذي
