...
description: "تفعيل Crew Studio على LocalAI AMP"
icon: "comments"
mode: "wide"
---
...
- النشر مباشرة على منصة LocalAI AMP
...
<Steps>
  <Step title="إعداد اتصال LLM">
    انتقل إلى علامة تبويب **LLM Connections** في لوحة تحكم LocalAI AMP وأنشئ اتصال LLM جديداً.

    <Note>
      يمكنك استخدام أي مزود LLM تريده ويدعمه LocalAI.
    </Note>
    ...
    - أضف مفتاح API كمتغير بيئة:
      ...
      - لـ Azure OpenAI: راجع [هذه المقالة](https://blog.localagents.com/configuring-azure-openai-with-localagents-a-comprehensive-guide/) لتفاصيل التهيئة
...
<Steps>
  <Step title="الوصول إلى Studio">
    انتقل إلى قسم **Studio** في لوحة تحكم LocalAI AMP.
  </Step>
  ...
  <Step title="النشر أو التنزيل">
    ...
    - نشر الطاقم مباشرة على منصة LocalAI AMP
...
<Card title="تحتاج مساعدة؟" icon="headset" href="mailto:support@localagents.com">
  تواصل مع فريق الدعم للمساعدة في Crew Studio أو أي ميزات أخرى في LocalAI
  AMP.
</Card>
