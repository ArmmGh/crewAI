---
title: "مشغل Slack"
description: "تشغيل طواقم LocalAI مباشرة من Slack باستخدام أوامر الشرطة المائلة"
icon: "slack"
mode: "wide"
---

يشرح هذا الدليل كيفية بدء طاقم مباشرة من Slack باستخدام مشغلات LocalAI.

## المتطلبات المسبقة

- مشغل LocalAI لـ Slack مُثبّت ومتصل بمساحة عمل Slack
- طاقم واحد على الأقل مُهيأ في LocalAI

## خطوات الإعداد

<Steps>
    <Step title="التأكد من إعداد مشغل LocalAI لـ Slack">
        في لوحة تحكم LocalAI، انتقل إلى قسم **Triggers**.

        <Frame>
            <img src="/images/enterprise/slack-integration.png" alt="تكامل LocalAI مع Slack" />
        </Frame>
...
- إذا لم تر الطاقم المطلوب في القائمة المنسدلة، تأكد من أنه مُهيأ بشكل صحيح ومتصل في LocalAI.
