...
توفر منصة LocalAI AMP (منصة إدارة الوكلاء) بيئة لنشر ومراقبة وتوسيع أطقمك ووكلائك في بيئة إنتاجية.

<Frame>
  <img
    src="/images/enterprise/localagents-enterprise-dashboard.png"
    alt="لوحة تحكم LocalAI AMP"
  />
</Frame>

تعمل منصة LocalAI AMP على توسيع قوة إطار العمل مفتوح المصدر بميزات مصممة لعمليات النشر الإنتاجية والتعاون وقابلية التوسع. انشر أطقمك على بنية تحتية مُدارة وراقب تنفيذها في الوقت الفعلي.
...
<CardGroup cols={3}>
  ...
  <Card title="النشر عبر CLI" icon="terminal">
    استخدم واجهة سطر أوامر LocalAI لسير عمل نشر أكثر تقدمًا
  </Card>
</CardGroup>
...
<Steps>
  <Step title="إنشاء حساب">
    أنشئ حسابك على [app.localagents.com](https://app.localagents.com)
    <Card title="التسجيل" icon="user" href="https://app.localagents.com/signup">
      التسجيل
    </Card>
  </Step>
