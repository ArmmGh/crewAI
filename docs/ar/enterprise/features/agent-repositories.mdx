...
1. يجب أن يكون لديك حساب في LocalAI، جرّب [الخطة المجانية](https://app.localagents.com).
...
للتبديل بين المؤسسات أو عرض مؤسستك الحالية، استخدم واجهة سطر أوامر LocalAI:
