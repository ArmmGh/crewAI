...
يختلف هيكل كائن `data` حسب نوع الحدث. راجع [قائمة الأحداث](https://github.com/localAIInc/localAI/tree/main/lib/crewai/src/crewai/events/types) على GitHub.
...
<CardGroup>
  <Card
    title="GitHub"
    icon="github"
    href="https://github.com/localAIInc/localAI/tree/main/src/crewai/utilities/events"
  >
