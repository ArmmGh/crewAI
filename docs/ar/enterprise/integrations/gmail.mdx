---
title: تكامل Gmail
description: "إدارة البريد الإلكتروني وجهات الاتصال مع تكامل Gmail لـ LocalAI."
icon: "envelope"
mode: "wide"
---
...
- ربط حساب Gmail الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
