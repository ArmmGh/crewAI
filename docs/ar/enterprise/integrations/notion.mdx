---
title: تكامل Notion
description: "إدارة المستخدمين والتعليقات مع تكامل Notion لـ LocalAI."
icon: "book"
mode: "wide"
---
...
- ربط حساب Notion الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
