---
title: تكامل Linear
description: "إدارة المشاريع البرمجية وتتبع الأخطاء مع تكامل Linear لـ LocalAI."
icon: "list-check"
mode: "wide"
---
...
- ربط حساب Linear الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
