---
title: تكامل Zendesk
description: "دعم العملاء وإدارة مكتب المساعدة مع تكامل Zendesk لـ LocalAI."
icon: "headset"
mode: "wide"
---
...
- ربط حساب Zendesk الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/integrations)
