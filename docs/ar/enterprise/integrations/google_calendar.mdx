...
description: "إدارة الأحداث والجداول الزمنية مع تكامل Google Calendar لـ LocalAI."
icon: "calendar"
mode: "wide"
---
...
- ربط حساب Google الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
