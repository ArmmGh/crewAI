---
title: تكامل HubSpot
description: "إدارة الشركات وجهات الاتصال في HubSpot مع LocalAI."
icon: "briefcase"
mode: "wide"
---
...
- ربط حساب HubSpot الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors).
