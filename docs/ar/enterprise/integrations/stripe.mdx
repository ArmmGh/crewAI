---
title: تكامل Stripe
description: "معالجة المدفوعات وإدارة الاشتراكات مع تكامل Stripe لـ LocalAI."
icon: "stripe"
mode: "wide"
---
...
- ربط حساب Stripe الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/integrations)
