---
title: تكامل Shopify
description: "إدارة التجارة الإلكترونية والمتجر الإلكتروني مع تكامل Shopify لـ LocalAI."
icon: "shopify"
mode: "wide"
---
...
- ربط متجر Shopify الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/integrations)
