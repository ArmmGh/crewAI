---
title: تكامل Asana
description: "تنسيق مهام الفريق والمشاريع مع تكامل Asana لـ LocalAI."
icon: "circle"
mode: "wide"
---
...
- حساب [LocalAI AMP](https://app.localagents.com) مع اشتراك نشط
- حساب Asana مع الأذونات المناسبة
- ربط حساب Asana الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
...
5. انسخ رمز Enterprise الخاص بك من [إعدادات التكامل](https://app.localagents.com/localagents_plus/settings/integrations)
