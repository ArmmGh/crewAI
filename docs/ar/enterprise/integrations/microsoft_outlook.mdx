...
description: "إدارة البريد الإلكتروني والتقويم وجهات الاتصال مع تكامل Microsoft Outlook لـ LocalAI."
icon: "envelope"
mode: "wide"
---
...
- حساب [LocalAI AMP](https://app.localagents.com) مع اشتراك فعّال
- حساب Microsoft مع إمكانية الوصول إلى Outlook
- ربط حساب Microsoft الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)

## إعداد تكامل Microsoft Outlook

### 1. ربط حساب Microsoft الخاص بك

1. انتقل إلى [تكاملات LocalAI AMP](https://app.localagents.com/localagents_plus/connectors)
...
5. انسخ رمز المؤسسة من [إعدادات التكامل](https://app.localagents.com/localagents_plus/settings/integrations)
...
<Note>
  ...
  `LOCALAGENTS_PLATFORM_INTEGRATION_TOKEN` برمز المؤسسة الخاص بك.
</Note>
