---
title: تكامل Box
description: "تخزين الملفات وإدارة المستندات مع تكامل Box لـ LocalAI."
icon: "box"
mode: "wide"
---
...
- ربط حساب Box الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
