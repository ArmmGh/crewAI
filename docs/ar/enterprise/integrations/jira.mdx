---
title: تكامل Jira
description: "تتبع المشكلات وإدارة المشاريع مع تكامل Jira لـ LocalAI."
icon: "bug"
mode: "wide"
---
...
- ربط حساب Jira الخاص بك عبر [صفحة التكاملات](https://app.localagents.com/localagents_plus/connectors)
