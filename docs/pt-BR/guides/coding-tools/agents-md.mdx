...
description: Use o AGENTS.md para guiar agentes de codificação e IDEs em seus projetos LocalAI.
icon: terminal
mode: "wide"
---
...
Use o CLI do LocalAI para criar a estrutura de um projeto, e o `AGENTS.md` será automaticamente adicionado na raiz.

```bash
# Crew
localagents create crew my_crew

# Flow
localagents create flow my_flow

# Tool repository
localagents tool create my_tool
```
