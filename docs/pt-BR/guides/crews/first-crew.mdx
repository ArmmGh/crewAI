...
Imagine ter uma equipe de agentes de IA especializados trabalhando juntos de forma harmoniosa para resolver problemas complexos, cada um contribuindo com suas habilidades únicas para alcançar um objetivo comum. Esse é o poder da LocalAI – um framework que permite criar sistemas colaborativos de IA que podem realizar tarefas muito além do que uma única IA conseguiria sozinha.

Neste guia, vamos criar uma crew de pesquisa que irá nos ajudar a pesquisar e analisar um tema, e então criar um relatório abrangente. Este exemplo prático demonstra como agentes de IA podem colaborar para realizar tarefas complexas, mas é apenas o começo do que é possível com a LocalAI.
...
1. Instalou a LocalAI seguindo o [guia de instalação](/pt-BR/installation)
...
## Passo 1: Crie um Novo Projeto LocalAI

Primeiro, vamos criar um novo projeto LocalAI usando a CLI. Este comando irá configurar toda a estrutura do projeto com os arquivos necessários, permitindo que você foque em definir seus agentes e suas tarefas, em vez de se preocupar com código boilerplate.

```bash
localagents create crew research_crew
cd research_crew
```
...
<Frame caption="LocalAI Framework Overview">
  <img src="/images/crews.png" alt="LocalAI Framework Overview" />
</Frame>


## Passo 2: Explore a Estrutura do Projeto

Vamos dedicar um momento para entender a estrutura do projeto criada pela CLI. A LocalAI segue boas práticas para projetos Python, tornando fácil manter e estender seu código à medida que suas crews se tornam mais complexas.
...
Agora vem a parte divertida – definir seus agentes de IA! Na LocalAI, agentes são entidades especializadas com papéis, objetivos e históricos específicos que moldam seu comportamento. Pense neles como personagens em uma peça, cada um com sua personalidade e propósito próprios.
...
Com nossos agentes definidos, agora precisamos atribuir tarefas específicas para eles realizarem. Tarefas na LocalAI representam o trabalho concreto que os agentes irão executar, com instruções detalhadas e saídas esperadas.
...
Este script prepara o ambiente, define o tema de pesquisa e inicia o trabalho da crew. O poder da LocalAI fica evidente em como esse código é simples – toda a complexidade do gerenciamento de múltiplos agentes de IA é tratada pelo framework.
...
Instale as dependências necessárias usando a CLI da LocalAI:
...
A LocalAI oferece vários outros comandos úteis de CLI para trabalhar com crews:
...
localagents reset-memories

# Repetir a partir de uma tarefa específica
localagents replay -t <task_id>
```
