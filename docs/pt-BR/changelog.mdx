...
description: "Atualizações de produto, melhorias e correções do LocalAI"
icon: "clock"
mode: "wide"
---
<Update label="27 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0rc1)
...
<Update label="27 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a2)
...
<Update label="27 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.13.0a1)
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.2)
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.1)
  ...
  - Resolver todos os erros estritos do mypy no pacote localagents
  ...
  - Corrigir todos os erros do mypy em localagents-files e adicionar todos os pacotes às verificações de tipo do CI
  - Fixar limite superior do litellm na última versão testada (1.82.6)

  ### Documentação
  - Atualizar changelog e versão para v1.12.0
  - Adicionar CONTRIBUTING.md
  - Adicionar guia para usar LocalAI sem LiteLLM
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0)
  ...
  - Resolver múltiplos bugs no sistema de fluxo HITL
  - Resolver erros do mypy em localagents-files e adicionar todos os pacotes às verificações de tipo do CI
  - Resolver todos os erros estritos do mypy no pacote localagents-tools
  - Resolver todos os erros do mypy no pacote localagents
...
<Update label="26 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a3)
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a2)
...
<Update label="25 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.12.0a1)
  ...
  - Adicionar suporte ao idioma árabe para changelog e ferramentas de lançamento
  - Adicionar tradução em árabe padrão moderno de toda a documentação
  - Adicionar provedores compatíveis com OpenAI nativos (OpenRouter, DeepSeek, Ollama, vLLM, Cerebras, Dashscope)
  - Adicionar habilidades de agente
  - Adicionar comando de logout na CLI
  - Implementar root_scope automático para isolamento de memória hierárquico

  ### Correções de Bugs
  - Corrigir a economia de memória do agente
  - Resolver erros do mypy em localagents-files e adicionar todos os pacotes às verificações de tipo do CI
  - Resolver todos os erros estritos do mypy no pacote localagents-tools
  - Resolver todos os erros do mypy no pacote localagents
  - Corrigir o uso de __router_paths__ para métodos listener+router em FlowMeta
  - Fixar o limite superior do litellm na última versão testada (1.82.6)
  - Levantar erro de valor quando não houver suporte a arquivos
  - Corrigir a redação da quarentena do litellm na documentação

  ### Documentação
  - Adicionar CONTRIBUTING.md
  - Adicionar guia para usar o LocalAI sem o LiteLLM
  - Atualizar changelog e versão para v1.11.1

  ### Refatoração
  - Refatorar para deduplicar a execução de tarefas síncronas/assíncronas e o início no agente
  - Desacoplar a estrutura interna do litellm (contagem de tokens, callbacks, detecção de recursos, erros)
...
<Update label="23 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.1)
...
<Update label="18 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0)
...
<Update label="17 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc2)
...
<Update label="15 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.11.0rc1)
...
<Update label="14 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc2)
...
<Update label="13 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2rc1)
...
<Update label="11 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.2a1)
...
<Update label="04 mar 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.1)
...
<Update label="27 fev 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.1a1)
...
<Update label="26 fev 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.10.0)
...
<Update label="26 jan 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.9.0)
...
<Update label="15 jan 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.8.1)
...
<Update label="08 jan 2026">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.8.0)
...
<Update label="19 dez 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.2)
...
<Update label="16 dez 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.1)
...
<Update label="09 dez 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.7.0)
...
<Update label="29 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.6.1)
  ...
  - Apagar configuração 'oauth2_extra' no comando 'localagents config reset'
...
<Update label="25 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.6.0)
...
<Update label="22 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.203.2)
...
<Update label="16 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.5.0)
...
<Update label="07 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.4.1)
...
<Update label="07 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.4.0)
...
<Update label="01 nov 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.3.0)
...
<Update label="27 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.2.1)
...
<Update label="24 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.2.0)
...
<Update label="21 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.1.0)
...
<Update label="20 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0)
  ...
  - Injetar credenciais do repositório de ferramentas no comando localagents run
  ...
  - Adicionar guia para capturar logs de telemetria no LocalAI AMP
...
<Update label="18 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b3)
...
<Update label="16 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b2)
  ...
  ### Documentação
  - Garantir que LOCALAGENTS_PLATFORM_INTEGRATION_TOKEN seja mencionado na documentação
...
<Update label="14 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0b1)
...
<Update label="13 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.203.1)

  ## O que Mudou

  ### Melhorias e Correções do Núcleo
  - Corrigida injeção de credenciais do repositório de ferramentas no comando `localagents run`
...
<Update label="09 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a4)
...
<Update label="07 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a3)
...
<Update label="03 out 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a2)
...
<Update label="30 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/1.0.0a1)
  ...
  - Repositório `localagents-tools` incorporado ao workspace principal (monorepo)
...
<Update label="26 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.201.1)
  ...
  - Versão do LocalAI atualizada para 0.201.1 com dependências internas revisadas
...
<Update label="24 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.201.0)
  ...
  - Adicionado comando `localagents uv` para executar `uv` diretamente via CLI
...
<Update label="20 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.2)
...
<Update label="20 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.1)
...
<Update label="19 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.193.0)
  ...
  - Atualizadas referências do `RagTool` para refletir a implementação nativa de RAG do LocalAI
...
<Update label="11 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.186.1)

  ## O que Mudou

  - Corrigida falha silenciosa de reversão quando a versão não era encontrada
  - Versão do LocalAI atualizada para 0.186.1 e dependências do CLI atualizadas
...
<Update label="10 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.186.0)
...
<Update label="04 set 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.177.0)
  ...
  - Centralizada a lógica de eventos movendo o módulo `events` para `localagents.events`
...
<Update label="28 ago 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.175.0)

  ## Melhorias e Correções Principais

  - Corrigida a migração da seção `tool` durante `localagents update`
  ...
  - Adicionado suporte para `localagents config reset` para limpar tokens
  - Habilitada a auto-injeção de `localagents_trigger_payload`
  ...
  - Adicionado suporte para remover Auth0 e entrada de e-mail em `localagents login`
...
<Update label="19 ago 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.165.1)
  ...
  - `localagents_trigger_payload` injetado automaticamente
  - Renomeada a flag interna `inject_trigger_input` para `allow_localagents_trigger_context`
...
<Update label="19 ago 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.165.0)
...
<Update label="13 ago 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.159.0)
...
<Update label="06 ago 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.157.0)
  ...
  - Adicionado grupo de comandos CLI `localagents config` com testes
...
<Update label="30 jul 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.152.0)

  ## Melhorias e Correções Principais

  - Removidas referências a `localagents signup` e substituídas por `localagents login`
...
<Update label="23 jul 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.150.0)
...
<Update label="16 jul 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.148.0)
...
<Update label="09 jul 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.141.0)
...
<Update label="02 jul 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.140.0)
...
<Update label="25 jun 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.134.0)
...
<Update label="12 jun 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.130.0)
...
<Update label="05 jun 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.126.0)
...
<Update label="27 mai 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.121.1)
...
<Update label="22 mai 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.121.0)
...
<Update label="15 mai 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.120.1)
...
<Update label="14 mai 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.120.0)
...
<Update label="08 mai 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.119.0)
...
<Update label="30 abr 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.118.0)
...
<Update label="28 abr 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.117.1)

  * build: atualizar localagents-tools
...
<Update label="28 abr 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.117.0)
...
<Update label="10 abr 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.114.0)
...
<Update label="17 mar 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.108.0)
  ...
  - Adicionadas instruções para atualizar o localAI com a ferramenta uv no PR #2363
...
<Update label="09 mar 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.105.0)
...
<Update label="13 fev 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.102.0)
...
<Update label="28 jan 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.100.0)
  ...
  * Docs: Novas documentações para o localagents chat
...
<Update label="20 jan 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.98.0)
...
<Update label="04 jan 2025">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.95.0)
...
<Update label="05 dez 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.86.0)
...
<Update label="04 dez 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.85.0)

  * Adicionado conhecimento ao nível do agente
  * Feat/remover langchain
  * Melhorar saídas de tarefas tipadas
  * Fazer login no Repositório de Ferramentas com `localagents login`
...
<Update label="25 nov 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.83.0)
...
<Update label="14 nov 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.80.0)
...
<Update label="11 nov 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.79.4)
...
<Update label="10 nov 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.79.0)
...
<Update label="30 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.9)

  * Atualizar comando de plotagem para localagents flow plot
  ...
  * Atualizar cli de fluxos para permitir que você adicione facilmente equipes adicionais a um fluxo com localagents flow add-crew
...
<Update label="23 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.2)

  # Atualizando o comando create do localagents

  ## Introdução

  O comando `create` do localagents permite que você crie novos projetos de forma rápida e fácil. Esta documentação fornece informações sobre como atualizar o comando para garantir que você esteja utilizando as funcionalidades mais recentes.

  ## Requisitos

  Antes de atualizar o comando, verifique se você possui:

  - A versão mais recente do localagents instalada.
  - Acesso à internet para baixar as atualizações.

  ## Passos para Atualização

  1. **Verifique a versão atual do localagents:**
  ...
  2. **Atualize o localagents:**

     Para atualizar o localagents, use o seguinte comando:

     ```bash
     npm install -g localagents
     ```
  ...
  ```bash
  localagents create <nome-do-projeto>
  ```

  ## Conclusão

  Manter o localagents atualizado é essencial para aproveitar ao máximo suas funcionalidades. Siga os passos acima para garantir que você esteja sempre utilizando a versão mais recente do comando `create`. Para mais informações, consulte a [documentação oficial do localagents](https://localagents.com/docs).
</Update>

<Update label="23 out 2024">
  ## v0.76.0

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.76.0)
...
<Update label="23 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.75.1)

  # nova opção `--provider` no localagents crewat

  A nova opção `--provider` foi adicionada ao comando `crewat` do LocalAI. Esta opção permite que os usuários especifiquem o provedor de serviços que desejam utilizar ao executar o comando.
  ...
  A adição da opção `--provider` no comando `crewat` do LocalAI oferece mais flexibilidade e controle sobre a escolha do provedor de serviços. Certifique-se de experimentar essa nova funcionalidade em seus projetos!
</Update>

<Update label="23 out 2024">
  ## v0.75.0

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.75.0)

  * Corrigindo o treinamento de post de teste
  * Simplificar fluxos
  * Adaptar `localagents tool install <tool>`
...
<Update label="18 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.74.2)
...
<Update label="18 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.74.0)
...
<Update label="11 out 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.70.1)

  * Novo recurso Flow
  * Visualizador de Flow
  * Criar comando `localagents create flow`
  * Criar comando `localagents tool create <tool>`
...
<Update label="27 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.65.2)
...
<Update label="27 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.64.0)
...
<Update label="25 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.6)
...
<Update label="25 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.5)
...
<Update label="24 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.2)
...
<Update label="24 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.1)

  - Pequena correção de bug para suportar futuras implantações do LocalAI
</Update>

<Update label="24 set 2024">
  ## v0.63.0

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.63.0)
...
<Update label="18 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.61.0)
...
<Update label="16 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.60.0)
...
<Update label="13 set 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.55.2)

  * Adicionando a capacidade de autocompletar
  * Adicionar nome e expected_output ao TaskOutput
  * Novo CLI `localagents install`
  * Novo CLI `localagents deploy`
...
<Update label="11 ago 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.51.0)

  - localAI Testes / Avaliação - https://docs.localagents.com/core-concepts/Testing/
  - Adicionando nova janela de contexto deslizante
  - Permitindo todos os atributos no YAML - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#customizing-your-project
  - Adicionando Estrutura Inicial do Pipeline - https://docs.localagents.com/core-concepts/Pipeline/
  - Capacidade de definir LLM para a etapa de planejamento - https://docs.localagents.com/core-concepts/Planning/
  - Novo comando crew run - https://docs.localagents.com/getting-started/Start-a-New-LocalAI-Project-Template-Method/#running-your-project
  - Salvando arquivo agora despeja dicionário em JSON - https://docs.localagents.com/core-concepts/Tasks/#creating-directories-when-saving-files
  - Usando configurações verbosas para saídas de ferramentas
  - Adicionados novos Modelos do Github
  - Nova ferramenta Vision - https://docs.localagents.com/tools/VisionTool/
  - Nova ferramenta DALL-E - https://docs.localagents.com/tools/DALL-ETool/
  - Nova ferramenta MySQL - https://docs.localagents.com/tools/MySQLTool/
  - Nova ferramenta NL2SQL - https://docs.localagents.com/tools/NL2SQLTool.md
  - Correções de Bugs:
...
<Update label="20 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.41.1)
...
<Update label="19 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.41.0)
  ...
  - **[Ferramentas]** Atualizada a dependência localAI-tools para a versão
...
<Update label="06 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.36.0)
...
<Update label="04 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.8)
...
<Update label="02 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.7)
...
<Update label="01 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.5)
...
<Update label="01 jul 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.4)

  - Atualizando o localagents create CLI para usar a nova versão
</Update>

<Update label="01 jul 2024">
  ## v0.35.3

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.3)

  - Correção de bug na execução de código
  - Atualização da documentação geral
  - Atualização da versão do localagents-tools
...
<Update label="29 jun 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.35.0)
  ...
  - Treine sua equipe antes de executá-la e obtenha resultados consistentes! Novo CLI `localagents train -n X`
...
<Update label="22 jun 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.32.2)

  - Atualizando `localagents create` CLI para usar a nova versão
...
<Update label="21 jun 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.32.0)
...
<Update label="23 mai 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.30.11)
...
<Update label="14 mai 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.8)

  - Atualizando dependências
  - Pequenas correções de bugs na estrutura do projeto localAI
...
<Update label="14 mai 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.5)
...
<Update label="13 mai 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.30.4)
...
<Update label="11 abr 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.28.8)

  - atualizando a versão utilizada no localagents CLI
</Update>

<Update label="11 abr 2024">
  ## v0.28.7

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/0.28.7)

  - Correções de bugs
  - Atualizando a versão da ferramenta localAI com correções de bugs
</Update>

<Update label="08 abr 2024">
  ## v0.28.5

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.5)
...
<Update label="07 abr 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.2)
...
<Update label="06 abr 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.1)

  - Atualizando localagents-tools para 0.1.15
</Update>

<Update label="05 abr 2024">
  ## v0.28.0

  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.28.0)
...
<Update label="04 abr 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.27.0)
  ...
  - 🤚🏼 **Suporte Nativo a Entrada Humana:** [docs](https://docs.localagents.com/how-to/Human-Input-on-Execution/)
  - 🌐 **Suporte Universal a Ferramentas RAG:** Quaisquer modelos, além de apenas OpenAI. [Exemplo](https://docs.localagents.com/tools/DirectorySearchTool/#custom-model-and-embeddings)
  - 🔍 **Controle de Cache Aprimorado:** Conheça o engenhoso atributo cache_function: [docs](https://docs.localagents.com/core-concepts/Tools/#custom-caching-mechanism)
  - 🔁 **Dependência localagents-tools Atualizada:** Sempre em sincronia com o mais recente e melhor.
...
<Update label="12 mar 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.5)
...
<Update label="12 mar 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.4)
  ...
  - [Documentação do LocalAI](https://localagents.com/docs)
...
<Update label="11 mar 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.2)
...
<Update label="11 mar 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.22.0)

  - Adicionando o comando inicial da CLI `localagents create`
...
<Update label="04 mar 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.19.0)
...
<Update label="28 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.16.3)
...
<Update label="28 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.16.0)

  - Removendo a dependência `localagents_tools` remanescente
...
<Update label="26 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.4)

  - Atualizando timeouts
  - Atualizando documentos
  - Removendo localagents_tools como obrigatório
...
<Update label="24 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.3)
...
<Update label="22 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.0)
...
<Update label="20 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.14.0rc0)

  - Adicionando suporte ao localagents-tools
...
<Update label="16 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.2)
...
<Update label="16 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.1)
...
<Update label="13 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.11.0)
...
<Update label="10 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.10.0)
  ...
  - Opção para compartilhar dados completos relacionados à equipe com a equipe do localAI
...
<Update label="08 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.5)
...
<Update label="07 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.3)
...
<Update label="06 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.2)
...
<Update label="04 fev 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.5.0)
...
<Update label="14 jan 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.32)
...
<Update label="07 jan 2024">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.23)
...
<Update label="30 dez 2023">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.14)
...
<Update label="24 nov 2023">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.2)
...
<Update label="19 nov 2023">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.1)

  # LocalAI v0.1.1 Notas de Lançamento
...
<Update label="14 nov 2023">
  ...
  [Ver release no GitHub](https://github.com/localAIInc/localAI/releases/tag/v0.1.0)

  # LocalAI v0.1.0 Notas de Lançamento

  Estamos empolgados em anunciar o lançamento inicial do LocalAI, versão 0.1.0! O LocalAI é uma estrutura projetada para facilitar a orquestração de agentes de IA autônomos capazes de interpretar papéis e colaborar para realizar tarefas complexas de forma mais eficiente.

  ## O que há de Novo

  - **Lançamento Inicial**: O LocalAI agora está oficialmente disponível! Este lançamento fundamental estabelece as bases para que os agentes de IA trabalhem em conjunto, cada um com seu próprio papel e objetivos especializados.
  ...
  - **Documentação**: Comece a explorar o LocalAI com nossa documentação inicial que o orienta através da configuração e uso da estrutura.

  ## Melhorias

  - Documentação detalhada da API para as classes `Agent`, `Task`, `Crew` e `Process`.
  - Exemplos e tutoriais para ajudá-lo a construir sua primeira aplicação LocalAI.
