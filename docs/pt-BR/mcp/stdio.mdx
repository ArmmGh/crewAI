...
description: Aprenda como conectar o LocalAI a servidores MCP locais usando o mecanismo de transporte Stdio (Entrada/Saída Padrão).
icon: server
mode: "wide"
---
...
with MCPServerAdapter(server_params) as tools:
    ...
    # Exemplo: Usando as ferramentas do servidor MCP Stdio em um Agente LocalAI
