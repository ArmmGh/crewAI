...
description: "Aprenda como integrar servidores MCP como ferramentas nos seus agentes LocalAI usando a biblioteca `crewai-tools`."
icon: plug
mode: "wide"
---
...
A classe `MCPServerAdapter` da `crewai-tools` é a principal forma de conectar-se a um servidor MCP e disponibilizar suas ferramentas aos seus agentes LocalAI. Ela suporta diferentes mecanismos de transporte e simplifica o gerenciamento de conexões.
