...
>
  <img src="/images/crew_only_logo.png" alt="LocalAI" width="250" height="100" />
...
<CardGroup cols={3}>
  <Card title="Introdução" href="/pt-BR/introduction" icon="sparkles">
    Visão geral dos conceitos da LocalAI, arquitetura e casos de uso para agentes, crews e flows.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Ferramentas de integração" href="/pt-BR/tools/integration/overview" icon="plug">
    Chame automations LocalAI existentes ou agentes do Amazon Bedrock diretamente das suas crews.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Star no GitHub" href="https://github.com/localAIInc/localAI" icon="star">
    Se a LocalAI acelera seu trabalho, deixe uma estrela e compartilhe seus projetos com a comunidade.
  </Card>
  <Card title="Participe da comunidade" href="https://community.localagents.com" icon="comments">
