---
title: FAQs
description: "Perguntas frequentes sobre LocalAI AMP"
...
<AccordionGroup>
    ...
    <Accordion title="Onde posso encontrar a documentação mais recente da LocalAI?">
        A documentação mais atualizada da LocalAI está disponível em nosso site oficial de documentação: https://docs.localagents.com/
        <Card href="https://docs.localagents.com/" icon="books">LocalAI Docs</Card>
    </Accordion>

    <Accordion title="Quais as principais diferenças entre os Processos Hierárquico e Sequencial na LocalAI?">
    ...
    <Accordion title="Quais são os benefícios do uso de memória no framework LocalAI?">
    ...
    <Accordion title="Qual o papel da entrada humana na execução de tarefas dentro de uma crew da LocalAI?">
    ...
    <Accordion title="Quais opções avançadas de customização estão disponíveis para aprimorar e personalizar o comportamento e as capacidades dos agentes na LocalAI?">
        A LocalAI oferece diversas opções avançadas de customização:
    ...
    <Accordion title="Quais são os diferentes tipos de memória disponíveis na localAI?">
        Os diferentes tipos de memória disponíveis na LocalAI são:
        ...
        <Card href="https://docs.localagents.com/concepts/memory" icon="brain">LocalAI Memory</Card>
    </Accordion>
    ...
    <Accordion title="Como faço para usar Output Pydantic em uma Tarefa?">
        ...
        <Steps>
            ...
            <Step title="Crie uma tarefa com Output Pydantic">
                ```python
                from localagents import Task, Crew, Agent
    ...
    <Accordion title="Como posso criar ferramentas personalizadas para meus agentes LocalAI?">
        Você pode criar ferramentas personalizadas herdando da classe `BaseTool` fornecida pela LocalAI ou usando o decorador de ferramenta. Herdar envolve definir uma nova classe que herda de `BaseTool`, especificando o nome, a descrição e o método `_run` para a lógica operacional. O decorador de ferramenta permite criar um objeto `Tool` diretamente com os atributos necessários e uma lógica funcional.

        <Card href="/pt-BR/learn/create-custom-tools" icon="code">LocalAI Tools Guide</Card>
    </Accordion>
