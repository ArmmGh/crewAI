...
<AccordionGroup>
    ...
    <Accordion title="Onde posso encontrar a documentação mais recente da LocalAI?">
        A documentação mais atualizada da LocalAI está disponível em nosso site oficial de documentação: https://docs.crewai.com/
        <Card href="https://docs.crewai.com/" icon="books">LocalAI Docs</Card>
    </Accordion>
    ...
    <Accordion title="Quais são os diferentes tipos de memória disponíveis na localAI?">
        ...
        <Card href="https://docs.crewai.com/concepts/memory" icon="brain">LocalAI Memory</Card>
    </Accordion>
