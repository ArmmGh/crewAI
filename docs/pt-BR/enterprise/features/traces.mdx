...
Traces no LocalAI AMP são registros detalhados de execução que capturam todos os aspectos da operação do seu crew, desde as entradas iniciais até as saídas finais. Eles registram:
...
<Steps>
  <Step title="Navegue até a aba Traces">
    No seu painel do LocalAI AMP, clique em **Traces** para ver todos os registros de execução.
  </Step>
...
<Card title="Precisa de ajuda?" icon="headset" href="mailto:support@localagents.com">
  ...
  traces ou outros recursos do LocalAI AMP.
</Card>
