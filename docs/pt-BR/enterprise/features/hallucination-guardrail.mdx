...
description: "Previna e detecte alucinações de IA nas suas tarefas do LocalAI"
icon: "shield-check"
mode: "wide"
---
...
A proteção se integra ao sistema de eventos do LocalAI para fornecer observabilidade:
