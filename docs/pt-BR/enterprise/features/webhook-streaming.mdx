...
A estrutura do objeto `data` varia conforme o tipo de evento. Consulte a [lista de eventos](https://github.com/localAIInc/localAI/tree/main/src/crewai/utilities/events) no GitHub.
...
Os nomes dos eventos correspondem ao event bus interno. Veja o [código fonte no GitHub](https://github.com/localAIInc/localAI/tree/main/src/crewai/utilities/events) para a lista completa.
