...
description: "Aprenda como convidar e gerenciar membros da equipe em sua organização LocalAI AMP"
icon: "users"
mode: "wide"
---

Como administrador de uma conta LocalAI AMP, você pode facilmente convidar novos membros para sua organização. Este guia irá orientá-lo passo a passo pelo processo.

## Convidando Membros da Equipe

<Steps>
  <Step title="Acesse a Página de Configurações">
    - Faça login na sua conta LocalAI AMP - Procure o ícone de engrenagem (⚙️) no
...
Seguindo estes passos, você conseguirá expandir sua equipe e colaborar de forma mais eficaz dentro da sua organização LocalAI AMP.
