...
description: "Dispare crews do LocalAI a partir de fluxos de trabalho no Zapier para automatizar fluxos multiaplicativos"
icon: "bolt"
mode: "wide"
---

Este guia irá conduzi-lo pelo processo de configuração de triggers no Zapier para o LocalAI AMP, permitindo automatizar fluxos de trabalho entre LocalAI AMP e outros aplicativos.

## Pré-requisitos

- Uma conta LocalAI AMP
- Uma conta Zapier
...
<Steps>
    ...
    <Step title="Configure a ação do LocalAI AMP">
        - Adicione uma nova etapa de ação ao seu Zap.
        - Escolha LocalAI+ como o app de ação e Kickoff como Evento de Ação.
    ...
    <Step title="Conecte sua conta LocalAI AMP">
        - Conecte sua conta LocalAI AMP.
    ...
    <Step title="Formate a saída do LocalAI AMP">
        - Adicione outra etapa de ação para formatar a saída de texto do LocalAI AMP.
    ...
    <Step title="Envie a saída por e-mail">
        ...
        - Insira a saída formatada do LocalAI AMP no corpo do e-mail.
...
- Certifique-se de que as entradas do LocalAI AMP estejam corretamente mapeadas a partir da mensagem do Slack.
...
Seguindo estes passos, você terá configurado com sucesso triggers no Zapier para o LocalAI AMP, permitindo fluxos de trabalho automatizados disparados por mensagens no Slack e resultando em notificações por e-mail com a saída do LocalAI AMP.
