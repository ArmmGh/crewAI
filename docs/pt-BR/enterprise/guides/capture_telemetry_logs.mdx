...
description: "Exporte traces e logs das suas implantações LocalAI AMP para seu próprio coletor OpenTelemetry"
icon: "magnifying-glass-chart"
mode: "wide"
---

O LocalAI AMP pode exportar **traces** e **logs** do OpenTelemetry das suas implantações diretamente para seu próprio coletor. Isso permite que você monitore o desempenho dos agentes, rastreie chamadas de LLM e depure problemas usando sua stack de observabilidade existente.

Os dados de telemetria seguem as [convenções semânticas GenAI do OpenTelemetry](https://opentelemetry.io/docs/specs/semconv/gen-ai/) além de atributos adicionais específicos do LocalAI.

## Pré-requisitos

<CardGroup cols={2}>
  <Card title="Conta LocalAI AMP" icon="users">
    Sua organização deve ter uma conta LocalAI AMP ativa.
  </Card>
...
1. No LocalAI AMP, vá para **Settings** > **OpenTelemetry Collectors**.
...
<Frame>![Configuração do Coletor OpenTelemetry](/images/localagents-otel-collector-config.png)</Frame>
