---
title: "Slack Trigger"
description: "Acione crews do LocalAI diretamente do Slack usando comandos de barra"
icon: "slack"
mode: "wide"
---

Este guia explica como iniciar um crew diretamente do Slack usando triggers do LocalAI.

## Pré-requisitos

- Trigger do LocalAI para Slack instalado e conectado ao seu workspace do Slack
- Pelo menos um crew configurado no LocalAI

## Etapas de Configuração

<Steps>
    <Step title="Garanta que o trigger do LocalAI para Slack está configurado">
        No dashboard do LocalAI, navegue até a seção **Triggers**.

        <Frame>
            <img src="/images/enterprise/slack-integration.png" alt="Integração LocalAI Slack" />
        </Frame>
...
- Se você não visualizar o crew desejado no menu suspenso, verifique se ele está devidamente configurado e online no LocalAI.