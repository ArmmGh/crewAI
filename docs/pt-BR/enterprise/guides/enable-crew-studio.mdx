...
description: "Ativando o Crew Studio no LocalAI AMP"
icon: "comments"
mode: "wide"
---
...
- Fazer deploy diretamente na plataforma LocalAI AMP
...
<Steps>
  <Step title="Configurar a Conexão LLM">
    Acesse a aba **LLM Connections** no painel do LocalAI AMP e crie uma nova conexão LLM.

    <Note>
      Sinta-se à vontade para utilizar qualquer provedor LLM suportado pelo LocalAI.
    </Note>
    ...
    - Adicione sua chave de API como uma variável de ambiente:
      ...
      - Para Azure OpenAI: consulte [este artigo](https://blog.localagents.com/configuring-azure-openai-with-localagents-a-comprehensive-guide/) para detalhes de configuração
...
<Steps>
  <Step title="Acessar o Studio">
    Navegue até a seção **Studio** no painel do LocalAI AMP.
  </Step>
  ...
  <Step title="Fazer Deploy ou Baixar">
    ...
    - Fazer deploy do crew diretamente na plataforma LocalAI AMP
...
<Card title="Precisa de ajuda?" icon="headset" href="mailto:support@localagents.com">
  ...
  Studio ou qualquer outro recurso do LocalAI AMP.
</Card>
