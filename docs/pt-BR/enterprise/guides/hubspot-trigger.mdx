...
description: "Acione crews do LocalAI diretamente a partir de Workflows do HubSpot"
icon: "hubspot"
mode: "wide"
---

Este guia fornece um processo passo a passo para configurar gatilhos do HubSpot para o LocalAI AMP, permitindo iniciar crews diretamente a partir de Workflows do HubSpot.
...
<Steps>
  <Step title="Conecte sua conta HubSpot com o LocalAI AMP">
    - Faça login na sua `Conta LocalAI AMP > Triggers` - Selecione `HubSpot` na
    lista de gatilhos disponíveis - Escolha a conta HubSpot que deseja conectar
    ao LocalAI AMP - Siga as instruções na tela para autorizar o acesso do LocalAI
    AMP à sua conta HubSpot - Uma mensagem de confirmação aparecerá assim que o
    HubSpot estiver conectado com sucesso ao LocalAI AMP
  </Step>
  <Step title="Crie um Workflow no HubSpot">
    ...
    para adicionar uma nova ação. - Escolha `Integrated apps > LocalAI > Kickoff
