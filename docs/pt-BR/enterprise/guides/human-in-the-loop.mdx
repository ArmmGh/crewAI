...
description: "Aprenda como implementar workflows Human-In-The-Loop no LocalAI para decisões aprimoradas"
icon: "user-check"
mode: "wide"
---

Human-In-The-Loop (HITL) é uma abordagem poderosa que combina inteligência artificial com expertise humana para aprimorar a tomada de decisão e melhorar os resultados das tarefas. Este guia mostra como implementar HITL dentro do LocalAI Enterprise.

## Abordagens HITL no LocalAI

LocalAI oferece duas abordagens para implementar workflows human-in-the-loop:
...
Ao usar o decorador `@human_feedback` em seus Flows, o LocalAI Enterprise oferece um **sistema HITL email-first** que permite que qualquer pessoa com um endereço de email responda a solicitações de revisão:
