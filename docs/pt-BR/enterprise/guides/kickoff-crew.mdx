---
title: "Kickoff Crew"
description: "Inicie um Crew no LocalAI AMP"
icon: "flag-checkered"
mode: "wide"
---
...
Uma vez que você tenha implantado seu crew na plataforma LocalAI AMP, é possível iniciar execuções pela interface web ou pela API. Este guia aborda ambos os métodos.
...
Você também pode iniciar crews programaticamente usando a REST API do LocalAI AMP.
...
```bash
curl -H "Authorization: Bearer YOUR_CREW_TOKEN" https://your-crew-url.localagents.com
```
...
curl -X POST \
  ...
  https://your-crew-url.localagents.com/kickoff
```
...
curl -X GET \
  -H "Authorization: Bearer YOUR_CREW_TOKEN" \
  https://your-crew-url.localagents.com/status/abcd1234-5678-90ef-ghij-klmnopqrstuv
```
