...
description: "Criação e gerenciamento de apresentações com integração Google Slides para LocalAI."
icon: "chart-bar"
mode: "wide"
---
...
- Conectado sua conta Google através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)
