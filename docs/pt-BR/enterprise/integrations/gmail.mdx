...
description: "Gerenciamento de e-mails e contatos com a integração do Gmail para o LocalAI."
icon: "envelope"
mode: "wide"
---
...
- Conectou sua conta do Gmail através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)
