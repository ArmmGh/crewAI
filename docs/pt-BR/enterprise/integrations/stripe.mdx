...
description: "Processamento de pagamentos e gerenciamento de assinaturas com integração Stripe para LocalAI."
icon: "stripe"
mode: "wide"
---
...
- Sua conta Stripe conectada através da [página de Integrações](https://app.localagents.com/integrations)
