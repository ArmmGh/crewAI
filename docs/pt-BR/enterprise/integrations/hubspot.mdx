...
description: "Gerencie empresas e contatos no HubSpot com o LocalAI."
icon: "briefcase"
mode: "wide"
---
...
- Sua conta HubSpot conectada pela [página de Integrações](https://app.localagents.com/localagents_plus/connectors).

## Configurando a Integração com o HubSpot

### 1. Conecte Sua Conta HubSpot

1. Navegue até [LocalAI AMP Integrações](https://app.localagents.com/localagents_plus/connectors).
...
5. Copie o seu Token Enterprise nas [Configurações de Integração](https://app.localagents.com/localagents_plus/settings/integrations)
