...
description: "Rastreamento de problemas e gestão de projetos com a integração Jira para LocalAI."
icon: "bug"
mode: "wide"
---
...
- Sua conta Jira conectada pela [Página de Integrações](https://app.localagents.com/localagents_plus/connectors)
