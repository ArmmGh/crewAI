...
description: "Coordenação de tarefas e projetos em equipe com a integração Asana para LocalAI."
icon: "circle"
mode: "wide"
---
...
- Sua conta Asana conectada através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)
