...
description: "Gestão de suporte ao cliente e helpdesk com integração Zendesk para LocalAI."
icon: "headset"
mode: "wide"
---
...
- Sua conta Zendesk conectada através da [página de Integrações](https://app.localagents.com/integrations)
