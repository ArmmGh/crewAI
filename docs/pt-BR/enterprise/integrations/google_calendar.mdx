...
description: "Gerenciamento de eventos e agendas com integração ao Google Calendar para o LocalAI."
icon: "calendar"
mode: "wide"
---
...
- Sua conta Google conectada pela [página de Integrações](https://app.localagents.com/localagents_plus/connectors)
