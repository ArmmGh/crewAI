...
description: "Gerenciamento de tarefas e produtividade com integração ClickUp para LocalAI."
icon: "list-check"
mode: "wide"
---
...
- Sua conta ClickUp conectada pela [Página de Integrações](https://app.localagents.com/localagents_plus/connectors)

## Configurando a Integração com o ClickUp

### 1. Conecte sua Conta ClickUp

1. Acesse [LocalAI AMP Integrações](https://app.localagents.com/localagents_plus/connectors)
