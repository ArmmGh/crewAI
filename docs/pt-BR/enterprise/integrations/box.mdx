...
description: "Armazenamento de arquivos e gerenciamento de documentos com a integração do Box para LocalAI."
icon: "box"
mode: "wide"
---
...
- Sua conta Box conectada através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)
