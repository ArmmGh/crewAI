...
- Sua conta Notion conectada através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)

## Configurando a Integração com o Notion

### 1. Conecte sua Conta Notion

1. Acesse [Integrações do LocalAI AMP](https://app.localagents.com/localagents_plus/connectors)
...
5. Copie seu Token Enterprise em [Configurações de Integração](https://app.localagents.com/localagents_plus/settings/integrations)
