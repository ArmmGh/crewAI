...
description: "Gerenciamento de repositórios e issues com a integração do GitHub para LocalAI."
icon: "github"
mode: "wide"
---
...
- Conta do GitHub conectada através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)

## Configurando a Integração com GitHub

### 1. Conecte sua conta GitHub

1. Acesse [Integrações LocalAI AMP](https://app.localagents.com/localagents_plus/connectors)
