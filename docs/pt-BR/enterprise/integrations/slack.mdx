...
description: "Comunicação e colaboração em equipe com a integração Slack para LocalAI."
icon: "slack"
mode: "wide"
---
...
- Seu workspace do Slack conectado por meio da [página de Integrações](https://app.localagents.com/integrations)
