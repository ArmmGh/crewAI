...
description: "Gestão de e-commerce e loja online com integração do Shopify para LocalAI."
icon: "shopify"
mode: "wide"
---
...
- Sua loja Shopify conectada através da [página de Integrações](https://app.localagents.com/integrations)
