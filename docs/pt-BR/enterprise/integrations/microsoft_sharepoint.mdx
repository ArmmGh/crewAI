...
description: "Gerenciamento de sites, listas e documentos com integração Microsoft SharePoint para LocalAI."
icon: "folder-tree"
mode: "wide"
---
...
- Uma conta [LocalAI AMP](https://app.localagents.com) com assinatura ativa
- Uma conta Microsoft com acesso ao SharePoint
- Conectado sua conta Microsoft através da [página de Integrações](https://app.localagents.com/localagents_plus/connectors)

## Configurando a Integração Microsoft SharePoint

### 1. Conecte sua Conta Microsoft

1. Navegue para [Integrações LocalAI AMP](https://app.localagents.com/localagents_plus/connectors)
...
5. Copie seu Token Enterprise das [Configurações de Integração](https://app.localagents.com/localagents_plus/settings/integrations)
