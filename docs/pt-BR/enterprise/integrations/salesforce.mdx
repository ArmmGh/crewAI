...
description: "Automação de vendas e CRM com integração Salesforce para LocalAI."
icon: "salesforce"
mode: "wide"
---
...
- Sua conta Salesforce conectada via a [página de Integrações](https://app.localagents.com/integrations)
