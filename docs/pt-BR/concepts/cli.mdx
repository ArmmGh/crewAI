...
Implemente o crew ou flow no [LocalAI AMP](https://app.crewai.com).
...
Assista ao vídeo tutorial para uma demonstração passo-a-passo de implantação do seu crew no [LocalAI AMP](http://app.crewai.com) usando o CLI.
...
| :------------------ | :--------------------- | :------------------------------------------------------------- |
| enterprise_base_url | https://app.crewai.com | URL base da instância LocalAI AMP                               |
