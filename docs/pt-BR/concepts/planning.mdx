---
title: Planejamento
description: Aprenda como adicionar planejamento à sua LocalAI Crew e melhorar sua performance.
icon: ruler-combined
mode: "wide"
---
...
O recurso de planejamento no LocalAI permite que você adicione capacidade de planejamento à sua crew. Quando ativado, antes de cada iteração da Crew, todas as informações da Crew são enviadas para um AgentPlanner que irá planejar as tarefas passo a passo, e este plano será adicionado à descrição de cada tarefa.
