---
title: "Introdução"
description: "Referência completa para a API REST do LocalAI AMP"
icon: "code"
mode: "wide"
---
...
Bem-vindo à referência da API do LocalAI AMP. Esta API permite que você interaja programaticamente com seus crews implantados, possibilitando a integração com seus aplicativos, fluxos de trabalho e serviços.

## Início Rápido

<Steps>
  <Step title="Obtenha suas credenciais de API">
    Navegue até a página de detalhes do seu crew no painel do LocalAI AMP e copie seu Bearer Token na aba Status.
  </Step>
...
curl -H "Authorization: Bearer YOUR_CREW_TOKEN" \
  https://your-crew-url.localagents.com/inputs
```
...
<Tip>
  ...
  detalhes do seu crew no painel do LocalAI AMP.
</Tip>
...
```
https://your-crew-name.localagents.com
```
...
<Info>
  **Por que não há botão "Enviar"?** Como cada usuário do LocalAI AMP possui sua
...
2. **Substitua `your-actual-crew-name.localagents.com`** pela URL real do seu crew
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="chart-line"
    href="https://app.localagents.com"
  >
