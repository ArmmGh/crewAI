...
description: Saiba como definir um agente personalizado como gerente no LocalAI, proporcionando mais controle sobre o gerenciamento e a coordenação das tarefas.
icon: user-shield
mode: "wide"
---

# Definindo um Agente Específico como Gerente no LocalAI

O LocalAI permite que usuários definam um agente específico como gerente da crew, oferecendo mais controle sobre o gerenciamento e a coordenação das tarefas.
