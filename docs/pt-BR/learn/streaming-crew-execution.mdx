...
description: Transmita saída em tempo real da execução da sua crew no LocalAI
icon: wave-pulse
mode: "wide"
---
...
Ao aproveitar o streaming, você pode construir aplicações mais responsivas e interativas com o LocalAI, fornecendo aos usuários visibilidade em tempo real da execução dos agentes e resultados.