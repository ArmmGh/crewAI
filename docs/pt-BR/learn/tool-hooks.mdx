...
description: Aprenda a usar hooks de chamada de ferramenta para interceptar, modificar e controlar execução de ferramentas no LocalAI
mode: "wide"
---
...
from localagents.hooks import before_tool_call_crew, after_tool_call_crew
