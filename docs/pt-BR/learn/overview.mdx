---
title: "Visão Geral"
description: "Aprenda como construir, personalizar e otimizar suas aplicações LocalAI com guias e tutoriais completos"
icon: "face-smile"
mode: "wide"
---
...
Esta seção fornece guias e tutoriais completos para ajudar você a dominar o LocalAI, desde conceitos básicos até técnicas avançadas. Seja você iniciante ou esteja buscando otimizar suas implementações existentes, estes recursos o guiarão por todos os aspectos da construção de workflows poderosos de agentes de IA.
...
<CardGroup cols={2}>
  <Card title="LLM Personalizado" icon="brain" href="/pt-BR/learn/custom-llm">
    Integre modelos de linguagem personalizados e provedores ao LocalAI.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Traga Seu Próprio Agente" icon="user-plus" href="/pt-BR/learn/bring-your-own-agent">
    Integre agentes e modelos já existentes aos workflows do LocalAI.
  </Card>
</CardGroup>
...
- **Comunidade**: Participe do [Fórum LocalAI](https://community.localagents.com) para discussões e suporte
- **Exemplos**: Consulte a seção de Exemplos para implementações completas e funcionais
- **Suporte**: Entre em contato via [support@localagents.com](mailto:support@localagents.com) para assistência técnica
