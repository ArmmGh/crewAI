...
description: Guia abrangente sobre como criar, utilizar e gerenciar ferramentas personalizadas dentro do framework LocalAI, incluindo novas funcionalidades e tratamento de erros.
icon: hammer
mode: "wide"
---

## Criando e Utilizando Ferramentas no LocalAI

Este guia traz instruções detalhadas sobre como criar ferramentas personalizadas para o framework LocalAI e como gerenciar e utilizar essas ferramentas de forma eficiente,
...
O LocalAI suporta ferramentas assíncronas para operações de I/O não bloqueantes. Isso é útil quando sua ferramenta precisa fazer requisições HTTP, consultas a banco de dados ou outras operações de I/O.
...
você pode aproveitar ao máximo as capacidades do framework LocalAI, aprimorando tanto a experiência de desenvolvimento quanto a eficiência dos seus agentes de IA.
