...
description: Aprenda como forçar a saída de uma ferramenta como resultado em uma tarefa de Agent no LocalAI.
icon: wrench-simple
mode: "wide"
---
...
No LocalAI, você pode forçar a saída de uma ferramenta como o resultado de uma tarefa de um agent.  
