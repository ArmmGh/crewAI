...
description: "Aprenda a usar o DALL-E para geração de imagens com IA em seus projetos LocalAI"
icon: "image"
mode: "wide"
---

O LocalAI oferece integração com o DALL-E da OpenAI, permitindo que seus agentes de IA gerem imagens como parte de suas tarefas. Este guia irá orientá-lo sobre como configurar e utilizar a ferramenta DALL-E em seus projetos LocalAI.

## Pré-requisitos

- localAI instalado (última versão)
...
<Steps>
    <Step title="Importe a ferramenta DALL-E">
        ```python
        from localagents_tools import DallETool
        ```
    </Step>
...
2. **Compatibilidade de versões** - Verifique se você está utilizando a versão mais recente do localAI e localagents-tools.
