...
description: Aprenda como habilitar seus Agentes LocalAI para escrever e executar código, e explore funcionalidades avançadas para maior potencial.
icon: rectangle-code
mode: "wide"
---
...
Os Agentes LocalAI agora têm a poderosa capacidade de escrever e executar código, aumentando significativamente suas habilidades de resolução de problemas. Esse recurso é particularmente útil para tarefas que exigem soluções computacionais ou programáticas.
...
3. **Dependências**: Para usar o recurso de execução de código, é necessário instalar o pacote `localagents_tools`. Caso não esteja instalado, o agente registrará uma mensagem informativa:
"Ferramentas de codificação não disponíveis. Instale localagents_tools."
