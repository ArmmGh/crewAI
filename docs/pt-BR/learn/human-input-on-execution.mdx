...
description: Integrando o LocalAI com input humano durante a execução em processos complexos de tomada de decisão e aproveitando ao máximo todos os atributos e ferramentas do agente.
icon: user-plus
mode: "wide"
---
...
## Usando input humano com LocalAI
