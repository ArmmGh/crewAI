...
description: Um guia abrangente para adaptar agentes a funções específicas, tarefas e customizações avançadas dentro do framework LocalAI.
icon: user-pen
mode: "wide"
---
...
A construção de uma equipe LocalAI eficiente depende da capacidade de adaptar dinamicamente seus agentes de IA para atender aos requisitos únicos de qualquer projeto. Esta seção aborda os atributos fundamentais que você pode personalizar.
...
Além dos atributos básicos, o LocalAI permite customizações mais profundas para aprimorar significativamente o comportamento e as capacidades de um agente.
...
Controlar a capacidade de um agente delegar tarefas ou fazer perguntas é fundamental para ajustar sua autonomia e a dinâmica de colaboração dentro do framework LocalAI. Por padrão, 
...
eficiência dentro do ecossistema LocalAI. Se necessário, a delegação pode ser ativada para atender requisitos operacionais específicos.
