...
[Spider](https://spider.cloud/?ref=localagents) é o [scraper](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md#benchmark-results) e crawler de código aberto mais rápido que retorna dados prontos para LLM.  
...
e também o SDK `localagents[tools]`:
