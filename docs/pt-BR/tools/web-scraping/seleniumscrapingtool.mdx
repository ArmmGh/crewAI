...
Para utilizar esta ferramenta, é necessário instalar o pacote LocalAI tools e o Selenium:
...
O exemplo a seguir demonstra como usar o `SeleniumScrapingTool` com um agente LocalAI:
...
Aqui está um exemplo mais detalhado de como integrar o `SeleniumScrapingTool` com um agente LocalAI:
