...
description: Ferramenta de automação web que integra o Stagehand ao LocalAI para interação e automação em navegadores
icon: hand
mode: "wide"
---
...
A `StagehandTool` integra o framework [Stagehand](https://docs.stagehand.dev/get_started/introduction) com o LocalAI, permitindo que agentes interajam com sites e automatizem tarefas no navegador utilizando instruções em linguagem natural.
...
A StagehandTool encapsula o SDK Python do Stagehand para fornecer aos agentes do LocalAI capacidades de controle do navegador através de três primitivas principais:
...
Para dúvidas sobre a integração com o LocalAI:
