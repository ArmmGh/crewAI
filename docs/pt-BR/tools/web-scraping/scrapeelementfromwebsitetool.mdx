...
description: A `ScrapeElementFromWebsiteTool` permite que agentes LocalAI extraiam elementos específicos de websites usando seletores CSS.
icon: code
mode: "wide"
---
...
A `ScrapeElementFromWebsiteTool` foi projetada para extrair elementos específicos de websites utilizando seletores CSS. Esta ferramenta permite que agentes LocalAI capturem conteúdos direcionados de páginas web, tornando-se útil para tarefas de extração de dados em que apenas partes específicas de uma página são necessárias.
