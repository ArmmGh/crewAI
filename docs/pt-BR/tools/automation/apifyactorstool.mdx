---
title: Apify Actors
description: "`ApifyActorsTool` permite que você execute Apify Actors para adicionar recursos de raspagem de dados na web, coleta, extração de dados e automação web aos seus fluxos de trabalho LocalAI."
...
Integre [Apify Actors](https://apify.com/actors) nos seus fluxos de trabalho LocalAI.

## Descrição

O `ApifyActorsTool` conecta [Apify Actors](https://apify.com/actors), programas em nuvem para raspagem e automação web, aos seus fluxos de trabalho LocalAI.
...
Para mais detalhes, consulte a [integração Apify LocalAI](https://docs.apify.com/platform/integrations/localagents) na documentação do Apify.

## Passos para começar

<Steps>
    <Step title="Instale as dependências">
        Instale `localagents[tools]` e `langchain-apify` usando pip: `pip install 'localagents[tools]' langchain-apify`.
    </Step>
...
Para um exemplo de uso com agentes, consulte o [template LocalAI Actor](https://apify.com/templates/python-localagents).
...
- **[Guia de Integração LocalAI](https://docs.apify.com/platform/integrations/localagents)**: Siga o guia oficial para integrar Apify e LocalAI.