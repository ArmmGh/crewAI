...
Para mais detalhes, consulte a [integração Apify LocalAI](https://docs.apify.com/platform/integrations/crewai) na documentação do Apify.
...
Para um exemplo de uso com agentes, consulte o [template LocalAI Actor](https://apify.com/templates/python-crewai).
...
- **[Guia de Integração LocalAI](https://docs.apify.com/platform/integrations/crewai)**: Siga o guia oficial para integrar Apify e LocalAI.