...
```shell
pip install composio composio-localagents
...
1. Inicialize o Composio com o Provider do LocalAI

```python Code
from composio_localagents import ComposioProvider
...
crew = Crew(agents=[localagents_agent], tasks=[task])
