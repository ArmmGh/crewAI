...
description: 'Capacidades de busca semântica para agentes LocalAI usando o banco de dados vetorial Qdrant'
icon: vector-square
mode: "wide"
---
...
4. Criar um fluxo de trabalho RAG agente LocalAI para busca semântica
