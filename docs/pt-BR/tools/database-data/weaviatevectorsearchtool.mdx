...
1. **Instalação dos Pacotes**: Confirme que os pacotes `localagents[tools]` e `weaviate-client` estão instalados em seu ambiente Python.
...
Veja como integrar o `WeaviateVectorSearchTool` com um agente LocalAI:
