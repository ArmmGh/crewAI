...
description: "Descubra a vasta biblioteca do LocalAI com mais de 40 ferramentas para potencializar seus agentes de IA"
icon: "toolbox"
mode: "wide"
---

O LocalAI oferece uma biblioteca extensa de ferramentas pré-construídas para aprimorar as capacidades dos seus agentes. De processamento de arquivos a web scraping, consultas em bancos de dados a serviços de IA — temos tudo o que você precisa.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Integrações"
    icon="plug"
    href="/pt-BR/tools/tool-integrations/overview"
    color="#0891B2"
  >
    Integre o LocalAI com sistemas externos como Amazon Bedrock e o toolkit de Automação do LocalAI.
  </Card>
</CardGroup>
...
Para usar qualquer ferramenta em seu projeto LocalAI:
...
```python
from localagents_tools import FileReadTool, SerperDevTool
