---
title: LocalAI Run Automation Tool
description: Enables LocalAI agents to invoke LocalAI Platform automations and leverage external crew services within your workflows.
icon: robot
---

# `InvokeLocalAgentsAutomationTool`

The `InvokeLocalAgentsAutomationTool` provides LocalAI Platform API integration with external crew services. This tool allows you to invoke and interact with LocalAI Platform automations from within your LocalAI agents, enabling seamless integration between different crew workflows.
...
- LocalAI Platform API access
- Valid bearer token for authentication
- Network access to LocalAI Platform automation endpoints
...
from localagents_tools import InvokeLocalAgentsAutomationTool

# Initialize the tool
automation_tool = InvokeLocalAgentsAutomationTool(
...
|:---------|:-----|:---------|:--------|:------------|
| **crew_api_url** | `str` | Yes | None | Base URL of the LocalAI Platform automation API |
...
```bash
LOCALAGENTS_API_URL=https://your-crew-automation.localagents.com  # Alternative to passing crew_api_url
LOCALAGENTS_BEARER_TOKEN=your_bearer_token_here              # Alternative to passing crew_bearer_token
```
...
market_research_tool = InvokeLocalAgentsAutomationTool(
...
data_collection_tool = InvokeLocalAgentsAutomationTool(
    crew_api_url="https://data-collection-crew-[...].localagents.com",
    crew_bearer_token="your_bearer_token_here",
    crew_name="Data Collection Automation",
    crew_description="Collects and preprocesses raw data"
)

analysis_tool = InvokeLocalAgentsAutomationTool(
    crew_api_url="https://analysis-crew-[...].localagents.com",
    crew_bearer_token="your_bearer_token_here",
    crew_name="Analysis Automation",
    crew_description="Performs advanced data analysis and modeling"
)

reporting_tool = InvokeLocalAgentsAutomationTool(
    crew_api_url="https://reporting-crew-[...].localagents.com",
    crew_bearer_token="your_bearer_token_here",
...
- Scale processing by distributing workloads across multiple LocalAI Platform automations

### Cross-Platform Integration
- Bridge LocalAI agents with LocalAI Platform automations for hybrid local-cloud workflows
...
- **API Connection Errors**: Network connectivity issues with LocalAI Platform
