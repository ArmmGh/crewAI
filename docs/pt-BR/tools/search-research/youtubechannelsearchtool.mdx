...
Para utilizar o YoutubeChannelSearchTool, é necessário instalar o pacote `localagents_tools`. Execute o seguinte comando no seu terminal para instalar:
...
O exemplo a seguir demonstra como utilizar o `YoutubeChannelSearchTool` com um agente LocalAI:
...
Veja um exemplo mais detalhado de como integrar o `YoutubeChannelSearchTool` com um agente LocalAI:
