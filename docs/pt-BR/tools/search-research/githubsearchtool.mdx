...
Para usar o GithubSearchTool, primeiro certifique-se de que o pacote localagents_tools está instalado em seu ambiente Python:

```shell
pip install 'localagents[tools]'
```

Esse comando instala o pacote necessário para rodar o GithubSearchTool juntamente com outras ferramentas incluídas no pacote localagents_tools.
