...
O `FileWriterTool` é um componente do pacote localagents_tools, projetado para simplificar o processo de escrita de conteúdo em arquivos com compatibilidade multiplataforma (Windows, Linux, macOS).  
...
Instale o pacote localagents_tools para utilizar o `FileWriterTool` em seus projetos:
