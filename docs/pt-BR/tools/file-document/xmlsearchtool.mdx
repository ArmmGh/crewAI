...
Para começar a usar o XMLSearchTool, é necessário instalar primeiro o pacote localagents_tools. Isso pode ser feito facilmente com o seguinte comando:
...
```python Code
from localagents_tools import XMLSearchTool
