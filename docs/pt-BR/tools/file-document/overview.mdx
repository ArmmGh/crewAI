---
title: "Visão Geral"
description: "Leia, escreva e pesquise em diversos formatos de arquivos com as ferramentas de processamento de documentos do LocalAI"
icon: "face-smile"
mode: "wide"
---
...
```python
from localagents_tools import FileReadTool, PDFSearchTool, JSONSearchTool
