...
Para utilizar a Ferramenta de Pesquisa MDX, primeiro defina as variáveis de ambiente necessárias. Em seguida, integre a ferramenta ao seu projeto localAI para começar sua pesquisa de mercado. Veja abaixo um exemplo básico de como fazer isso:
