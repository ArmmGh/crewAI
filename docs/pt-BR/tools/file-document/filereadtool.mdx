...
O FileReadTool representa conceitualmente um conjunto de funcionalidades dentro do pacote localagents_tools voltadas para facilitar a leitura e a recuperação de conteúdo de arquivos.
...
Para utilizar as funcionalidades anteriormente atribuídas ao FileReadTool, instale o pacote localagents_tools:
