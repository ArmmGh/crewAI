---
title: Guia Rápido
description: Construa seu primeiro agente de IA com a LocalAI em menos de 5 minutos.
icon: rocket
mode: "wide"
---

## Construa seu primeiro Agente LocalAI
...
Antes de prosseguir, certifique-se de ter concluído a instalação da LocalAI.
...
<Steps>
  ...
  <Step title="[Opcional] Adicione funções de pré e pós execução da tripulação">
    ...
    # src/latest_ai_development/crew.py
    from localagents import Agent, Crew, Process, Task
    from localagents.project import CrewBase, agent, crew, task, before_kickoff, after_kickoff
    from localagents_tools import SerperDevTool
  ...
  Para usuários do LocalAI AMP, você pode criar a mesma tripulação sem escrever código:

1. Faça login na sua conta LocalAI AMP (crie uma conta gratuita em [app.localagents.com](https://app.localagents.com))
...
![Crew Studio Quickstart](/images/enterprise/crew-studio-interface.png)
  ...
  <Card title="Experimente o LocalAI AMP" icon="rocket" href="https://app.localagents.com">
    Comece sua conta gratuita no LocalAI AMP
  </Card>
  </Step>
...
Veja um exemplo de como o relatório deve ser:
  ...
  <CodeGroup>
    ...
    - **LocalAI**: Aimed at collaborative environments, LocalAI strengthens teamwork by facilitating communication through AI-driven insights.
...
Essa consistência de nomes permite que a LocalAI conecte automaticamente suas configurações ao seu código; caso contrário, sua tarefa não reconhecerá a referência corretamente.
...
A forma mais fácil de fazer deploy da sua tripulação em produção é através da [LocalAI AMP](http://app.localagents.com).

Assista a este vídeo tutorial para uma demonstração detalhada de como fazer deploy da sua tripulação na [LocalAI AMP](http://app.localagents.com) usando a CLI.
...
<CardGroup cols={2}>
  <Card title="Deploy no Enterprise" icon="rocket" href="http://app.localagents.com">
    Comece com o LocalAI AMP e faça o deploy da sua tripulação em ambiente de
    produção com apenas alguns cliques.
  </Card>
  <Card
    title="Junte-se à Comunidade"
    icon="comments"
    href="https://community.localagents.com"
  >
    Participe da nossa comunidade open source para discutir ideias, compartilhar
    seus projetos e conectar-se com outros desenvolvedores LocalAI.
  </Card>
</CardGroup>
