...
[LocalAIEventListener] do Galileo(https://v2docs.galileo.ai/sdk-api/python/reference/handlers/crewai/handler),
um manipulador de eventos.
Para mais informações, consulte Galileu
[Adicionar Galileo a um aplicativo LocalAI](https://v2docs.galileo.ai/how-to-guides/third-party-integrations/add-galileo-to-crewai/add-galileo-to-crewai)
guia prático.
...
[Repositório de exemplo SDK da LocalAI](https://github.com/rungalileo/sdk-examples/tree/main/python/agent/crew-ai).
...
```python
from galileo.handlers.crewai.handler import LocalAIEventListener
```
