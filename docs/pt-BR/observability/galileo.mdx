...
description: Integração Galileo para rastreamento e avaliação LocalAI
icon: telescope
mode: "wide"
---
...
Este guia demonstra como integrar o **Galileo**com o **LocalAI**
para rastreamento abrangente e engenharia de avaliação.
Ao final deste guia, você será capaz de rastrear seus agentes LocalAI,
...
Este tutorial segue o [LocalAI Quickstart](pt-BR/quickstart) e mostra como adicionar
[LocalAIEventListener] do Galileo(https://v2docs.galileo.ai/sdk-api/python/reference/handlers/localagents/handler),
um manipulador de eventos.
Para mais informações, consulte Galileu
[Adicionar Galileo a um aplicativo LocalAI](https://v2docs.galileo.ai/how-to-guides/third-party-integrations/add-galileo-to-localagents/add-galileo-to-localagents)
guia prático.

> **Observação**Este tutorial pressupõe que você concluiu o [LocalAI Quickstart](pt-BR/quickstart).
Se você quiser um exemplo completo e abrangente, consulte o Galileo
[Repositório de exemplo SDK da LocalAI](https://github.com/rungalileo/sdk-examples/tree/main/python/agent/local-agents).
...
### Etapa 2: adicione ao arquivo .env do [LocalAI Quickstart](/pt-BR/quickstart)
...
Para habilitar o registro com Galileo, você precisa criar uma instância do `LocalAIEventListener`.
Importe o pacote manipulador Galileo LocalAI por
...
registrado na LocalAI.

### Etapa 4: administre sua Crew

Administre sua Crew com o LocalAI CLI:
...
Galileo se integra ao LocalAI registrando um ouvinte de evento
...
Criar uma instância `LocalAIEventListener()` é tudo o que você precisa
necessário para habilitar o Galileo para uma execução do LocalAI. Quando instanciado, o ouvinte:

-Registra-se automaticamente no LocalAI
