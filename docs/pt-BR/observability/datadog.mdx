...
description: Saiba como integrar o Datadog com o LocalAI para enviar os rastros de observabilidade do LLM para o Datadog.
icon: dog
mode: "wide"
---

# Integrar o Datadog com a LocalAI

Este guia demonstrará como integrar o **Datadog** com o **LocalAI** usando a instrumentação automática do Datadog. Ao final deste guia, você poderá enviar rastreamentos do LLM Observability para o Datadog e visualizar as execuções do agente LocalAI no Agentic Execution View do Datadog LLM Observability.
...
```shell
pip install ddtrace localagents localagents-tools
```
...
### Criar um aplicativo agente LocalAI

```python
# localagents_agent.py
...
```shell
ddtrace-run python localagents_agent.py
```
...
- [Datadog LLM Observability LocalAI Auto-Instrumentation](https://docs.datadoghq.com/llm_observability/instrumentation/auto_instrumentation?tab=python#local-agents)
