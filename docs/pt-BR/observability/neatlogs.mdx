...
description: Understand, debug, and share your LocalAI agent runs
...
LocalAI agents use multiple tools and reasoning steps. When something goes wrong, you need context — not just errors.
...
The best UX to view a LocalAI trace. Post comments anywhere you want. Use AI to debug.
...
## Quick Setup with LocalAI

<Steps>
  <Step title="Sign Up & Get API Key">
    Visit [neatlogs.com](https://neatlogs.com/?utm_source=localAI-docs), create a project, copy the API key.
  </Step>
...
You can now capture, understand, share, and act on your LocalAI agent runs in seconds.
