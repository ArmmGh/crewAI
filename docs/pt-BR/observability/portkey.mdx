...
description: Como usar Portkey com LocalAI
icon: key
mode: "wide"
---

<img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/main/Portkey-LocalAI.png" alt="Portkey LocalAI Header Image" width="70%" />



## Introdução

Portkey aprimora o LocalAI com recursos prontos para produção, transformando seus crews de agentes experimentais em sistemas robustos ao fornecer:
...
```bash
pip install -U localagents portkey-ai
```
</Step>
...
<Step title="Configure o LocalAI com Portkey">
A integração é simples – basta atualizar a configuração do LLM no seu setup do LocalAI:
...
Portkey oferece observabilidade abrangente para seus agentes LocalAI, ajudando você a entender exatamente o que está acontecendo durante cada execução.

<Tabs>
  <Tab title="Traces">
<Frame>
    <img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20Product%2011.1.webp"/>
</Frame>
...
```
  ...
  <Tab title="Logs">
<Frame>
    <img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20Portkey%20Docs%20Metadata.png"/>
</Frame>
...
<Frame>
    <img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20Dashboard.png"/>
</Frame>
...
<Frame>
  <img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/Metadata%20Filters%20from%20LocalAI.png" alt="Analytics with metadata filters" />
</Frame>

Adicione metadados personalizados à configuração LLM do seu LocalAI para permitir filtragem e segmentação poderosas:
...
É simples habilitar fallback na sua configuração LocalAI usando um Config do Portkey:
...
### 3. Prompting no LocalAI

O Prompt Engineering Studio do Portkey ajuda você a criar, gerenciar e otimizar os prompts usados em seus agentes LocalAI. Em vez de codificar prompts ou instruções manualmente, use a API de renderização de prompts do Portkey para buscar e aplicar dinâmicamente seus prompts versionados.

<Frame caption="Gerencie prompts na Prompt Library do Portkey">
![Prompt Playground Interface](https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20Portkey%20Docs.webp)
</Frame>
...
Esse ambiente visual facilita a criação de prompts eficazes para cada etapa do fluxo de trabalho dos seus agentes LocalAI.
  </Tab>
...
Guardrails garantem que seus agentes LocalAI operem com segurança e respondam adequadamente em todas as situações.

**Por que usar Guardrails?**

Os agentes LocalAI podem apresentar falhas de diversos tipos:
...
Rastreie usuários individuais através dos seus agentes LocalAI utilizando o sistema de metadados do Portkey.
...
<Frame caption="Filtre analytics por usuário">
  <img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/Metadata%20Filters%20from%20LocalAI.png"/>
</Frame>
...
Implemente caching para tornar seus agentes LocalAI mais eficientes e econômicos:
...
O LocalAI oferece suporte a múltiplos provedores de LLM, e o Portkey amplia essa capacidade fornecendo acesso a mais de 200 LLMs por meio de uma interface unificada. Você pode facilmente alternar entre diferentes modelos sem alterar a lógica central do seu agente:
...
## Configure Governança Corporativa para o LocalAI

**Por que Governança Corporativa?**
Se você utiliza LocalAI dentro de sua organização, é importante considerar diversos aspectos de governança:
...
<Frame>
<img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20Portkey%20Docs%20Config.png" width="500"/>
...
<Frame>
<img src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/refs/heads/main/LocalAI%20API%20Key.png" width="500"/>

</Frame>
</Step>

<Step title="Conecte ao LocalAI">
Após configurar sua chave de API Portkey com a config anexada, conecte-a aos seus agentes LocalAI:
...
```
  ...
  <Accordion title="Etapa 4: Implante & Monitore">
    ...
    Após distribuir as chaves de API para os membros da equipe, seu setup corporativo LocalAI está pronto. Cada membro pode agora usar suas chaves designadas com os níveis de acesso e controles de orçamento apropriados.
...
**Sua integração LocalAI agora conta com:**
...
<AccordionGroup>
  <Accordion title="Como o Portkey aprimora o LocalAI?">
    Portkey adiciona prontidão para produção ao LocalAI através de observabilidade abrangente (traces, logs, métricas), recursos de confiabilidade (fallbacks, tentativas automáticas, cache) e acesso a mais de 200 LLMs por meio de uma interface unificada. Isso facilita depurar, otimizar e escalar suas aplicações de agentes.
  </Accordion>

  <Accordion title="Posso usar Portkey com aplicações LocalAI existentes?">
    Sim! Portkey integra-se perfeitamente a aplicações LocalAI existentes. Basta atualizar o código de configuração do LLM com a versão habilitada do Portkey. O restante do seu código de agente e crew permanece inalterado.
  </Accordion>

  <Accordion title="Portkey funciona com todos os recursos do LocalAI?">
    Portkey suporta todos os recursos do LocalAI, incluindo agentes, ferramentas, workflows human-in-the-loop e todos os tipos de processo de tarefas (sequencial, hierárquico, etc.). Ele adiciona observabilidade e confiabilidade sem limitar nenhuma funcionalidade do framework.
  </Accordion>
...
<CardGroup cols="3">
  <Card title="LocalAI Docs" icon="book" href="https://docs.localagents.com/">
    <p>Documentação oficial do LocalAI</p>
  </Card>
