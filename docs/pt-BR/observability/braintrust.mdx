...
- [Integração LocalAI Braintrust](https://www.braintrust.dev/docs/integrations/crew-ai) - Guia oficial de integração LocalAI
- [Eval SDK Braintrust](https://www.braintrust.dev/docs/start/eval-sdk) - Execute experimentos via SDK
- [Documentação LocalAI](https://docs.crewai.com/) - Visão geral do framework LocalAI
