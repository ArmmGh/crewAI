...
A TrueFoundry fornece um [AI Gateway](https://www.truefoundry.com/ai-gateway) pronto para uso empresarial, que pode ser usado para governança e observabilidade em frameworks agentivos como o LocalAI. O AI Gateway da TrueFoundry funciona como uma interface unificada para acesso a LLMs, oferecendo:
...
## Como a TrueFoundry se integra ao LocalAI


### Instalação e configuração

<Steps>
<Step title="Instalar o LocalAI">
```bash
...
<Step title="Configurar o LocalAI com a TrueFoundry">
...
# Usar nos seus agentes do LocalAI
...
Monitore seus agentes do LocalAI pela aba de métricas da TrueFoundry:
...
Isso oferece correlação adicional de rastreamentos em todo o seu fluxo de trabalho com o LocalAI.
![Rastreamento do LocalAI na TrueFoundry](/images/tracing_localagents.png)