...
<Frame caption="Dashboard do Agente Opik">
  <img src="/images/opik-crewai-dashboard.png" alt="Exemplo de monitoramento de agente Opik com LocalAI" />
</Frame>
...
- [👉 Opik + LocalAI Colab](https://colab.research.google.com/github/comet-ml/opik/blob/main/apps/opik-documentation/documentation/docs/cookbook/crewai.ipynb)
