...
**LocalAI é o principal framework open-source para orquestrar agentes de IA autônomos e construir fluxos de trabalho complexos.**
...
- **[Flows do LocalAI](/pt-BR/guides/flows/first-flow)**: A espinha dorsal da sua aplicação de IA. Flows permitem criar fluxos de trabalho estruturados e orientados a eventos que gerenciam estado e controlam a execução. Eles fornecem a estrutura para seus agentes de IA trabalharem.
- **[Crews do LocalAI](/pt-BR/guides/crews/first-crew)**: As unidades de trabalho dentro do seu Flow. Crews são equipes de agentes autônomos que colaboram para resolver tarefas específicas delegadas a eles pelo Flow.

Com mais de 100.000 desenvolvedores certificados em nossos cursos comunitários, o LocalAI é o padrão para automação de IA pronta para empresas.

## A Arquitetura do LocalAI

A arquitetura do LocalAI foi projetada para equilibrar autonomia com controle.
...
<Frame caption="Visão Geral do Framework LocalAI">
  <img src="/images/flows.png" alt="Visão Geral do Framework LocalAI" />
</Frame>
...
<Frame caption="Visão Geral do Framework LocalAI">
  <img src="/images/crews.png" alt="Visão Geral do Framework LocalAI" />
</Frame>
...
<CardGroup cols={3}>
  <Card
    title="Instale o LocalAI"
    icon="wrench"
    href="/pt-BR/installation"
  >
    Comece a usar o LocalAI em seu ambiente de desenvolvimento.
  </Card>
  <Card
  ...
  >
    Siga nosso guia rápido para criar seu primeiro agente LocalAI e colocar a mão na massa.
  </Card>
  <Card
  ...
  >
    Conecte-se com outros desenvolvedores, obtenha ajuda e compartilhe suas experiências com o LocalAI.
  </Card>
</CardGroup>
