        ...
        try:
            if not self.batch_manager.backend_initialized:
                ...
                execution_metadata = {
                    ...
                    "localagents_version": original_metadata.get("localagents_version"),
                }
...
• Set LOCALAGENTS_TRACING_ENABLED=false in your project's .env file
• Run: localagents traces disable
