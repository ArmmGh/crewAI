...
from localagents.cli.authentication.token import AuthError, get_auth_token
from localagents.cli.version import get_localagents_version
from localagents.events.base_event_listener import BaseEventListener
from localagents.events.base_events import BaseEvent
...
from localagents.events.listeners.tracing.trace_batch_manager import TraceBatchManager
...
from localagents.events.types.system_events import SignalEvent, on_signal
...
class TraceCollectionListener(BaseEventListener):
    ...
    def _get_user_context(self) -> dict[str, str]:
        ...
        return {
            "user_id": os.getenv("LOCALAGENTS_USER_ID", "anonymous"),
            "organization_id": os.getenv("LOCALAGENTS_ORG_ID", ""),
    ...
    def setup_listeners(self, localagents_event_bus: LocalAgentsEventsBus) -> None:
        ...
        self._register_env_event_handlers(localagents_event_bus)
        self._register_flow_event_handlers(localagents_event_bus)
        self._register_context_event_handlers(localagents_event_bus)
        self._register_action_event_handlers(localagents_event_bus)
        self._register_a2a_event_handlers(localagents_event_bus)
        self._register_system_event_handlers(localagents_event_bus)

        self._listeners_setup = True

    def _register_env_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _register_flow_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _register_context_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _register_action_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _register_a2a_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _register_system_event_handlers(self, event_bus: LocalAgentsEventsBus) -> None:
    ...
    def _initialize_crew_batch(self, source: Any, event: BaseEvent) -> None:
        ...
        execution_metadata = {
            ...
            "localagents_version": get_localagents_version(),
        }
