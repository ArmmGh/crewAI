...
from localagents.utilities.paths import db_storage_path
...
def should_enable_tracing(*, override: bool | None = None) -> bool:
    ...
    2. Environment variable LOCALAGENTS_TRACING_ENABLED
    ...
    env_value = os.getenv("LOCALAGENTS_TRACING_ENABLED", "").lower()
...
def _user_data_file() -> Path:
    ...
    return base / ".localagents_user.json"
...
def is_tracing_enabled() -> bool:
    ...
    return os.getenv("LOCALAGENTS_TRACING_ENABLED", "false").lower() == "true"
...
def _is_test_environment() -> bool:
    ...
    return os.environ.get("LOCALAGENTS_TESTING", "").lower() == "true"
