...
from localagents.events.types.event_bus_types import ExecutionPlan, Handler
...
class HandlerGraph:
    ...
    def __init__(
        ...
        Args:
            handlers: Mapping of handler -> list of `localagents.events.depends.Depends` objects
        """
        self.handlers = handlers
