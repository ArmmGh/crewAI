...
try:
    ...
    raise ImportError(
        'Anthropic native provider not available, to install: uv add "localagents[anthropic]"'
    ) from None
...
class AnthropicCompletion(BaseLLM):
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from localagents_files.uploaders.anthropic import AnthropicFileUploader
