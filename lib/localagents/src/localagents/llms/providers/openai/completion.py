...
from localagents.events.types.llm_events import LLMCallType
from localagents.llms.base_llm import BaseLLM, llm_call_context
from localagents.llms.hooks.transport import AsyncHTTPTransport, HTTPTransport
from localagents.utilities.agent_utils import is_context_length_exceeded
...
class OpenAICompletion(BaseLLM):
    ...
    def _prepare_responses_params(
        ...
        return {k: v for k, v in params.items() if k not in localagents_specific_params}
    ...
    def _convert_tools_for_responses(
        ...
        """
        from localagents.llms.providers.utils.common import safe_tool_conversion
    ...
    def _convert_tools_for_interference(
        ...
        from localagents.llms.providers.utils.common import safe_tool_conversion
        from localagents.utilities.pydantic_schema_utils import (
    ...
    def get_context_window_size(self) -> int:
        ...
        from localagents.llm import CONTEXT_WINDOW_USAGE_RATIO, LLM_CONTEXT_WINDOW_SIZES
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from localagents_files.uploaders.openai import OpenAIFileUploader
