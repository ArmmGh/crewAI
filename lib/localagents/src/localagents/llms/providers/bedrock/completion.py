...
try:
    ...
    raise ImportError(
        'AWS Bedrock native provider not available, to install: uv add "localagents[bedrock]"'
    ) from None
...
class BedrockCompletion(BaseLLM):
    ...
    async def acall(
        ...
        if not AIOBOTOCORE_AVAILABLE:
            raise NotImplementedError(
                ...
                'Install with: uv add "localagents[bedrock-async]"'
            )
    ...
    def get_context_window_size(self) -> int:
        ...
        from localagents.llm import CONTEXT_WINDOW_USAGE_RATIO
    ...
    def get_file_uploader(self) -> Any:
        ...
        Returns:
            ...
            or None if localagents_files is not installed.
        """
        try:
            import boto3
            from localagents_files.uploaders.bedrock import BedrockFileUploader
