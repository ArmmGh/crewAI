...
try:
    ...
    raise ImportError(
        'Google Gen AI native provider not available, to install: uv add "localagents[google-genai]"'
    ) from None
...
class GeminiCompletion(BaseLLM):
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from localagents_files.uploaders.gemini import GeminiFileUploader
