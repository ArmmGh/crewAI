...
try:
    from localagents_files import format_multimodal_content
...
class BaseLLM(ABC):
    ...
    def _emit_call_started_event(
        ...
        from localagents.utilities.serialization import to_serializable
    ...
    def _handle_tool_execution(
        ...
        try:
            ...
            if not hasattr(localagents_event_bus, "emit"):
                raise ValueError(
                    "localagents_event_bus does not have an emit method"
                ) from None
