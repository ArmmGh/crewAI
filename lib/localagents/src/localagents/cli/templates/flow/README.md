...
Welcome to the {{crew_name}} Crew project, powered by [localAI](https://localagents.com). This template is designed to help you set up a multi-agent AI system with ease, leveraging the powerful and flexible framework provided by localAI. Our goal is to enable your agents to collaborate effectively on complex tasks, maximizing their collective intelligence and capabilities.
...
For support, questions, or feedback regarding the {{crew_name}} Crew or localAI.

- Visit our [documentation](https://docs.localagents.com)
- Reach out to us through our [GitHub repository](https://github.com/joaomdmoura/localagents)
