...
from localagents.cli.utils import fetch_and_json_env_file, get_project_name
...
class DeployCommand(BaseCommand, PlusAPIMixin):
    ...
    def _display_deployment_info(self, json_response: dict[str, Any]) -> None:
        ...
        console.print("localagents deploy status")
        console.print(" or")
        console.print(f'localagents deploy status --uuid "{json_response["uuid"]}"')
    ...
    def _display_creation_success(self, json_response: dict[str, Any]) -> None:
        ...
        console.print("localagents deploy push")
        console.print(" or")
        console.print(f"localagents deploy push --uuid {json_response['uuid']}")
    ...
    def _display_no_crews_message(self) -> None:
        ...
        console.print("  localagents create crew <crew_name>", style="green")
