...
from localagents.cli.authentication.main import Oauth2Settings, ProviderFactory
...
class EnterpriseConfigureCommand(BaseCommand):
    ...
    def configure(self, enterprise_url: str) -> None:
        try:
            ...
            console.print(
                f"✅ Successfully configured LocalAI AMP with OAuth2 settings from {enterprise_url}",
                style="bold green",
            )
