...
from localagents.cli.command import BaseCommand
from localagents.cli.config import HIDDEN_SETTINGS_KEYS, READONLY_SETTINGS_KEYS, Settings
from localagents.events.listeners.tracing.utils import _load_user_data
...
class SettingsCommand(BaseCommand):
    ...
    def list(self) -> None:
        ...
        # LOCALAGENTS_TRACING_ENABLED environment variable
        env_tracing = os.getenv("LOCALAGENTS_TRACING_ENABLED", "")
    ...
    def reset_all_settings(self) -> None:
        ...
        self.settings.reset()
        console.print(
            "Successfully reset all configuration parameters to default values. It is recommended to run [bold yellow]'localagents login'[/bold yellow] to re-authenticate.",
            style="bold green",
        )
