...
from localagents.cli.authentication.utils import validate_jwt_token
...
if TYPE_CHECKING:
    from localagents.cli.authentication.providers.base_provider import BaseProvider
...
class ProviderFactory:
    ...
    def from_settings(
        ...
        module = importlib.import_module(
            f"localagents.cli.authentication.providers.{settings.provider.lower()}"
        )
