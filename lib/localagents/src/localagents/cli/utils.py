...
from localagents.cli.constants import ENV_VARS
from localagents.crew import Crew
from localagents.flow import Flow
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "localagents" in dep):
            raise Exception("localagents is not in the dependencies.")
...
def is_valid_tool(obj: Any) -> bool:
    from localagents.tools.base_tool import Tool
...
def _print_no_tools_warning() -> None:
    ...
    console.print(
        ...
        "[green]from localagents.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
