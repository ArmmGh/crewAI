...
def before_llm_call(
    ...
    *,
    ...
    """
    from localagents.hooks.llm_hooks import register_before_llm_call_hook
    ...
    Example:
        ...
        With agent filter::
            ...
            def log_researcher_responses(context):
                ...
                return None
    """
    from localagents.hooks.llm_hooks import register_after_llm_call_hook
...
def before_tool_call(
    ...
    *,
    ...
    """
    from localagents.hooks.tool_hooks import register_before_tool_call_hook
    ...
    Example:
        ...
        With tool filter::
            ...
            def sanitize_search_results(context):
                ...
                return None
    """
    from localagents.hooks.tool_hooks import register_after_tool_call_hook
