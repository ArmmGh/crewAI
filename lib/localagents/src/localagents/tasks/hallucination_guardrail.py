...
class HallucinationGuardrail:
    ...
    def __init__(
        ...
        self._logger.log(
            "warning",
            """Hallucination detection is a no-op in open source, use it for free at https://app.localagents.com\n""",
            color="red",
        )
    ...
    def __call__(self, task_output: TaskOutput) -> tuple[bool, Any]:
        ...
        self._logger.log(
            "warning",
            "Premium hallucination detection skipped (use for free at https://app.localagents.com)\n",
            color="red",
        )
