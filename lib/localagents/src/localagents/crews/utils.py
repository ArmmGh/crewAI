...
from localagents.utilities.file_store import store_files
...
def prepare_kickoff(
    ...
    from localagents.events.event_context import get_current_parent_id, reset_last_event_id
    from localagents.events.types.crew_events import CrewKickoffStartedEvent
    ...
    future = localagents_event_bus.emit(crew, started_event)
    ...
    crew._set_allow_localagents_trigger_context_for_first_task()
