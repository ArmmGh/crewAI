...
from localagents.agents.agent_builder.base_agent_executor_mixin import CrewAgentExecutorMixin
from localagents.agents.parser import (
    AgentAction,
    AgentFinish,
    OutputParserError,
)
from localagents.core.providers.human_input import (
...
from localagents.flow.flow import Flow, StateProxy, listen, or_, router, start
from localagents.flow.types import FlowMethodName
from localagents.hooks.llm_hooks import (
...
from localagents.utilities.constants import TRAINING_DATA_FILE
...
from localagents.utilities.step_execution_context import StepExecutionContext, StepResult
...
if TYPE_CHECKING:
    ...
    from localagents.utilities.prompts import StandardPromptResult, SystemPromptResult
...
class AgentExecutor(Flow[AgentExecutorState], CrewAgentExecutorMixin):
    ...
    def generate_plan(self) -> None:
        ...
        try:
            from localagents.utilities.reasoning_handler import AgentReasoning
