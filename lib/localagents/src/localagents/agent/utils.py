...
from localagents.knowledge.utils.knowledge_utils import extract_knowledge_context
...
def handle_reasoning(agent: Agent, task: Task) -> None:
    ...
    try:
        from localagents.utilities.reasoning_handler import (
            AgentReasoning,
...
def append_skill_context(agent: Agent, task_prompt: str) -> str:
    ...
    from localagents.skills.loader import format_skill_context
