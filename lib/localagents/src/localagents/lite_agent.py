...
from localagents.agents.agent_builder.utilities.base_token_process import TokenProcess
from localagents.agents.cache.cache_handler import CacheHandler
from localagents.agents.parser import (
    AgentAction,
    AgentFinish,
    OutputParserError,
)
...
from localagents.events.types.logging_events import AgentLogsExecutionEvent
...
from localagents.hooks.llm_hooks import get_after_llm_call_hooks, get_before_llm_call_hooks
from localagents.hooks.types import (
...
from localagents.utilities.converter import (
    Converter,
    ConverterError,
)
...
from localagents.utilities.i18n import I18N, get_i18n
...
from localagents.utilities.tool_utils import execute_tool_and_check_finality
...
def _kickoff_with_a2a_support(
    ...
    """
    from localagents.a2a.utils.response_model import get_a2a_agents_and_response_model
    from localagents.a2a.wrapper import _execute_task_with_a2a
...
class LiteAgent(FlowTrackable, BaseModel):
    ...
    def setup_a2a_support(self) -> Self:
        ...
        if self.a2a:
            from localagents.a2a.config import A2AClientConfig, A2AConfig
            from localagents.a2a.extensions.registry import (
                create_extension_registry_from_config,
            )
            from localagents.a2a.utils.agent_card import inject_a2a_server_methods
