...
from localagents.a2a.auth.client_schemes import APIKeyAuth, HTTPDigestAuth
from localagents.a2a.auth.utils import (
    _auth_store,
    configure_auth_client,
    validate_auth_against_agent_card,
)
from localagents.a2a.config import ClientTransportConfig, GRPCClientConfig
from localagents.a2a.extensions.registry import (
    ExtensionsMiddleware,
    validate_required_extensions,
)
from localagents.a2a.task_helpers import TaskStateResult
from localagents.a2a.types import (
    HANDLER_REGISTRY,
    HandlerType,
    PartsDict,
    PartsMetadataDict,
...
from localagents.a2a.updates import (
    PollingConfig,
    PushNotificationConfig,
    StreamingHandler,
    UpdateConfig,
)
from localagents.a2a.utils.agent_card import (
    _afetch_agent_card_cached,
    _get_tls_verify,
    _prepare_auth_headers,
)
from localagents.a2a.utils.content_type import (
    DEFAULT_CLIENT_OUTPUT_MODES,
    negotiate_content_types,
)
from localagents.a2a.utils.transport import (
    NegotiatedTransport,
...
if TYPE_CHECKING:
    ...
    from localagents.a2a.auth.client_schemes import ClientAuthScheme
...
def _create_file_parts(input_files: dict[str, Any] | None) -> list[Part]:
    ...
    try:
        import localagents_files  # noqa: F401
    except ImportError:
        logger.debug("localagents_files not installed, skipping file parts")
        return []
