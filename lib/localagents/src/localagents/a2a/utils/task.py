...
from localagents.a2a.utils.agent_card import _get_server_config
from localagents.a2a.utils.content_type import validate_message_parts
...
if TYPE_CHECKING:
    from localagents.a2a.extensions.server import ExtensionContext, ServerExtensionRegistry
...
def _convert_a2a_files_to_file_inputs(
    ...
    """Convert a2a file types to localagents FileInput dict.
    ...
    """
    try:
        from localagents_files import File, FileBytes
    except ImportError:
        logger.debug("localagents_files not installed, returning empty file dict")
        return {}
