...
from localagents.a2a.config import A2AServerConfig
...
def _agent_to_agent_card(agent: Agent, url: str) -> AgentCard:
    ...
    """
    from localagents.a2a.utils.agent_card_signing import sign_agent_card
    ...
    if server_config.server_extensions:
        from localagents.a2a.extensions.server import ServerExtensionRegistry
