...
from localagents.a2a.auth.server_schemes import ServerAuthScheme
from localagents.a2a.extensions.base import ValidatedA2AExtension
from localagents.a2a.types import ProtocolVersion, TransportType, Url
...
try:
    ...
    from localagents.a2a.extensions.server import ServerExtension
    from localagents.a2a.updates import UpdateConfig
except ImportError:
...
def _get_default_update_config() -> UpdateConfig:
    from localagents.a2a.updates import StreamingConfig
...
@deprecated(
    """
    `localagents.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0,
    use `localagents.a2a.config.A2AClientConfig` or `localagents.a2a.config.A2AServerConfig` instead.
    """,
