...
from localagents.a2a.extensions.base import (
    A2AExtension,
    ConversationState,
    ExtensionRegistry,
)
from localagents.a2a.task_helpers import TaskStateResult
from localagents.a2a.templates import (
...
from localagents.a2a.utils.delegation import (
...
def _get_turn_context(
    ...
    """
    console_formatter = getattr(localagents_event_bus, "_console", None)
    agent_branch = None
