...
from localagents.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
    OpenAIAgentToolAdapter,
)
from localagents.agents.agent_adapters.openai_agents.protocols import (
    AgentKwargs,
    OpenAIAgent as OpenAIAgentProtocol,
    OpenAIAgentsModule,
)
from localagents.agents.agent_adapters.openai_agents.structured_output_converter import (
