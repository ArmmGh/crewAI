...
from localagents.agents.agent_adapters.base_tool_adapter import BaseToolAdapter
...
from localagents.utilities.pydantic_schema_utils import force_additional_properties_false
