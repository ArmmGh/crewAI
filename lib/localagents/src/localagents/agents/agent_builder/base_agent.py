...
from localagents.agent.internal.meta import AgentMeta
...
from localagents.mcp.config import MCPServerConfig
...
from localagents.tools.base_tool import BaseTool, Tool
...
_SLUG_RE: Final[re.Pattern[str]] = re.compile(
    r"^(?:localagents-amp:)?[a-zA-Z0-9][a-zA-Z0-9_-]*(?:#[\w-]+)?$"
)
            ...
            if isinstance(mcp, str):
                if mcp.startswith("https://"):
                    ...
                    raise ValueError(
                        ...
                        "slug (e.g. 'notion', 'notion#search', 'localagents-amp:notion')."
                    )
