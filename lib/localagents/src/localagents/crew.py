...
if TYPE_CHECKING:
    from localagents_files import FileInput
    from opentelemetry.trace import Span

try:
    from localagents_files import get_supported_content_types

    HAS_LOCALAGENTS_FILES = True
except ImportError:
    HAS_LOCALAGENTS_FILES = False
...
from localagents.crews.crew_output import CrewOutput
from localagents.crews.utils import (
    StreamingContext,
...
from localagents.events.event_listener import EventListener
from localagents.events.listeners.tracing.trace_listener import (
...
from localagents.flow.flow_trackable import FlowTrackable
...
from localagents.memory.memory_scope import MemoryScope, MemorySlice
from localagents.memory.unified_memory import Memory
from localagents.process import Process
from localagents.rag.embeddings.types import EmbedderConfig
from localagents.rag.types import SearchResult
from localagents.security.fingerprint import Fingerprint
from localagents.security.security_config import SecurityConfig
from localagents.skills.models import Skill
from localagents.task import Task
from localagents.tasks.conditional_task import ConditionalTask
from localagents.tasks.task_output import TaskOutput
from localagents.tools.agent_tools.agent_tools import AgentTools
from localagents.tools.agent_tools.read_file_tool import ReadFileTool
from localagents.tools.base_tool import BaseTool
from localagents.types.callback import SerializableCallable
from localagents.types.streaming import CrewStreamingOutput
from localagents.types.usage_metrics import UsageMetrics
from localagents.utilities.constants import NOT_SPECIFIED, TRAINING_DATA_FILE
from localagents.utilities.crew.models import CrewContext
from localagents.utilities.env import get_env_context
from localagents.utilities.evaluators.crew_evaluator_handler import CrewEvaluator
from localagents.utilities.evaluators.task_evaluator import TaskEvaluator
from localagents.utilities.file_handler import FileHandler
from localagents.utilities.file_store import clear_files, get_all_files
from localagents.utilities.formatter import (
    aggregate_raw_outputs_from_task_outputs,
    aggregate_raw_outputs_from_tasks,
)
from localagents.utilities.i18n import get_i18n
from localagents.utilities.llm_utils import create_llm
from localagents.utilities.logger import Logger
from localagents.utilities.planning_handler import CrewPlanner
from localagents.utilities.printer import PrinterColor
from localagents.utilities.rpm_controller import RPMController
from localagents.utilities.streaming import (
    create_async_chunk_generator,
    create_chunk_generator,
    signal_end,
    signal_error,
)
from localagents.utilities.string_utils import sanitize_tool_name
from localagents.utilities.task_output_storage_handler import TaskOutputStorageHandler
from localagents.utilities.training_handler import CrewTrainingHandler
...
class Crew(FlowTrackable, BaseModel):
    ...
    def set_private_attrs(self) -> Crew:
        ...
        trace_listener.setup_listeners(localagents_event_bus)
    ...
    def create_crew_memory(self) -> Crew:
        ...
        """
        from localagents.memory.utils import sanitize_scope_name
        ...
        if self.memory is True:
            ...
            if self.embedder is not None:
                from localagents.rag.embeddings.factory import build_embedder
    ...
    def _add_memory_tools(self, tools: list[BaseTool], memory: Any) -> list[BaseTool]:
        ...
        """
        from localagents.tools.memory_tools import create_memory_tools
    ...
    def _set_allow_localagents_trigger_context_for_first_task(self) -> None:
        localagents_trigger_payload = self._inputs and self._inputs.get(
            "localagents_trigger_payload"
        )
        able_to_inject = (
            self.tasks and self.tasks[0].allow_localagents_trigger_context is None
        )

        if (
            self.process == Process.sequential
            and localagents_trigger_payload
            and able_to_inject
        ):
            self.tasks[0].allow_localagents_trigger_context = True
...
• Set LOCALAGENTS_TRACING_ENABLED=true in your project's .env file
• Run: localagents traces enable"""
        else:
            message = """Info: Tracing is disabled.
