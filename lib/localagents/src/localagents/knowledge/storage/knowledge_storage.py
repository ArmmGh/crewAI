...
from localagents.rag.chromadb.types import ChromaEmbeddingFunctionWrapper
from localagents.rag.config.utils import get_rag_client
...
from localagents.rag.embeddings.types import ProviderSpec
from localagents.rag.factory import create_client
from localagents.rag.types import BaseRecord, SearchResult
        ...
        try:
            ...
            if "dimension mismatch" in str(e).lower():
                Logger(verbose=True).log(
                    "error",
                    "Embedding dimension mismatch. This usually happens when mixing different embedding models. Try resetting the collection using `localagents reset-memories -a`",
                    "red",
                )
                raise ValueError(
                    "Embedding dimension mismatch. Make sure you're using the same embedding model "
                    "across all operations with this collection."
                    "Try resetting the collection using `localagents reset-memories -a`"
                ) from e
