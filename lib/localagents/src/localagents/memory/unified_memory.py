...
from localagents.memory.storage.backend import StorageBackend
...
from localagents.memory.utils import join_scope_paths
...
class Memory(BaseModel):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if isinstance(self.storage, str):
            if self.storage == "qdrant-edge":
                from localagents.memory.storage.qdrant_edge_storage import QdrantEdgeStorage
    ...
    _MEMORY_DOCS_URL = "https://docs.localagents.com/concepts/memory"
    ...
    def _encode_batch(
        ...
        """
        from localagents.memory.encoding_flow import EncodingFlow
    ...
    def recall(
        ...
        try:
            ...
            if depth == "shallow":
                ...
                from localagents.memory.recall_flow import RecallFlow
