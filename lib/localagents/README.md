<p align="center">
  <a href="https://github.com/localAgentsInc/localAgents">
    <img src="docs/images/localagents_logo.png" width="600px" alt="Open source Multi-AI Agent orchestration framework">
  </a>
</p>
<p align="center" style="display: flex; justify-content: center; gap: 20px; align-items: center;">
  <a href="https://trendshift.io/repositories/11239" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/11239" alt="localAgentsInc%2FlocalAgents | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
</p>

<p align="center">
  <a href="https://localagents.com">Homepage</a>
  ·
  <a href="https://docs.localagents.com">Docs</a>
  ·
  <a href="https://app.localagents.com">Start Cloud Trial</a>
  ·
  <a href="https://blog.localagents.com">Blog</a>
  ·
  <a href="https://community.localagents.com">Forum</a>
</p>

<p align="center">
  <a href="https://github.com/localAgentsInc/localAgents">
    <img src="https://img.shields.io/github/stars/localAgentsInc/localAgents" alt="GitHub Repo stars">
  </a>
  <a href="https://github.com/localAgentsInc/localAgents/network/members">
    <img src="https://img.shields.io/github/forks/localAgentsInc/localAgents" alt="GitHub forks">
  </a>
  <a href="https://github.com/localAgentsInc/localAgents/issues">
    <img src="https://img.shields.io/github/issues/localAgentsInc/localAgents" alt="GitHub issues">
  </a>
  <a href="https://github.com/localAgentsInc/localAgents/pulls">
    <img src="https://img.shields.io/github/issues-pr/localAgentsInc/localAgents" alt="GitHub pull requests">
  </a>
...
<p align="center">
  <a href="https://pypi.org/project/localagents/">
    <img src="https://img.shields.io/pypi/v/localagents" alt="PyPI version">
  </a>
  <a href="https://pypi.org/project/localagents/">
    <img src="https://img.shields.io/pypi/dm/localagents" alt="PyPI downloads">
  </a>
  <a href="https://twitter.com/localAgentsInc">
    <img src="https://img.shields.io/twitter/follow/localAgentsInc?style=social" alt="Twitter Follow">
  </a>
</p>
...
With over 100,000 developers certified through our community courses at [learn.localagents.com](https://learn.localagents.com), LocalAI is rapidly becoming the
...
You can try one part of the suite the [Crew Control Plane for free](https://app.localagents.com)
...
- [Why LocalAI?](#why-localagents)
- [Getting Started](#getting-started)
- [Key Features](#key-features)
- [Understanding Flows and Crews](#understanding-flows-and-crews)
- [LocalAI vs LangGraph](#how-localagents-compares)
- [Examples](#examples)
...
- [How LocalAI Compares](#how-localagents-compares)
...
- [Multi AI Agent Systems with LocalAI](https://www.deeplearning.ai/short-courses/multi-ai-agent-systems-with-localagents/) - Master the fundamentals of multi-agent systems
- [Practical Multi AI Agents and Advanced Use Cases](https://www.deeplearning.ai/short-courses/practical-multi-ai-agents-and-advanced-use-cases-with-localagents/) - Deep dive into advanced implementations
...
If you want to install the 'localagents' package along with its optional features that include additional tools for agents, you can do so by using the following command:

```shell
pip install 'localagents[tools]'
```
...
1. **ModuleNotFoundError: No module named 'tiktoken'**
   ...
   - Install tiktoken explicitly: `pip install 'localagents[embeddings]'`
   - If using embedchain or other tools: `pip install 'localagents[tools]'`
...
```shell
localagents create crew <project_name>
```
...
```shell
localagents create crew latest-ai-development
```
...
If an error happens due to the usage of poetry, please run the following command to update your localagents package:
...
- **Flexible & Precise**: Easily orchestrate autonomous agents through intuitive [Crews](https://docs.localagents.com/concepts/crews) or precise [Flows](https://docs.localagents.com/concepts/flows), achieving perfect balance for your needs.
...
You can test different real life examples of AI crews in the [LocalAI-examples repo](https://github.com/localAgentsInc/localAgents-examples?tab=readme-ov-file):

- [Landing Page Generator](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/landing_page_generator)
- [Having Human input on the execution](https://docs.localagents.com/how-to/Human-Input-on-Execution)
- [Trip Planner](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/trip_planner)
- [Stock Analysis](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/stock_analysis)
...
[Check out code for this example](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/job-posting) or watch a video below:

[![Jobs postings](https://img.youtube.com/vi/u98wEMz-9to/maxresdefault.jpg)](https://www.youtube.com/watch?v=u98wEMz-9to "Jobs postings")

### Trip Planner

[Check out code for this example](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/trip_planner) or watch a video below:

[![Trip Planner](https://img.youtube.com/vi/xis7rWp-hjs/maxresdefault.jpg)](https://www.youtube.com/watch?v=xis7rWp-hjs "Trip Planner")

### Stock Analysis

[Check out code for this example](https://github.com/localAgentsInc/localAgents-examples/tree/main/crews/stock_analysis) or watch a video below:
...
```python
from localagents.flow.flow import Flow, listen, start, router, or_
from localagents import Crew, Agent, Task, Process
...
Please refer to the [Connect LocalAI to LLMs](https://docs.localagents.com/how-to/LLM-Connections/) page for details on configuring your agents' connections to models.
...
_P.S. LocalAI demonstrates significant performance advantages over LangGraph, executing 5.76x faster in certain cases like this QA task example ([see comparison](https://github.com/localAgentsInc/localAgents-examples/tree/main/Notebooks/LocalAgents%20Flows%20%26%20Langgraph/QA%20Agent)) while achieving higher evaluation scores with faster completion times in certain coding tasks, like in this example ([detailed analysis](https://github.com/localAgentsInc/localAgents-examples/blob/main/Notebooks/LocalAgents%20Flows%20%26%20Langgraph/Coding%20Assistant/coding_assistant_eval.ipynb))._
...
LocalAI is released under the [MIT License](https://github.com/localAgentsInc/localAgents/blob/main/LICENSE).

## Frequently Asked Questions (FAQ)

### General

- [What exactly is LocalAI?](#q-what-exactly-is-localagents)
- [How do I install LocalAI?](#q-how-do-i-install-localagents)
- [Does LocalAI depend on LangChain?](#q-does-localagents-depend-on-langchain)
- [Is LocalAI open-source?](#q-is-localagents-open-source)
- [Does LocalAI collect data from users?](#q-does-localagents-collect-data-from-users)

### Features and Capabilities

- [Can LocalAI handle complex use cases?](#q-can-localagents-handle-complex-use-cases)
- [Can I use LocalAI with local AI models?](#q-can-i-use-localagents-with-local-ai-models)
- [What makes Crews different from Flows?](#q-what-makes-crews-different-from-flows)
- [How is LocalAI better than LangChain?](#q-how-is-localagents-better-than-langchain)
- [Does LocalAI support fine-tuning or training custom models?](#q-does-localagents-support-fine-tuning-or-training-custom-models)

### Resources and Community

- [Where can I find real-world LocalAI examples?](#q-where-can-i-find-real-world-localagents-examples)
- [How can I contribute to LocalAI?](#q-how-can-i-contribute-to-localagents)

### Enterprise Features

- [What additional features does LocalAI AMP offer?](#q-what-additional-features-does-localagents-enterprise-offer)
- [Is LocalAI AMP available for cloud and on-premise deployments?](#q-is-localagents-enterprise-available-for-cloud-and-on-premise-deployments)
- [Can I try LocalAI AMP for free?](#q-can-i-try-localagents-enterprise-for-free)
...
A: Absolutely! LocalAI supports various language models, including local ones. Tools like Ollama and LM Studio allow seamless integration. Check the [LLM Connections documentation](https://docs.localagents.com/how-to/LLM-Connections/) for more details.
...
A: Check out practical examples in the [LocalAI-examples repository](https://github.com/localAgentsInc/localAgents-examples), covering use cases like trip planners, stock analysis, and job postings.
...
A: Yes, you can explore part of the LocalAI AMP Suite by accessing the [Crew Control Plane](https://app.localagents.com) for free.
...
A: Yes, LocalAI provides extensive beginner-friendly tutorials, courses, and documentation through learn.localagents.com, supporting developers at all skill levels.
