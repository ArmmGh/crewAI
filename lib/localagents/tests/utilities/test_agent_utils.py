...
class TestParallelSummarization:
    ...
    @patch("localagents.utilities.agent_utils.is_inside_event_loop", return_value=True)
...
class TestParallelSummarizationVCR:
    ...
    To record cassettes:
        PYTEST_VCR_RECORD_MODE=all uv run pytest lib/localagents/tests/utilities/test_agent_utils.py::TestParallelSummarizationVCR -v
    """
