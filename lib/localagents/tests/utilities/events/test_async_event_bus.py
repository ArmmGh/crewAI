...
async def test_async_handler_execution():
    ...
    with localagents_event_bus.scoped_handlers():
        ...
        @localagents_event_bus.on(AsyncTestEvent)
...
async def test_async_handler_registration_via_register_handler():
    ...
    with localagents_event_bus.scoped_handlers():
        ...
        localagents_event_bus.register_handler(AsyncTestEvent, custom_async_handler)
...
async def test_scoped_handlers_with_async():
    ...
    with localagents_event_bus.scoped_handlers():
        ...
        with localagents_event_bus.scoped_handlers():
            ...
            await localagents_event_bus.aemit("test_source", event1)
        ...
        await localagents_event_bus.aemit("test_source", event2)
