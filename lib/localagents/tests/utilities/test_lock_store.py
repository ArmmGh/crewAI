...
import localagents.utilities.lock_store as lock_store
from localagents.utilities.lock_store import lock
...
def test_uses_file_lock_when_redis_unavailable():
    ...
    assert "localagents:" in mock_lock.call_args.args[0]
...
def test_uses_redis_lock_when_redis_available(monkeypatch):
    ...
    assert kwargs["channel"].startswith("localagents:")
