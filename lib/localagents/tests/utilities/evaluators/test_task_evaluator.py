...
from localagents.utilities.converter import ConverterError
from localagents.utilities.evaluators.task_evaluator import (
    TaskEvaluator,
    TrainingTaskEvaluation,
)


@patch("localagents.utilities.evaluators.task_evaluator.TrainingConverter")
...
@patch("localagents.utilities.converter.Converter.to_pydantic")
@patch("localagents.utilities.training_converter.TrainingConverter._convert_field_by_field")
