...
from localagents.utilities.evaluators.crew_evaluator_handler import (
    CrewEvaluator,
...
class InternalCrewEvaluator:
    ...
    @mock.patch("localagents.utilities.evaluators.crew_evaluator_handler.Console")
    @mock.patch("localagents.utilities.evaluators.crew_evaluator_handler.Table")
