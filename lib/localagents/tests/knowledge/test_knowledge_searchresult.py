...
import pytest
from localagents.knowledge.knowledge import Knowledge  # type: ignore[import-untyped]
from localagents.knowledge.source.string_knowledge_source import (  # type: ignore[import-untyped]
    StringKnowledgeSource,
)
from localagents.knowledge.utils.knowledge_utils import (  # type: ignore[import-untyped]
...
def test_knowledge_query_returns_searchresult() -> None:
    ...
    with patch("localagents.knowledge.knowledge.KnowledgeStorage") as mock_storage_class:
...
@patch("localagents.rag.config.utils.get_rag_client")
@patch("localagents.knowledge.storage.knowledge_storage.KnowledgeStorage")
