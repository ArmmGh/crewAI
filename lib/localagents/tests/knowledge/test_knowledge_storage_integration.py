...
import pytest
from localagents.knowledge.storage.knowledge_storage import (  # type: ignore[import-untyped]
    KnowledgeStorage,
)


@patch("localagents.knowledge.storage.knowledge_storage.get_rag_client")
@patch("localagents.knowledge.storage.knowledge_storage.create_client")
@patch("localagents.knowledge.storage.knowledge_storage.build_embedder")
