...
from localagents.hooks import clear_all_llm_call_hooks, unregister_after_llm_call_hook, unregister_before_llm_call_hook
import pytest
...
def clear_hooks():
    ...
    from localagents.hooks import llm_hooks
