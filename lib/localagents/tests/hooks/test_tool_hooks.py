...
from localagents.hooks import clear_all_tool_call_hooks, unregister_after_tool_call_hook, unregister_before_tool_call_hook
import pytest
...
def clear_hooks():
    ...
    from localagents.hooks import tool_hooks
