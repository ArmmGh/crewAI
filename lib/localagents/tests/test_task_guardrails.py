...
from localagents import Agent, Task
...
from localagents.tasks.hallucination_guardrail import HallucinationGuardrail
...
def test_guardrail_emits_events(sample_agent):
    ...
    localagents_event_bus.flush(timeout=10.0)
