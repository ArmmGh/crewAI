...
from localagents.flow import Flow, human_feedback, listen, start
...
class TestHumanFeedbackLearn:
    ...
    def test_learn_true_stores_distilled_lessons(self):
        ...
        with (
            ...
            patch("localagents.llm.LLM") as MockLLM,
        ):
            from localagents.flow.human_feedback import DistilledLessons
    ...
    def test_learn_true_pre_reviews_with_past_lessons(self):
        ...
        from localagents.memory.types import MemoryMatch, MemoryRecord
        ...
        with (
            ...
            from localagents.flow.human_feedback import DistilledLessons, PreReviewResult
