...
from localagents.agents import CacheHandler
...
from localagents.flow import Flow, start
...
from localagents.project import CrewBase, agent, before_kickoff, crew, task
...
from localagents.tools import BaseTool, tool
...
def test_replay_with_context():
    ...
    with patch(
        "localagents.utilities.task_output_storage_handler.TaskOutputStorageHandler.load",
        return_value=[
            {
...
def test_replay_with_context_set_to_nullable():
    ...
    with patch("localagents.task.Task.execute_sync") as mock_execute_task:
        mock_execute_task.return_value = TaskOutput(
            description="Test Task Output",
            raw="test raw output",
            agent="test_agent",
