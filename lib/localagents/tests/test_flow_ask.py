...
from localagents.flow import Flow, flow_config, listen, start
from localagents.flow.async_feedback.providers import ConsoleProvider
from localagents.flow.flow import FlowState
...
class TestAskEvents:
    ...
    def test_ask_emits_input_requested_event(self) -> None:
        ...
        from localagents.events.types.flow_events import FlowInputRequestedEvent
        ...
        original_emit = localagents_event_bus.emit
        ...
        with patch.object(localagents_event_bus, "emit", side_effect=capture_emit):
            flow.kickoff()
    ...
    def test_ask_emits_input_received_event(self) -> None:
        ...
        from localagents.events.event_bus import localagents_event_bus
        from localagents.events.types.flow_events import FlowInputReceivedEvent
...
class TestAskIntegration:
    ...
    def test_ask_and_human_feedback_coexist(self) -> None:
        ...
        from localagents.flow import human_feedback
