...
from localagents.memory.utils import (
    join_scope_paths,
...
class TestMemoryRootScope:
    ...
    def test_memory_root_scope_with_llm_inferred_scope(
        ...
        from localagents.memory.analyze import ExtractedMetadata, MemoryAnalysis
        from localagents.memory.unified_memory import Memory
...
class TestAgentScopeExtension:
    ...
    def test_agent_save_extends_crew_root_scope(self) -> None:
        ...
        from localagents.agents.agent_builder.base_agent_executor_mixin import (
...
class TestEncodingFlowRootScope:
    ...
    def test_encoding_flow_fast_path_with_root_scope(
        ...
        from localagents.memory.encoding_flow import ItemState
...
class TestConsolidationIsolation:
    ...
    def test_consolidation_search_constrained_to_root_scope(
        ...
        from localagents.memory.encoding_flow import EncodingFlow, ItemState
        from localagents.memory.types import MemoryConfig
