...
from localagents.experimental.evaluation.base_evaluator import EvaluationScore
...
from localagents.utilities.llm_utils import LLM


class TestSemanticQualityEvaluator(BaseEvaluationMetricsTest):
    @patch("localagents.utilities.llm_utils.create_llm")
