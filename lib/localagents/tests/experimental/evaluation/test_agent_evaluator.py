...
from localagents.experimental.evaluation.agent_evaluator import AgentEvaluator
...
class TestAgentEvaluator:
    ...
    def test_evaluate_current_iteration(self, mock_crew):
        with localagents_event_bus.scoped_handlers():
            ...
            @localagents_event_bus.on(AgentEvaluationCompletedEvent)
    ...
    def test_eval_specific_agents_from_crew(self, mock_crew):
        with localagents_event_bus.scoped_handlers():
            ...
            @localagents_event_bus.on(AgentEvaluationStartedEvent)
            ...
            @localagents_event_bus.on(AgentEvaluationFailedEvent)
