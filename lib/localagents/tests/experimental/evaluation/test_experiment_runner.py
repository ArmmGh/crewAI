...
from localagents.experimental.evaluation.evaluation_display import (
    AgentAggregatedEvaluationResult,
)
from localagents.experimental.evaluation.experiment.result import ExperimentResults
from localagents.experimental.evaluation.experiment.runner import ExperimentRunner
...
class TestExperimentRunner:
    ...
    @patch("localagents.experimental.evaluation.experiment.runner.create_default_evaluator")
