...
from localagents.llms.providers.openai.completion import OpenAICompletion, ResponsesAPIResult
...
def test_openai_completion_module_is_imported():
    ...
    """
    module_name = "localagents.llms.providers.openai.completion"
...
def test_openai_raises_error_when_model_not_supported():
    ...
    with patch('localagents.llms.providers.openai.completion.OpenAI') as mock_openai_class:
