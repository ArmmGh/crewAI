...
def test_gemini_completion_module_is_imported():
    ...
    """
    module_name = "localagents.llms.providers.gemini.completion"
...
def test_gemini_raises_error_when_model_not_supported():
    ...
    with patch('localagents.llms.providers.gemini.completion.genai') as mock_genai:
...
def test_gemini_tool_conversion():
    ...
    gemini_tools = llm._convert_tools_for_interference(localagents_tools)
