...
def mock_aws_credentials():
    ...
    with patch.dict(os.environ, {
        ...
        with patch('localagents.llms.providers.bedrock.completion.Session') as mock_session_class:
            mock_session_instance = MagicMock()
            mock_client = MagicMock()
...
def test_bedrock_completion_module_is_imported():
    ...
    """
    module_name = "localagents.llms.providers.bedrock.completion"
...
def test_bedrock_tool_conversion():
    ...
    bedrock_tools = llm._format_tools_for_converse(localagents_tools)
