...
TEST_FIXTURES_DIR = Path(__file__).parent.parent.parent.parent / "localagents-files" / "tests" / "fixtures"
...
def _build_responses_message_with_upload(
    ...
    Returns:
        ...
        to verify file_id was used.
    """
    from localagents_files.formatting import OpenAIResponsesFormatter
