...
def test_flow_trigger_payload_injection():
    ...
    class TriggerFlow(Flow):
        @start()
        def start_method(self, localagents_trigger_payload=None):
            captured_payload.append(localagents_trigger_payload)
            return "started"
    ...
    flow.kickoff(inputs={"localagents_trigger_payload": test_payload})
...
def test_flow_trigger_payload_injection_multiple_starts():
    ...
    class MultiStartFlow(Flow):
        @start()
        def start_method_1(self, localagents_trigger_payload=None):
            captured_payloads.append(("start_1", localagents_trigger_payload))
            return "start_1_done"

        @start()
        def start_method_2(self, localagents_trigger_payload=None):
            captured_payloads.append(("start_2", localagents_trigger_payload))
            return "start_2_done"
...
def test_flow_trigger_payload_with_structured_state():
    ...
    class StructuredFlow(Flow[TriggerState]):
        @start()
        def start_method(self, localagents_trigger_payload=None):
            return localagents_trigger_payload

    flow = StructuredFlow()

    test_payload = "Structured state trigger data"
    result = flow.kickoff(inputs={"localagents_trigger_payload": test_payload})
...
def test_flow_start_method_without_trigger_parameter():
    ...
    result = flow.kickoff(inputs={"localagents_trigger_payload": "some data"})
...
def test_async_flow_with_trigger_payload():
    ...
    class AsyncTriggerFlow(Flow):
        @start()
        async def async_start_method(self, localagents_trigger_payload=None):
            captured_payload.append(localagents_trigger_payload)
    ...
    result = asyncio.run(
        flow.kickoff_async(inputs={"localagents_trigger_payload": test_payload})
    )
...
def test_flow_plotting():
    ...
    @localagents_event_bus.on(FlowPlotEvent)
