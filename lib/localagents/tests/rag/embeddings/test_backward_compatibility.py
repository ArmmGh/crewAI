...
from localagents.rag.embeddings.factory import build_embedder, PROVIDER_PATHS
from localagents.rag.embeddings.providers.openai.openai_provider import OpenAIProvider
from localagents.rag.embeddings.providers.cohere.cohere_provider import CohereProvider
from localagents.rag.embeddings.providers.google.generative_ai import GenerativeAiProvider
from localagents.rag.embeddings.providers.google.vertex import VertexAIProvider
from localagents.rag.embeddings.providers.microsoft.azure import AzureProvider
from localagents.rag.embeddings.providers.jina.jina_provider import JinaProvider
from localagents.rag.embeddings.providers.ollama.ollama_provider import OllamaProvider
from localagents.rag.embeddings.providers.aws.bedrock import BedrockProvider
from localagents.rag.embeddings.providers.text2vec.text2vec_provider import Text2VecProvider
from localagents.rag.embeddings.providers.sentence_transformer.sentence_transformer_provider import (
    SentenceTransformerProvider,
)
from localagents.rag.embeddings.providers.instructor.instructor_provider import InstructorProvider
from localagents.rag.embeddings.providers.openclip.openclip_provider import OpenCLIPProvider
...
class TestFactoryBackwardCompatibility:
    ...
    def test_factory_with_google_alias(self):
        ...
        with patch("localagents.rag.embeddings.factory.import_and_validate_definition") as mock_import:
            ...
            mock_import.assert_called_once_with(
                "localagents.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider"
            )
