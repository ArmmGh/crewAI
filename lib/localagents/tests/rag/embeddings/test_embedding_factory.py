...
class TestEmbeddingFactory:
    ...
    @patch("localagents.rag.embeddings.factory.import_and_validate_definition")
    def test_build_embedder_openai(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.openai.openai_provider.OpenAIProvider"
        )
    ...
    def test_build_embedder_azure(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.microsoft.azure.AzureProvider"
        )
    ...
    def test_build_embedder_ollama(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.ollama.ollama_provider.OllamaProvider"
        )
    ...
    def test_build_embedder_huggingface(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.huggingface.huggingface_provider.HuggingFaceProvider"
        )
        mock_provider_class.assert_called_once()
    ...
    def test_build_embedder_cohere(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.cohere.cohere_provider.CohereProvider"
        )
    ...
    def test_build_embedder_voyageai(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.voyageai.voyageai_provider.VoyageAIProvider"
        )
    ...
    def test_build_embedder_watsonx(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.ibm.watsonx.WatsonXProvider"
        )
    ...
    def test_build_embedder_custom_provider(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.custom.custom_provider.CustomProvider"
        )
    ...
    @patch("localagents.rag.embeddings.factory.import_and_validate_definition")
    @patch("localagents.rag.embeddings.factory.build_embedder_from_provider")
    ...
    def test_build_embedder_google_vertex_with_genai_model(self, mock_import):
        ...
        mock_import.assert_called_once_with(
            "localagents.rag.embeddings.providers.google.vertex.VertexAIProvider"
        )
        mock_provider_class.assert_called_once()
