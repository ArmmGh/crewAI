...
from localagents import Agent, Crew, Task, LLM
...
def enable_telemetry_for_tests():
    ...
    original_telemetry = os.environ.get("LOCALAGENTS_DISABLE_TELEMETRY")
    original_otel = os.environ.get("OTEL_SDK_DISABLED")

    os.environ["LOCALAGENTS_DISABLE_TELEMETRY"] = "false"
    ...
    if original_telemetry is not None:
        os.environ["LOCALAGENTS_DISABLE_TELEMETRY"] = original_telemetry
    else:
        os.environ.pop("LOCALAGENTS_DISABLE_TELEMETRY", None)
