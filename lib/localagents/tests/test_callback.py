"""Tests for localagents.types.callback — SerializableCallable round-tripping."""
...
from localagents.types.callback import (
...
class TestStringToCallable:
    ...
    def test_string_refused_without_env_var(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.delenv("LOCALAGENTS_DESERIALIZE_CALLBACKS", raising=False)
    ...
    def test_string_resolves_with_env_var(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("LOCALAGENTS_DESERIALIZE_CALLBACKS", "1")
