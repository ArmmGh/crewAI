...
from localagents.agents.step_executor import StepExecutor
from localagents.agents.planner_observer import PlannerObserver
from localagents.experimental.agent_executor import (
    AgentExecutorState,
    AgentExecutor,
)
from localagents.agents.parser import AgentAction, AgentFinish
...
from localagents.utilities.step_execution_context import StepExecutionContext
from localagents.utilities.planning_types import TodoItem
...
class TestAgentExecutor:
    ...
    async def test_invoke_step_callback_async_inside_running_loop(
        ...
        answer = AgentFinish(thought="thinking", output="test", text="final")
        with patch("localagents.experimental.agent_executor.asyncio.run") as mock_run:
            executor._invoke_step_callback(answer)
...
class TestStepExecutorCriticalFixes:
    ...
    def test_step_executor_text_tool_emits_usage_events(self, step_executor):
        ...
        with patch(
            "localagents.agents.step_executor.execute_tool_and_check_finality",
    ...
    @patch("localagents.experimental.agent_executor.handle_output_parser_exception")
    def test_recover_from_parser_error(
        self, mock_handle_exception, mock_dependencies
    ):
        """Test recovery from OutputParserError."""
        from localagents.agents.parser import OutputParserError
    ...
    @patch("localagents.experimental.agent_executor.handle_context_length")
...
class TestFlowErrorHandling:
    ...
    @patch("localagents.experimental.agent_executor.get_llm_response")
    @patch("localagents.experimental.agent_executor.enforce_rpm_limit")
    ...
    @patch("localagents.experimental.agent_executor.get_llm_response")
    @patch("localagents.experimental.agent_executor.enforce_rpm_limit")
    @patch("localagents.experimental.agent_executor.is_context_length_exceeded")
...
class TestNativeToolExecution:
    ...
    def test_check_native_todo_completion_requires_current_todo(
        ...
        from localagents.utilities.planning_types import TodoList
...
class TestAgentExecutorPlanning:
    ...
    def test_agent_kickoff_with_planning_stores_plan_in_state(self):
        ...
        from localagents import Agent, PlanningConfig
...
class TestResponseFormatWithKickoff:
    ...
    def test_kickoff_response_format_with_planning_and_tools(self):
        ...
        from localagents import Agent, PlanningConfig
        from localagents.llm import LLM
        from localagents_tools import EXASearchTool
...
class TestReasoningEffort:
    ...
    def test_reasoning_effort_medium_replans_on_failure(self):
        ...
        """
        from localagents.experimental.agent_executor import AgentExecutor
        from localagents.utilities.planning_types import (
            StepObservation,
            TodoItem,
            TodoList,
        )
    ...
    def test_reasoning_effort_low_marks_complete_without_deciding(self):
        ...
        """
        from localagents.experimental.agent_executor import AgentExecutor
        from localagents.utilities.planning_types import TodoItem, TodoList
...
class TestObserverResponseParsing:
    ...
    def test_parse_step_observation_instance(self):
        ...
        from localagents.agents.planner_observer import PlannerObserver
        from localagents.utilities.planning_types import StepObservation
    ...
    def test_observe_parses_json_string_from_llm(self):
        ...
        from localagents.agents.planner_observer import PlannerObserver
        from localagents.utilities.planning_types import StepObservation, TodoItem
...
class TestVisionImageFormatContract:
    ...
    def test_anthropic_provider_has_image_block_converter(self):
        from localagents.llms.providers.anthropic.completion import AnthropicCompletion
