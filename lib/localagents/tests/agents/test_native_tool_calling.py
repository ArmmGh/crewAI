...
from localagents.events import localagents_event_bus
from localagents.hooks import register_after_tool_call_hook, register_before_tool_call_hook
from localagents.hooks.tool_hooks import ToolCallHookContext
...
def test_native_tool_calling_error_handling(failing_tool: FailingTool):
    ...
    import threading
    from localagents.events import localagents_event_bus
    from localagents.events.types.tool_usage_events import ToolUsageErrorEvent
...
class TestNativeToolCallingJsonParseError:
    ...
    def _make_executor(self, tools: list[BaseTool]) -> "CrewAgentExecutor":
        ...
        from localagents.tools.base_tool import to_langchain
    ...
    def test_malformed_json_returns_parse_error(self) -> None:
        ...
        from localagents.utilities.agent_utils import convert_tools_to_openai_schema
