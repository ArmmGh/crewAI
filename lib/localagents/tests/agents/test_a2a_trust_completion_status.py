...
from localagents.a2a.config import A2AConfig
...
def test_trust_remote_completion_status_true_returns_directly():
    ...
    from localagents.a2a.wrapper import _delegate_to_a2a
    ...
    with (
        patch("localagents.a2a.wrapper.execute_a2a_delegation") as mock_execute,
        patch("localagents.a2a.wrapper._fetch_agent_cards_concurrently") as mock_fetch,
    ):
