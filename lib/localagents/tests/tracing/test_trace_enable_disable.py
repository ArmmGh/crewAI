...
class TestTraceEnableDisable:
    ...
    def test_no_http_calls_when_disabled_via_env(self):
        """Test execution when tracing disabled via LOCALAGENTS_TRACING_ENABLED=false."""
        with pytest.MonkeyPatch.context() as mp:
            mp.setenv("LOCALAGENTS_TRACING_ENABLED", "false")
            mp.setenv("LOCALAGENTS_DISABLE_TELEMETRY", "false")
    ...
    def test_trace_calls_when_enabled_via_env(self):
        """Test execution when tracing enabled via LOCALAGENTS_TRACING_ENABLED=true."""
        with pytest.MonkeyPatch.context() as mp:
            mp.setenv("LOCALAGENTS_TRACING_ENABLED", "true")
            mp.setenv("LOCALAGENTS_DISABLE_TELEMETRY", "false")
