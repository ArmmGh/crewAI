...
from localagents.events.types.llm_events import LLMStreamChunkEvent, ToolCall, FunctionCall
...
class TestStreamingImports:
    ...
    def test_streaming_types_importable_from_types_module(self) -> None:
        """Test that streaming types can be imported from localagents.types.streaming."""
        from localagents.types.streaming import (
            CrewStreamingOutput,
            FlowStreamingOutput,
            StreamChunk,
