...
from localagents.cli.create_crew import create_crew, create_folder_structure
...
@mock.patch("localagents.cli.create_crew.copy_template")
@mock.patch("localagents.cli.create_crew.write_env_file")
@mock.patch("localagents.cli.create_crew.load_env_vars")
def test_create_crew_with_trailing_slash_creates_valid_project(
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        with mock.patch(
            "localagents.cli.create_crew.create_folder_structure"
...
@mock.patch("localagents.cli.create_crew.create_folder_structure")
@mock.patch("localagents.cli.create_crew.copy_template")
@mock.patch("localagents.cli.create_crew.load_env_vars")
@mock.patch("localagents.cli.create_crew.get_provider_data")
@mock.patch("localagents.cli.create_crew.select_provider")
@mock.patch("localagents.cli.create_crew.select_model")
