...
from localagents.cli.cli import (
    deploy_create,
    deploy_list,
    deploy_logs,
    deploy_push,
...
@mock.patch("localagents.cli.cli.train_crew")
...
def mock_get_crews(mock_crew):
    with mock.patch(
        "localagents.cli.reset_memories_command.get_crews", return_value=[mock_crew]
    ) as mock_get_crew, mock.patch(
        "localagents.cli.reset_memories_command.get_flows", return_value=[]
    ):
        yield mock_get_crew
...
def mock_get_flows(mock_flow):
    with mock.patch(
        "localagents.cli.reset_memories_command.get_flows", return_value=[mock_flow]
    ) as mock_get_flow, mock.patch(
        "localagents.cli.reset_memories_command.get_crews", return_value=[]
    ):
        yield mock_get_flow
...
@mock.patch("localagents.cli.cli.evaluate_crew")
...
@mock.patch("localagents.cli.cli.AuthenticationCommand")
...
@mock.patch("localagents.cli.cli.DeployCommand")
...
@mock.patch("localagents.cli.add_crew_to_flow.create_embedded_crew")
