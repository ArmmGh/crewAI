...
@patch("localagents.cli.tools.main.subprocess.run")
...
@patch("localagents.cli.tools.main.subprocess.run")
@patch("localagents.cli.plus_api.PlusAPI.get_tool")
@patch("localagents.cli.tools.main.ToolCommand._print_current_organization")
...
@patch("localagents.cli.tools.main.git.Repository.is_synced", return_value=False)
...
@patch("localagents.cli.tools.main.get_project_name", return_value="sample-tool")
@patch("localagents.cli.tools.main.get_project_version", return_value="1.0.0")
@patch("localagents.cli.tools.main.get_project_description", return_value="A sample tool")
@patch("localagents.cli.tools.main.subprocess.run")
@patch("localagents.cli.tools.main.os.listdir", return_value=["sample-tool-1.0.0.tar.gz"])
@patch(
    "localagents.cli.tools.main.open",
    new_callable=unittest.mock.mock_open,
    read_data=b"sample tarball content",
)
@patch("localagents.cli.plus_api.PlusAPI.publish_tool")
@patch("localagents.cli.tools.main.git.Repository.is_synced", return_value=False)
@patch(
    "localagents.cli.tools.main.extract_available_exports",
...
@patch("localagents.cli.plus_api.PlusAPI.publish_tool")
@patch("localagents.cli.tools.main.git.Repository.is_synced", return_value=True)
@patch(
    "localagents.cli.tools.main.extract_available_exports",
    return_value=[{"name": "SampleTool"}],
)
...
@patch("localagents.cli.tools.main.Settings")
