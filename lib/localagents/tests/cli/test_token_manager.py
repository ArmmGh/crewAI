...
class TestTokenManager(unittest.TestCase):
    ...
    @patch("localagents.cli.shared.token_manager.TokenManager._get_or_create_key")
    def setUp(self, mock_get_key: unittest.mock.MagicMock) -> None:
        """Set up test fixtures."""
        mock_get_key.return_value = Fernet.generate_key()
        self.token_manager = TokenManager()

    @patch("localagents.cli.shared.token_manager.TokenManager._read_secure_file")
    @patch("localagents.cli.shared.token_manager.TokenManager._get_or_create_key")
    ...
    def test_get_or_create_key_new(self) -> None:
        ...
        with (
            ...
            patch("localagents.cli.shared.token_manager.Fernet.generate_key", return_value=mock_key) as mock_generate,
        ):
    ...
    def test_get_or_create_key_race_condition(self) -> None:
        ...
        with (
            ...
            patch("localagents.cli.shared.token_manager.Fernet.generate_key", return_value=our_key),
        ):
            result = self.token_manager._get_or_create_key()
    ...
    @patch("localagents.cli.shared.token_manager.TokenManager._atomic_write_secure_file")
    ...
    @patch("localagents.cli.shared.token_manager.TokenManager._delete_secure_file")
