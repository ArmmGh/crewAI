...
from localagents import __version__
from localagents.cli.version import (
    _find_latest_non_yanked_version,
    _get_cache_file,
    _is_cache_valid,
    _is_version_yanked,
    get_localagents_version,
...
def test_dynamic_versioning_consistency() -> None:
    ...
    cli_version = get_localagents_version()
...
class TestVersionChecking:
    ...
    def test_get_localagents_version(self) -> None:
        """Test getting current localagents version."""
        version = get_localagents_version()
    ...
    @patch("localagents.cli.version.Path.exists")
    @patch("localagents.cli.version.request.urlopen")
    ...
    @patch("localagents.cli.version.get_localagents_version")
    @patch("localagents.cli.version.get_latest_version_from_pypi")
...
class TestIsCurrentVersionYanked:
    ...
    @patch("localagents.cli.version.get_localagents_version")
    @patch("localagents.cli.version._get_cache_file")
...
class TestConsoleFormatterVersionCheck:
    ...
    @patch("localagents.events.utils.console_formatter.is_current_version_yanked")
    @patch("localagents.events.utils.console_formatter.is_newer_version_available")
