...
from localagents.cli.plus_api import PlusAPI
...
class TestPlusAPI(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue("LocalAI-CLI/" in self.api.headers["User-Agent"])
        self.assertTrue(self.api.headers["X-Localagents-Version"])

    @patch("localagents.cli.plus_api.PlusAPI._make_request")
    def test_login_to_tool_repository(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/tools/login", json={}
        )
    ...
    def test_login_to_tool_repository_with_user_identifier(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/tools/login", json={"user_identifier": "test-hash-123"}
        )
        self.assertEqual(response, mock_response)
    ...
    def assert_request_with_org_id(
        ...
        mock_client_instance.request.assert_called_once_with(
            method,
            f"{os.getenv('LOCALAGENTS_PLUS_URL')}{endpoint}",
            headers={
                "Authorization": ANY,
                "Content-Type": ANY,
                "User-Agent": ANY,
                "X-Localagents-Version": ANY,
                "X-Localagents-Organization-Id": self.org_uuid,
            },
            **kwargs,
        )

    @patch("localagents.cli.plus_api.Settings")
    @patch("localagents.cli.plus_api.httpx.Client")
    def test_login_to_tool_repository_with_org_uuid(
        self, mock_client_class, mock_settings_class
    ):
        mock_settings = MagicMock()
        mock_settings.org_uuid = self.org_uuid
        mock_settings.enterprise_base_url = os.getenv('LOCALAGENTS_PLUS_URL')
        ...
        self.assert_request_with_org_id(
            mock_client_instance, "POST", "/localagents_plus/api/v1/tools/login", json={}
        )
        self.assertEqual(response, mock_response)
    ...
    def test_get_tool(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "GET", "/localagents_plus/api/v1/tools/test_tool_handle"
        )
        self.assertEqual(response, mock_response)
    ...
    def test_get_tool_with_org_uuid(self, mock_client_class, mock_settings_class):
        ...
        self.assert_request_with_org_id(
            mock_client_instance, "GET", "/localagents_plus/api/v1/tools/test_tool_handle"
        )
        self.assertEqual(response, mock_response)
    ...
    def test_publish_tool(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/tools", json=params
        )
        self.assertEqual(response, mock_response)
    ...
    def test_publish_tool_with_org_uuid(self, mock_client_class, mock_settings_class):
        ...
        self.assert_request_with_org_id(
            mock_client_instance, "POST", "/localagents_plus/api/v1/tools", json=expected_params
        )
        self.assertEqual(response, mock_response)
    ...
    def test_deploy_by_name(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/crews/by-name/test_project/deploy"
        )
    ...
    def test_deploy_by_uuid(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/crews/test_uuid/deploy"
        )
    ...
    def test_crew_status_by_name(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "GET", "/localagents_plus/api/v1/crews/by-name/test_project/status"
        )
    ...
    def test_crew_status_by_uuid(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "GET", "/localagents_plus/api/v1/crews/test_uuid/status"
        )
    ...
    def test_crew_by_name(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "GET", "/localagents_plus/api/v1/crews/by-name/test_project/logs/deployment"
        )

        self.api.crew_by_name("test_project", "custom_log")
        mock_make_request.assert_called_with(
            "GET", "/localagents_plus/api/v1/crews/by-name/test_project/logs/custom_log"
        )
    ...
    def test_crew_by_uuid(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "GET", "/localagents_plus/api/v1/crews/test_uuid/logs/deployment"
        )

        self.api.crew_by_uuid("test_uuid", "custom_log")
        mock_make_request.assert_called_with(
            "GET", "/localagents_plus/api/v1/crews/test_uuid/logs/custom_log"
        )
    ...
    def test_delete_crew_by_name(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "DELETE", "/localagents_plus/api/v1/crews/by-name/test_project"
        )
    ...
    def test_delete_crew_by_uuid(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "DELETE", "/localagents_plus/api/v1/crews/test_uuid"
        )

    @patch("localagents.cli.plus_api.PlusAPI._make_request")
    def test_list_crews(self, mock_make_request):
        self.api.list_crews()
        mock_make_request.assert_called_once_with("GET", "/localagents_plus/api/v1/crews")
    ...
    def test_create_crew(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with(
            "POST", "/localagents_plus/api/v1/crews", json=payload
        )

    @patch("localagents.cli.plus_api.Settings")
    @patch.dict(os.environ, {"LOCALAGENTS_PLUS_URL": ""})
    ...
    @patch.dict(os.environ, {"LOCALAGENTS_PLUS_URL": "https://custom-url-from-env.com"})
...
async def test_get_agent(mock_async_client_class):
    ...
    mock_client_instance.get.assert_called_once_with(
        f"{api.base_url}/localagents_plus/api/v1/agents/test_agent_handle",
        headers=api.headers,
    )
...
async def test_get_agent_with_org_uuid(mock_settings_class, mock_async_client_class):
    ...
    assert "X-Localagents-Organization-Id" in api.headers
    assert api.headers["X-Localagents-Organization-Id"] == org_uuid
    assert response == mock_response
