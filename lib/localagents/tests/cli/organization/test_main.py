...
from localagents.cli.cli import org_list, switch, current
...
@pytest.fixture
def mock_settings():
    with patch("localagents.cli.organization.main.Settings") as mock_settings_class:
        mock_settings_instance = MagicMock()
        mock_settings_class.return_value = mock_settings_instance
        yield mock_settings_instance


@patch("localagents.cli.cli.OrganizationCommand")
...
class TestOrganizationCommand(unittest.TestCase):
    ...
    @patch("localagents.cli.organization.main.console")
    @patch("localagents.cli.organization.main.Table")
    ...
    @patch("localagents.cli.organization.main.console")
    @patch("localagents.cli.organization.main.Settings")
    ...
    def test_list_organizations_unauthorized(self, mock_console):
        ...
        self.org_command.plus_api_client.get_organizations.assert_called_once()
        mock_console.print.assert_called_once_with(
            "You are not logged in to any organization. Use 'localagents login' to login.",
            style="bold red",
        )
