...
class TestEnterpriseConfigureCommand(unittest.TestCase):
    def setUp(self):
        ...
        with patch('localagents.cli.enterprise.main.SettingsCommand') as mock_settings_command_class:
    ...
    @patch('localagents.cli.enterprise.main.httpx.get')
    @patch('localagents.cli.enterprise.main.get_localagents_version')
