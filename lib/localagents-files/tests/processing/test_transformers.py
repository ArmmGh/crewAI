...
from localagents_files import ImageFile, PDFFile, TextFile
from localagents_files.core.sources import FileBytes
from localagents_files.processing.exceptions import ProcessingDependencyError
from localagents_files.processing.transformers import (
    chunk_pdf,
    chunk_text,
    ...
    def test_raises_without_pillow(self) -> None:
        ...
        with patch.dict("sys.modules", {"PIL": None, "PIL.Image": None}):
            with pytest.raises(ProcessingDependencyError) as exc_info:
                ...
                import localagents_files.processing.transformers as t
