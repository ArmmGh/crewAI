...
from localagents_files import AudioFile, FileBytes, ImageFile, PDFFile, TextFile, VideoFile
...
class TestValidateAudio:
    ...
    @patch("localagents_files.processing.validators._get_audio_duration")
...
class TestValidateVideo:
    ...
    @patch("localagents_files.processing.validators._get_video_duration")
