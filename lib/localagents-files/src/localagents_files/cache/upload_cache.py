...
from localagents_files.core.constants import DEFAULT_MAX_CACHE_ENTRIES, DEFAULT_TTL_SECONDS
...
def _compute_file_hash(file: FileInput) -> str:
    ...
    """
    from localagents_files.core.sources import FilePath
...
class UploadCache:
    ...
    def __init__(
        ...
        namespace: str = "localagents_uploads",
