...
from localagents_files.core.sources import is_file_source


if TYPE_CHECKING:
    from localagents_files.core.sources import FileSource, FileSourceInput
...
def wrap_file_source(source: FileSource) -> FileInput:
    ...
    """
    from localagents_files.core.types import (
        AudioFile,
        ImageFile,
        PDFFile,
        TextFile,
...
def normalize_input_files(
    ...
    """
    from localagents_files.core.sources import FileBytes, FilePath, FileStream, FileUrl
    from localagents_files.core.types import BaseFile
