...
from localagents_files.core.constants import DEFAULT_MAX_FILE_SIZE_BYTES, MAGIC_BUFFER_SIZE
...
class FilePath(BaseModel):
    ...
    def _validate_file_exists(self) -> FilePath:
        ...
        from localagents_files.processing.exceptions import FileTooLargeError
