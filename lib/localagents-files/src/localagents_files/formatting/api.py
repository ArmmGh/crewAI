...
from localagents_files.cache.upload_cache import get_upload_cache
from localagents_files.core.types import FileInput
from localagents_files.formatting.anthropic import AnthropicFormatter
from localagents_files.formatting.bedrock import BedrockFormatter
from localagents_files.formatting.gemini import GeminiFormatter
from localagents_files.formatting.openai import OpenAIFormatter, OpenAIResponsesFormatter
from localagents_files.processing.constraints import get_constraints_for_provider
from localagents_files.processing.processor import FileProcessor
from localagents_files.resolution.resolver import FileResolver, FileResolverConfig
from localagents_files.uploaders.factory import ProviderType
...
def format_multimodal_content(
    ...
    Example:
        >>> from localagents_files import format_multimodal_content, ImageFile
...
def _get_resolver_config(
    ...
    """
    if "bedrock" in provider_lower:
        s3_bucket = os.environ.get("LOCALAGENTS_BEDROCK_S3_BUCKET")
        prefer_upload = (
...
def _get_formatter(
    ...
    if "bedrock" in provider_lower or "aws" in provider_lower:
        s3_bucket_owner = os.environ.get("LOCALAGENTS_BEDROCK_S3_BUCKET_OWNER")
