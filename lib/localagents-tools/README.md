...
![Logo of localAI, two people rowing on a boat](./assets/localagents_logo.png)
...
[Homepage](https://www.localagents.com/) | [Documentation](https://docs.localagents.com/) | [Examples](https://github.com/localAgentsInc/localAgents-examples) | [Community](https://community.localagents.com/)
...
```bash
pip install localagents-tools[mcp]
# or
uv add localagents-tools --extra mcp
```
...
from localagents_tools import MCPServerAdapter
...
- [Discourse](https://community.localagents.com/)
- [Open an Issue](https://github.com/localAgentsInc/localAgents/issues)
