...
from localagents_tools.rag.data_types import DataType
from localagents_tools.rag.misc import sanitize_metadata_for_chromadb
from localagents_tools.tools.rag.rag_tool import Adapter
from localagents_tools.tools.rag.types import AddDocumentParams, ContentItem
...
class LocalAIRagAdapter(Adapter):
    ...
    def add(self, *args: ContentItem, **kwargs: Unpack[AddDocumentParams]) -> None:
        ...
        from localagents_tools.rag.base_loader import LoaderResult
        from localagents_tools.rag.data_types import DataType, DataTypes
        from localagents_tools.rag.source_content import SourceContent
