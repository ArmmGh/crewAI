...
from localagents_tools.aws.bedrock.browser.browser_session_manager import (
    BrowserSessionManager,
)
from localagents_tools.aws.bedrock.browser.utils import aget_current_page, get_current_page
...
class BrowserToolkit:
    ...
    Example:
        ...
        from localagents_tools.aws.bedrock.browser import create_browser_toolkit
