...
import chromadb
from localagents.utilities.lock_store import lock as store_lock
from pydantic import BaseModel, Field, PrivateAttr

from localagents_tools.rag.base_loader import BaseLoader
from localagents_tools.rag.chunkers.base_chunker import BaseChunker
from localagents_tools.rag.data_types import DataType
from localagents_tools.rag.embedding_service import EmbeddingService
from localagents_tools.rag.misc import compute_sha256
...
class RAG(Adapter):
    collection_name: str = "localagents_knowledge_base"
