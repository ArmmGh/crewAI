...
## Installation
To get started with the PDFSearchTool, first, ensure the localagents_tools package is installed with the following command:
...
```python
from localagents_tools import PDFSearchTool
