...
## Installation
To start using the XMLSearchTool, you must first install the localagents_tools package. This can be easily done with the following command:
...
```python
from localagents_tools.tools.xml_search_tool import XMLSearchTool
