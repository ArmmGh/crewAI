...
```python
from localagents_tools import SerplyWebSearchTool
...
```python
from localagents_tools import SerplyNewsSearchTool
...
```python
from localagents_tools import SerplyScholarSearchTool
...
```python
from localagents_tools import SerplyJobSearchTool
...
```python
from localagents_tools import SerplyWebpageToMarkdownTool
...
from localagents_tools import SerplyWebSearchTool, SerplyWebpageToMarkdownTool
...
1. **Package Installation**: Confirm that the `localagents[tools]` package is installed in your Python environment.
