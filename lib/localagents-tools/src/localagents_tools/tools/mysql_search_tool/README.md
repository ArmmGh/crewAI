...
## Installation
To install the `localagents_tools` package and utilize the MySQLSearchTool, execute the following command in your terminal:
...
```python
from localagents_tools import MySQLSearchTool
