...
## Installation
To start using the DirectorySearchTool, you need to install the localagents_tools package. Execute the following command in your terminal:
...
```python
from localagents_tools import DirectorySearchTool
