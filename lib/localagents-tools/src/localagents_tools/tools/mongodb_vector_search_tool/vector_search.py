...
from localagents_tools.tools.mongodb_vector_search_tool.utils import (
...
class MongoDBVectorSearchTool(BaseTool):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if not MONGODB_AVAILABLE:
            ...
            if click.confirm(
                "You are missing the 'mongodb' localagents tool. Would you like to install it?"
            ):
                import subprocess
                ...
                raise ImportError("You are missing the 'mongodb' localagents tool.")
        ...
        self._client: MongoClient[dict[str, Any]] = MongoClient(
            ...
            driver=DriverInfo(name="LocalAI", version=version("localagents-tools")),
        )
