...
## Installation
Install the localagents_tools package with MongoDB support by executing the following command in your terminal:

```shell
pip install localagents-tools[mongodb]
```

or

```
uv add localagents-tools --extra mongodb
```
...
```python
from localagents_tools import MongoDBVectorSearchTool
...
```python
from localagents_tools import MongoDBVectorSearchConfig, MongoDBVectorSearchTool
