...
Install the localagents_tools package with the databricks extra:

```shell
pip install 'localagents[tools]' 'databricks-sdk'
```
...
```python
from localagents_tools import DatabricksQueryTool
