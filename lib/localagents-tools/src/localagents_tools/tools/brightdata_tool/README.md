...
```shell
pip install localagents[tools] aiohttp requests
```
...
```python
from localagents_tools import BrightDataDatasetTool
...
```python
from localagents_tools import BrightDataSearchTool
...
```python
from localagents_tools import BrightDataWebUnlockerTool
