...
## Installation
Install the `localagents_tools` package to use the DirectoryReadTool in your project. If you haven't added this package to your environment, you can easily install it with pip using the following command:

```shell
pip install 'localagents[tools]'
```

This installs the latest version of the `localagents_tools` package, allowing access to the DirectoryReadTool and other utilities.
...
```python
from localagents_tools import DirectoryReadTool
