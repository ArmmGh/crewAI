...
## Installation
To start using the SerpApi Tools, you must first install the `localagents_tools` package. This can be easily done with the following command:
...
### Google Search
```python
from localagents_tools import SerpApiGoogleSearchTool
...
### Google Shopping
```python
from localagents_tools import SerpApiGoogleShoppingTool
