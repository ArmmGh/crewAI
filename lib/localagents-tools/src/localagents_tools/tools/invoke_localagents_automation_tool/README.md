...
```python
from localagents_tools import InvokeLocalAIAutomationTool

# Basic crew automation tool
tool = InvokeLocalAIAutomationTool(
    crew_api_url="https://data-analysis-crew-[...].localagents.com",
...
tool = InvokeLocalAIAutomationTool(
    crew_api_url="https://state-of-ai-report-crew-[...].localagents.com",
    crew_bearer_token="your_bearer_token_here",
...
market_research_tool = InvokeLocalAIAutomationTool(
    crew_api_url="https://market-research-automation-crew-[...].localagents.com",
    crew_bearer_token="your_bearer_token_here",
