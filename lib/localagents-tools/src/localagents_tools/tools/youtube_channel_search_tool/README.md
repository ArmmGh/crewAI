...
## Installation
To utilize the YoutubeChannelSearchTool, the `localagents_tools` package must be installed. Execute the following command in your shell to install:
...
```python
from localagents_tools import YoutubeChannelSearchTool
