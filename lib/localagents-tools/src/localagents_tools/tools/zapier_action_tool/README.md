...
Install the localagents_tools package by executing the following command in your terminal:

```shell
uv pip install 'localagents[tools]'
```
...
```python
from localagents_tools import ZapierActionTools
