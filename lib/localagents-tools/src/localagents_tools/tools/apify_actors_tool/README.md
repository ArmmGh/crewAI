...
Integrate [Apify Actors](https://apify.com/actors) into your LocalAI workflows.

## Description

The `ApifyActorsTool` connects [Apify Actors](https://apify.com/actors), cloud-based programs for web scraping and automation, to your LocalAI workflows.
...
For details, see the [Apify LocalAI integration](https://docs.apify.com/platform/integrations/localagents) in Apify documentation.
...
1. **Install dependencies**
   Install `localagents[tools]` and `langchain-apify`:
   ```bash
   pip install 'localagents[tools]' langchain-apify
   ```
...
```python
from localagents_tools import ApifyActorsTool
...
```text
URL: https://www.example.com/localagents-intro
Content: LocalAI is a framework for building AI-powered workflows...
URL: https://docs.localagents.com/
Content: Official documentation for LocalAI...
```
...
For an example of usage with agents, see the [LocalAI Actor template](https://apify.com/templates/python-localagents).
...
- **[LocalAI Integration Guide](https://docs.apify.com/platform/integrations/localagents)**: Follow the official guide for integrating Apify and LocalAI.
