...
from localagents_tools.printer import Printer
...
class CodeInterpreterTool(BaseTool):
    ...
    def _get_installed_package_path() -> str:
        """Gets the installation path of the localagents_tools package.
        ...
        """
        spec = importlib.util.find_spec("localagents_tools")
        if spec is None or spec.origin is None:
            raise RuntimeError("Cannot find localagents_tools package installation path")
