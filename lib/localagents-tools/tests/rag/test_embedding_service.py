...
from localagents_tools.rag.embedding_service import EmbeddingService, EmbeddingConfig
...
class TestEmbeddingService:
    ...
    @patch('localagents.rag.embeddings.factory.build_embedder')
    ...
    def test_create_openai_service(self):
        ...
        with patch('localagents.rag.embeddings.factory.build_embedder'):
