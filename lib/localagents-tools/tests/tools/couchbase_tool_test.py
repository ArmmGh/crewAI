...
def couchbase_tool(tool_config):
    ...
    with patch(
        "localagents_tools.tools.couchbase_tool.couchbase_tool.COUCHBASE_AVAILABLE", True
    ):
...
def test_initialization_couchbase_unavailable():
    ...
    with patch(
        "localagents_tools.tools.couchbase_tool.couchbase_tool.COUCHBASE_AVAILABLE", False
    ):
...
def test_run_success_scoped_index(
    ...
    with (
        patch(
            "localagents_tools.tools.couchbase_tool.couchbase_tool.VectorQuery"
        ) as mock_vq,
        patch(
            "localagents_tools.tools.couchbase_tool.couchbase_tool.VectorSearch"
        ) as mock_vs,
        patch(
            "localagents_tools.tools.couchbase_tool.couchbase_tool.search.SearchRequest"
        ) as mock_sr,
        patch(
            "localagents_tools.tools.couchbase_tool.couchbase_tool.SearchOptions"
        ) as mock_so,
    ):
