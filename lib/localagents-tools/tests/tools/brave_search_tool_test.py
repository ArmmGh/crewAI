...
from localagents_tools.tools.brave_search_tool.base import BraveSearchToolBase
...
from localagents_tools.tools.brave_search_tool.schemas import (
    WebSearchParams,
    WebSearchHeaders,
    ImageSearchParams,
    ImageSearchHeaders,
...
@patch("localagents_tools.tools.brave_search_tool.base.requests.get")
...
def test_raw_false_calls_refine_response(mock_get, web_tool):
    ...
    result = web_tool._run(query="localagents")
...
@patch("localagents_tools.tools.brave_search_tool.base.requests.get")
@patch("localagents_tools.tools.brave_search_tool.base._save_results_to_file")
...
@patch("localagents_tools.tools.brave_search_tool.base.requests.get")
@patch("localagents_tools.tools.brave_search_tool.base.time")
