...
def mock_stagehand_modules():
    ...
    from localagents_tools.tools.stagehand_tool.stagehand_tool import (
        StagehandResult,
        StagehandTool,
    )
...
def mock_stagehand_instance():
    with patch(
        "localagents_tools.tools.stagehand_tool.stagehand_tool.Stagehand",
...
@patch(
    "localagents_tools.tools.stagehand_tool.stagehand_tool.StagehandTool._run", autospec=True
)
