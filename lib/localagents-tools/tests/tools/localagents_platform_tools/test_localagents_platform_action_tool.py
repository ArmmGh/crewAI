...
class TestLocalAIPlatformActionToolVerify:
    """Test suite for SSL verification behavior based on LOCALAGENTS_FACTORY environment variable"""
    ...
    def test_run_with_ssl_verification_default(self, mock_post):
        """Test that _run uses SSL verification by default when LOCALAGENTS_FACTORY is not set"""
        mock_response = Mock()
    ...
    def test_run_with_ssl_verification_factory_false(self, mock_post):
        """Test that _run uses SSL verification when LOCALAGENTS_FACTORY is 'false'"""
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"result": "success"}
        mock_post.return_value = mock_response
    ...
    def test_run_with_ssl_verification_factory_false_uppercase(self, mock_post):
        """Test that _run uses SSL verification when LOCALAGENTS_FACTORY is 'FALSE' (case-insensitive)"""
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"result": "success"}
        mock_post.return_value = mock_response
    ...
    def test_run_without_ssl_verification_factory_true(self, mock_post):
        """Test that _run disables SSL verification when LOCALAGENTS_FACTORY is 'true'"""
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"result": "success"}
        mock_post.return_value = mock_response
    ...
    def test_run_without_ssl_verification_factory_true_uppercase(self, mock_post):
        """Test that _run disables SSL verification when LOCALAGENTS_FACTORY is 'TRUE' (case-insensitive)"""
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"result": "success"}
        mock_post.return_value = mock_response
