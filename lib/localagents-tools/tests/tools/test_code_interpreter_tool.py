...
@pytest.fixture
def printer_mock():
    with patch("localagents_tools.printer.Printer.print") as mock:
        yield mock
...
def docker_unavailable_mock():
    with patch(
        "localagents_tools.tools.code_interpreter_tool.code_interpreter_tool.CodeInterpreterTool._check_docker_available",
        return_value=False,
    ) as mock:
        yield mock


@patch("localagents_tools.tools.code_interpreter_tool.code_interpreter_tool.docker_from_env")
...
@patch("localagents_tools.tools.code_interpreter_tool.code_interpreter_tool.subprocess.run")
