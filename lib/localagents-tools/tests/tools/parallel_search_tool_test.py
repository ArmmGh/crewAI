...
from localagents_tools.tools.parallel_tools.parallel_search_tool import (
    ParallelSearchTool,
)
...
@patch("localagents_tools.tools.parallel_tools.parallel_search_tool.requests.post")
