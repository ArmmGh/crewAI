...
from localagents_tools.adapters.localagents_rag_adapter import LocalAIRagAdapter
from localagents_tools.tools.rag.rag_tool import RagTool


@patch("localagents_tools.adapters.localagents_rag_adapter.get_rag_client")
@patch("localagents_tools.adapters.localagents_rag_adapter.create_client")
...
@patch("localagents_tools.tools.rag.rag_tool.build_embedder")
@patch("localagents_tools.adapters.localagents_rag_adapter.create_client")
...
def test_rag_tool_with_azure_config_without_env_vars(
    ...
    with patch(
        "localagents_tools.tools.rag.rag_tool.build_embedder",
