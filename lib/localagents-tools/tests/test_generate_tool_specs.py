...
from localagents.tools.base_tool import BaseTool, EnvVar
from localagents_tools.generate_tool_specs import ToolSpecExtractor
...
def mock_tool_extractor(extractor):
    with (
        mock.patch("localagents_tools.generate_tool_specs.dir", return_value=["MockTool"]),
        mock.patch("localagents_tools.generate_tool_specs.getattr", return_value=MockTool),
    ):
