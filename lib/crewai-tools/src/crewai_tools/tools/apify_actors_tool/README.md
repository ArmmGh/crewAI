...
For details, see the [Apify LocalAI integration](https://docs.apify.com/platform/integrations/crewai) in Apify documentation.
...
For an example of usage with agents, see the [LocalAI Actor template](https://apify.com/templates/python-crewai).
...
- **[LocalAI Integration Guide](https://docs.apify.com/platform/integrations/crewai)**: Follow the official guide for integrating Apify and LocalAI.
